...
(function() {
    var DEBUG = !1, HOST = DEBUG ? "http://test.yumprint.com" : "http://yumprint.com", SECURE_HOST = DEBUG ? "https://test.yumprint.com" : "https://yumprint.com", API_HOST = DEBUG ? "http://testapi.yumprint.com" : "http://api.yumprint.com", SECURE_API_HOST = DEBUG ? "https://testapi.yumprint.com" : "https://api.yumprint.com", ANIMATION_TIME = 250, MESSAGE_TIME = 1E3, TOUCH = "undefined" !== typeof window && "ontouchstart"in window || "undefined" !== typeof navigator && (0 < navigator.maxTouchPoints || 0 < navigator.msMaxTouchPoints);
    (function(a, e) {
        function c(p) {
            var a = p.length, b = j.type(p);
            return j.isWindow(p) ? !1 : 1 === p.nodeType && a ? !0 : "array" === b || "function" !== b && (0 === a || "number" === typeof a && 0 < a && a - 1 in p)
        }
        function b(p, a, b, c) {
            if (j.acceptData(p)) {
                var f = j.expando, d = "string" === typeof a, h = p.nodeType, g = h ? j.cache : p, k = h ? p[f] : p[f] && f;
                if (k && g[k] && (c || g[k].data) || !(d && b === e)) {
                    k || (h ? p[f] = k = xa.pop() || j.guid++ : k = f);
                    g[k] || (g[k] = {}, h || (g[k].toJSON = j.noop));
                    if ("object" === typeof a || "function" === typeof a)
                        c ? g[k] = j.extend(g[k], a) : g[k].data = j.extend(g[k].data,
                                a);
                    p = g[k];
                    c || (p.data || (p.data = {}), p = p.data);
                    b !== e && (p[j.camelCase(a)] = b);
                    d ? (b = p[a], null == b && (b = p[j.camelCase(a)])) : b = p;
                    return b
                }
            }
        }
        function d(p, a, b) {
            if (j.acceptData(p)) {
                var c, f, d, h = p.nodeType, g = h ? j.cache : p, e = h ? p[j.expando] : j.expando;
                if (g[e]) {
                    if (a && (d = b ? g[e] : g[e].data)) {
                        ...
                        for (f = a.length; c < f; c++)
                            delete d[a[c]];
                        if (!(b ? l : j.isEmptyObject)(d))
                            return
                    }
                    if (!b && (delete g[e].data, !l(g[e])))
                        return;
                    h ? j.cleanData([p],
        ...
        function g(p, a, b) {
            if (b === e && 1 === p.nodeType)
                if (b = "data-" + a.replace(Kb, "-$1").toLowerCase(), b = p.getAttribute(b), "string" === typeof b) {
                    try {
                        b = "true" === b ? !0 : "false" === b ? !1 : "null" === b ? null : +b + "" === b ? +b : Lb.test(b) ? j.parseJSON(b) : b
                    } catch (c) {
                    }
                    j.data(p, a, b)
                } else
        ...
        function l(p) {
            for (var a in p)
                if (!("data" === a && j.isEmptyObject(p[a])) && "toJSON" !== a)
                    return!1;
            return!0
        }
        function f() {
        ...
        function m(p, a, b) {
            a = a || 0;
            if (j.isFunction(a))
                return j.grep(p, function(p, c) {
                    return!!a.call(p, c, p) === b
                });
            if (a.nodeType)
                return j.grep(p, function(p) {
                    return p === a === b
                });
            if ("string" === typeof a) {
                var c = j.grep(p, function(p) {
                    return 1 === p.nodeType
                });
                if (Tc.test(a))
                    return j.filter(a, c, !b);
                a = j.filter(a, c)
            }
            return j.grep(p, function(p) {
                return 0 <= j.inArray(p, a) === b
            })
        }
        function n(p) {
            var a = sc.split("|"), p = p.createDocumentFragment();
            if (p.createElement)
                for (; a.length; )
                    p.createElement(a.pop());
            return p
        }
        function w(p) {
            var a = p.getAttributeNode("type");
            p.type = (a && a.specified) + "/" + p.type;
            return p
        }
        function q(p) {
            var a = Uc.exec(p.type);
            a ? p.type = a[1] : p.removeAttribute("type");
            return p
        }
        function r(p, a) {
            for (var b, c = 0; null != (b = p[c]); c++)
                j._data(b, "globalEval", !a || j._data(a[c], "globalEval"))
        }
        function v(p, a) {
            if (1 === a.nodeType && j.hasData(p)) {
                var b, c, f;
                c = j._data(p);
                ...
                if (h)
                    for (b in delete d.handle, d.events = {}, h) {
                        c = 0;
                        for (f = h[b].length; c < f; c++)
                            j.event.add(a, b, h[b][c])
                    }
                d.data && (d.data =
                        j.extend({}, d.data))
            }
        ...
        function u(p, a) {
            var b, c, f = 0, d = typeof p.getElementsByTagName !== E ? p.getElementsByTagName(a || "*") : typeof p.querySelectorAll !== E ? p.querySelectorAll(a || "*") : e;
            if (!d) {
                d = [];
                for (b = p.childNodes || p; null != (c = b[f]); f++)
                    !a || j.nodeName(c, a) ? d.push(c) : j.merge(d, u(c, a))
            }
            return a === e || a && j.nodeName(p, a) ? j.merge([p], d) : d
        }
        function y(p) {
            Mb.test(p.type) && (p.defaultChecked = p.checked)
        }
        function x(p, a) {
            if (a in p)
                return a;
            for (var b = a.charAt(0).toUpperCase() + a.slice(1), c = a, f = tc.length; f--; )
                if (a = tc[f] +
                        b, a in p)
                    return a;
            return c
        ...
        function C(p, a) {
            p = a || p;
            return"none" === j.css(p, "display") || !j.contains(p.ownerDocument, p)
        }
        function G(p, a) {
            for (var b, c, f, d = [], h = 0, g = p.length; h < g; h++)
                if (c = p[h], c.style)
                    if (d[h] = j._data(c, "olddisplay"), b = c.style.display, a)
                        !d[h] && "none" === b && (c.style.display = ""), "" === c.style.display && C(c) && (d[h] = j._data(c, "olddisplay", J(c.nodeName)));
                    else if (!d[h] && (f = C(c), b && "none" !== b || !f))
                        j._data(c, "olddisplay", f ? b : j.css(c, "display"));
            for (h = 0; h < g; h++)
                if (c = p[h], c.style && (!a || "none" === c.style.display ||
                        "" === c.style.display))
                    c.style.display = a ? d[h] || "" : "none";
            return p
        }
        function t(p, a, b) {
            return(p = Vc.exec(a)) ? Math.max(0, p[1] - (b || 0)) + (p[2] || "px") : a
        }
        function s(p, a, b, c, f) {
            for (var a = b === (c ? "border" : "content") ? 4 : "width" === a ? 1 : 0, d = 0; 4 > a; a += 2)
                "margin" === b && (d += j.css(p, b + Da[a], !0, f)), c ? ("content" === b && (d -= j.css(p, "padding" + Da[a], !0, f)), "margin" !== b && (d -= j.css(p, "border" + Da[a] + "Width", !0, f))) : (d += j.css(p, "padding" + Da[a], !0, f), "padding" !== b && (d += j.css(p, "border" + Da[a] + "Width", !0, f)));
            return d
        }
        function A(p, a, b) {
            var c =
                    !0, f = "width" === a ? p.offsetWidth : p.offsetHeight, d = Ea(p), h = j.support.boxSizing && "border-box" === j.css(p, "boxSizing", !1, d);
            if (0 >= f || null == f) {
                f = Fa(p, a, d);
                if (0 > f || null == f)
                    f = p.style[a];
                if (qb.test(f))
                    return f;
                c = h && (j.support.boxSizingReliable || f === p.style[a]);
                f = parseFloat(f) || 0
            }
            return f + s(p, a, b || (h ? "border" : "content"), c, d) + "px"
        }
        function J(p) {
            var a = z, b = uc[p];
            if (!b) {
                b = U(p, a);
                if ("none" === b || !b)
                    Ya = (Ya || j("<iframe frameborder='0' width='0' height='0'/>").css("cssText", "display:block !important")).appendTo(a.documentElement),
                            a = (Ya[0].contentWindow || Ya[0].contentDocument).document, a.write("<!doctype html><html><body>"), a.close(), b = U(p, a), Ya.detach();
                uc[p] = b
            }
            return b
        }
        function U(p, a) {
            var b = j(a.createElement(p)).appendTo(a.body), c = j.css(b[0], "display");
            b.remove();
            return c
        }
        function R(p, a, b, c) {
            ...
            if (j.isArray(a))
                j.each(a, function(a, f) {
                    b || Wc.test(p) ? c(p, f) : R(p + "[" + ("object" === typeof f ? a : "") + "]", f, b, c)
                });
        ...
        function K(p) {
            return function(a, b) {
                "string" !==
                        typeof a && (b = a, a = "*");
                var c, f = 0, d = a.toLowerCase().match(ja) || [];
                if (j.isFunction(b))
                    for (; c = d[f++]; )
                        "+" === c[0] ? (c = c.slice(1) || "*", (p[c] = p[c] || []).unshift(b)) : (p[c] = p[c] || []).push(b)
            }
        }
        function V(p, a, b, c) {
            function f(g) {
                var e;
                d[g] = !0;
                j.each(p[g] || [], function(p, g) {
                    var k = g(a, b, c);
                    if ("string" === typeof k && !h && !d[k])
                        return a.dataTypes.unshift(k), f(k), !1;
                    if (h)
                        return!(e = k)
                });
                return e
        ...
        function na(p, a, b) {
            var c, f, d = 0, h = rb.length, g = j.Deferred().always(function() {
                delete e.elem
            }), e = function() {
                if (f)
                    return!1;
                for (var a = Ja || ta(), a = Math.max(0, k.startTime + k.duration - a), b = 1 - (a / k.duration || 0), c = 0, d = k.tweens.length; c < d; c++)
                    k.tweens[c].run(b);
                g.notifyWith(p, [k, b, a]);
                if (1 > b && d)
                    return a;
                g.resolveWith(p, [k]);
                return!1
            }, k =
                    g.promise({elem: p, props: j.extend({}, a), opts: j.extend(!0, {specialEasing: {}}, b), originalProperties: a, originalOptions: b, startTime: Ja || ta(), duration: b.duration, tweens: [], createTween: function(a, b) {
                            var c = j.Tween(p, k.opts, a, b, k.opts.specialEasing[a] || k.opts.easing);
                            k.tweens.push(c);
                            return c
                        }, stop: function(a) {
                            ...
                            for (f = !0; b < c; b++)
                                k.tweens[b].run(1);
                            a ? g.resolveWith(p, [k, a]) : g.rejectWith(p, [k, a]);
                            return this
                        }}), a = k.props, b = k.opts.specialEasing, l, m, t, n;
            for (c in a)
                if (m =
                        j.camelCase(c), t = b[m], l = a[c], j.isArray(l) && (t = l[1], l = a[c] = l[0]), c !== m && (a[m] = l, delete a[c]), (n = j.cssHooks[m]) && "expand"in n)
                    for (c in l = n.expand(l), delete a[m], l)
                        c in a || (a[c] = l[c], b[c] = t);
                else
                    b[m] = t;
            for (; d < h; d++)
                if (c = rb[d].call(k, p, a, k.opts))
                    return c;
            var s = k;
            j.each(a, function(p, a) {
                for (var b = (Za[p] || []).concat(Za["*"]), c = 0, f = b.length; c < f && !b[c].call(s, p, a); c++)
                    ;
            });
            j.isFunction(k.opts.start) && k.opts.start.call(p, k);
            j.fx.timer(j.extend(e, {elem: p, anim: k, queue: k.opts.queue}));
            return k.progress(k.opts.progress).done(k.opts.done,
                    k.opts.complete).fail(k.opts.fail).always(k.opts.always)
        }
        function M(p, a, b, c, f) {
            return new M.prototype.init(p, a, b, c, f)
        }
        function ka(p, a) {
            for (var b, c = {height: p}, f = 0, a = a ? 1 : 0; 4 > f; f += 2 - a)
                b = Da[f], c["margin" + b] = c["padding" + b] = p;
            a && (c.opacity = c.width = p);
            return c
        }
        function ha(p) {
            return j.isWindow(p) ? p : 9 === p.nodeType ? p.defaultView || p.parentWindow : !1
        }
        var W, aa, E = typeof e, z = a.document, I = a.location, ba = a.jQuery, la = a.$, O = {}, xa = [], sb = xa.concat, $a = xa.push, ua = xa.slice, tb = xa.indexOf, Ob = O.toString, Ga = O.hasOwnProperty, ab =
                "1.9.1".trim, j = function(p, a) {
                    return new j.fn.init(p, a, aa)
                }, Ka = /[+-]?(?:\d*\.|)\d+(?:[eE][+-]?\d+|)/.source, ja = /\S+/g, Pb = /^[\s\uFEFF\xA0]+|[\s\uFEFF\xA0]+$/g, Qb = /^(?:(<[\w\W]+>)[^>]*|#([\w-]*))$/, ub = /^<(\w+)\s*\/?>(?:<\/\1>|)$/, Rb = /^[\],:{}\s]*$/, Sb = /(?:^|:|,)(?:\s*\[)+/g, Tb = /\\(?:["\\\/bfnrt]|u[\da-fA-F]{4})/g, Ub = /"[^"\\\r\n]*"|true|false|null|-?(?:\d+\.|)\d+(?:[eE][+-]?\d+|)/g, Vb = /^-ms-/, Wb = /-([\da-z])/gi, Xb = function(p, a) {
            return a.toUpperCase()
        }, oa = function(p) {
            if (z.addEventListener || "load" === p.type ||
                    "complete" === z.readyState)
                vb(), j.ready()
        }, vb = function() {
            z.addEventListener ? (z.removeEventListener("DOMContentLoaded", oa, !1), a.removeEventListener("load", oa, !1)) : (z.detachEvent("onreadystatechange", oa), a.detachEvent("onload", oa))
        };
        j.fn = j.prototype = {jquery: "1.9.1", constructor: j, init: function(p, a, b) {
                var c;
                if (!p)
                    return this;
                if ("string" === typeof p) {
                    if ((c = "<" === p.charAt(0) && ">" === p.charAt(p.length - 1) && 3 <= p.length ? [null, p, null] : Qb.exec(p)) && (c[1] || !a)) {
                        if (c[1]) {
                            if (a = a instanceof j ? a[0] : a, j.merge(this, j.parseHTML(c[1],
                                    a && a.nodeType ? a.ownerDocument || a : z, !0)), ub.test(c[1]) && j.isPlainObject(a))
                                for (c in a)
                                    if (j.isFunction(this[c]))
                                        this[c](a[c]);
                                    else
                                        this.attr(c, a[c])
                        } else {
                            if ((a = z.getElementById(c[2])) && a.parentNode) {
                                if (a.id !== c[2])
                                    return b.find(p);
                                this.length = 1;
                                this[0] = a
                    ...
                    return!a || a.jquery ? (a || b).find(p) : this.constructor(a).find(p)
                }
                if (p.nodeType)
                    return this.context = this[0] = p, this.length = 1, this;
                if (j.isFunction(p))
                    return b.ready(p);
                p.selector !== e && (this.selector = p.selector, this.context =
                        p.context);
                return j.makeArray(p, this)
        ...
        j.extend = j.fn.extend = function() {
            ...
            for (; g < k; g++)
                if (null != (d = arguments[g]))
                    for (f in d)
                        a = h[f], c = d[f], h !== c && (l && c && (j.isPlainObject(c) || (b = j.isArray(c))) ? (b ? (b = !1, a = a && j.isArray(a) ? a : []) : a = a && j.isPlainObject(a) ? a : {}, h[f] = j.extend(l, a, c)) : c !== e && (h[f] = c));
            return h
        };
        j.extend({noConflict: function(p) {
                a.$ === j && (a.$ = la);
                p && a.jQuery === j && (a.jQuery = ba);
                return j
                ...
                if (!(!0 === a ? --j.readyWait : j.isReady)) {
                    if (!z.body)
                        return setTimeout(j.ready);
                    j.isReady = !0;
                    !0 !== a && 0 < --j.readyWait || (W.resolveWith(z, [j]), j.fn.trigger && j(z).trigger("ready").off("ready"))
                }
                ...
                return null == a ? String(a) : "object" === typeof a || "function" === typeof a ? O[Ob.call(a)] || "object" : typeof a
            }, isPlainObject: function(a) {
                if (!a || "object" !==
                        j.type(a) || a.nodeType || j.isWindow(a))
                    return!1;
                try {
                ...
                if (a.JSON && a.JSON.parse)
                    return a.JSON.parse(p);
                if (null === p)
                    return p;
                if ("string" === typeof p && (p = j.trim(p)) && Rb.test(p.replace(Tb, "@").replace(Ub, "]").replace(Sb, "")))
                    return(new Function("return " + p))();
                j.error("Invalid JSON: " + p)
            }, parseXML: function(p) {
                var b, c;
                if (!p || "string" !== typeof p)
                    return null;
                try {
                    a.DOMParser ? (c = new DOMParser, b = c.parseFromString(p, "text/xml")) : (b = new ActiveXObject("Microsoft.XMLDOM"), b.async = "false", b.loadXML(p))
                } catch (f) {
                    b =
                    e
                }
                (!b || !b.documentElement || b.getElementsByTagName("parsererror").length) && j.error("Invalid XML: " + p);
                return b
            }, noop: function() {
            }, globalEval: function(p) {
                p && j.trim(p) && (a.execScript || function(p) {
                    a.eval.call(a, p)
                })(p)
                ...
                var f = b || [];
                null != a && (c(Object(a)) ? j.merge(f, "string" === typeof a ? [a] : a) : $a.call(f, a));
                return f
            }, inArray: function(a, b, c) {
                var f;
                if (b) {
                    if (tb)
                        return tb.call(b, a, c);
                    f = b.length;
                ...
                for (var f, d = [], h = 0, g = a.length, c = !!c; h < g; h++)
                    f = !!b(a[h], h), c !== f && d.push(a[h]);
                return d
            }, map: function(a, b, f) {
                var d, h = 0, g = a.length, e = [];
                if (c(a))
                    for (; h < g; h++)
                        d = b(a[h], h, f), null != d && (e[e.length] = d);
                else
                    for (h in a)
                        d = b(a[h], h, f), null != d && (e[e.length] = d);
                return sb.apply([], e)
                ...
                if (!j.isFunction(a))
                    return e;
                c = ua.call(arguments, 2);
                f = function() {
                    return a.apply(b || this, c.concat(ua.call(arguments)))
                };
                ...
                if ("object" === j.type(c))
                    for (k in d = !0, c)
                        j.access(a, b, k, c[k], !0, h, g);
                else if (f !== e && (d = !0, j.isFunction(f) || (g = !0), m && (g ? (b.call(a, f), b = null) : (m = b, b = function(a, p, b) {
                    return m.call(j(a), b)
                })), b))
                    for (; k < l; k++)
                        b(a[k], c, g ? f : f.call(a[k], k, b(a[k],
                                c)));
                return d ? a : m ? b.call(a) : l ? b(a[0], c) : h
            }, now: function() {
                return(new Date).getTime()
            }});
        j.ready.promise = function(p) {
            if (!W)
                if (W = j.Deferred(), "complete" === z.readyState)
                    setTimeout(j.ready);
                else if (z.addEventListener)
                    z.addEventListener("DOMContentLoaded", oa, !1), a.addEventListener("load", oa, !1);
                else {
                    z.attachEvent("onreadystatechange", oa);
        ...
        j.Callbacks = function(a) {
            ...
            if ("string" === typeof a) {
                if (!(b = wb[a])) {
                    b = a;
                    var c = wb[b] = {};
                    j.each(b.match(ja) || [], function(a, p) {
                        c[p] = !0
                    });
                    b = c
                }
                ...
                b = j.extend({}, a);
            var a = b, f, d, h, g, k, l, m = [], t = !a.once && [], n = function(b) {
                d = a.memory && b;
                h = !0;
                k = l || 0;
                l = 0;
                ...
                f = !1;
                m && (t ? t.length && n(t.shift()) : d ? m = [] : s.disable())
            }, s = {add: function() {
                    if (m) {
                        var b = m.length;
                        (function Xc(b) {
                            j.each(b, function(b, c) {
                                var f = j.type(c);
                                "function" === f ? (!a.unique || !s.has(c)) && m.push(c) : c && (c.length && "string" !== f) && Xc(c)
                            })
                        })(arguments);
                        f ? g = m.length : d && (l = b, n(d))
                    }
                    return this
                }, remove: function() {
                    m && j.each(arguments, function(a, b) {
                        for (var p; - 1 < (p = j.inArray(b, m, p)); )
                            m.splice(p, 1), f && (p <= g && g--, p <= k && k--)
                    });
                    return this
                }, has: function(a) {
        ...
        j.extend({Deferred: function(a) {
                var b = [["resolve", "done", j.Callbacks("once memory"), "resolved"], ["reject", "fail",
                        j.Callbacks("once memory"), "rejected"], ["notify", "progress", j.Callbacks("memory")]], c = "pending", f = {state: function() {
                        return c
                    }, always: function() {
                        ...
                        var a = arguments;
                        return j.Deferred(function(p) {
                            j.each(b, function(b, c) {
                                var h = c[0], g = j.isFunction(a[b]) && a[b];
                                d[c[1]](function() {
                                    var a = g && g.apply(this, arguments);
                                    if (a && j.isFunction(a.promise))
                                        a.promise().done(p.resolve).fail(p.reject).progress(p.notify);
                                    else
                                        p[h + "With"](this === f ? p.promise() : this,
                                                g ? [a] : arguments)
                                })
                            });
                            a = null
                ...
                j.each(b, function(a, p) {
                    ...
                    d[p[0]] = function() {
                        d[p[0] + "With"](this === d ? f : this, arguments);
                        return this
                    };
                    d[p[0] + "With"] = h.fireWith
                });
                f.promise(d);
                a && a.call(d, d);
                return d
            }, when: function(a) {
                var b = 0, c = ua.call(arguments), f = c.length, d = 1 !== f || a && j.isFunction(a.promise) ? f : 0, h = 1 === d ? a : j.Deferred(), g = function(a, b, p) {
                    return function(c) {
                        b[a] =
                                this;
                        p[a] = 1 < arguments.length ? ua.call(arguments) : c;
                        p === e ? h.notifyWith(b, p) : --d || h.resolveWith(b, p)
                    }
                }, e, k, l;
                if (1 < f) {
                    e = Array(f);
                    k = Array(f);
                    for (l = Array(f); b < f; b++)
                        c[b] && j.isFunction(c[b].promise) ? c[b].promise().done(g(b, l, c)).fail(h.reject).progress(g(b, k, e)) : --d
                }
                d || h.resolveWith(l, c);
                return h.promise()
            }});
        var Yb = j, bb;
        var N, La, pa, X, Ma, Na, Oa, cb, xb, db, D = z.createElement("div");
        D.setAttribute("className", "t");
        D.innerHTML = "  <link/><table></table><a href='/a'>a</a><input type='checkbox'/>";
        La = D.getElementsByTagName("*");
        pa = D.getElementsByTagName("a")[0];
        if (!La || !pa || !La.length)
            bb = {};
        else {
            Ma = z.createElement("select");
            Oa = Ma.appendChild(z.createElement("option"));
            X = D.getElementsByTagName("input")[0];
            pa.style.cssText = "top:1px;float:left;opacity:.5";
            N = {getSetAttribute: "t" !== D.className, leadingWhitespace: 3 === D.firstChild.nodeType, tbody: !D.getElementsByTagName("tbody").length, htmlSerialize: !!D.getElementsByTagName("link").length, style: /top/.test(pa.getAttribute("style")), hrefNormalized: "/a" === pa.getAttribute("href"), opacity: /^0.5/.test(pa.style.opacity),
                cssFloat: !!pa.style.cssFloat, checkOn: !!X.value, optSelected: Oa.selected, enctype: !!z.createElement("form").enctype, html5Clone: "<:nav></:nav>" !== z.createElement("nav").cloneNode(!0).outerHTML, boxModel: "CSS1Compat" === z.compatMode, deleteExpando: !0, noCloneEvent: !0, inlineBlockNeedsLayout: !1, shrinkWrapBlocks: !1, reliableMarginRight: !0, boxSizingReliable: !0, pixelPosition: !1};
            X.checked = !0;
            N.noCloneChecked = X.cloneNode(!0).checked;
            Ma.disabled = !0;
            N.optDisabled = !Oa.disabled;
            try {
                delete D.test
            } catch (vc) {
                N.deleteExpando =
            ...
            N.input = "" === X.getAttribute("value");
            X.value = "t";
            X.setAttribute("type", "radio");
            N.radioValue = "t" === X.value;
            X.setAttribute("checked", "t");
            X.setAttribute("name", "t");
            Na = z.createDocumentFragment();
            Na.appendChild(X);
            N.appendChecked = X.checked;
            N.checkClone = Na.cloneNode(!0).cloneNode(!0).lastChild.checked;
            D.attachEvent && (D.attachEvent("onclick", function() {
                N.noCloneEvent = !1
            }), D.cloneNode(!0).click());
            for (db in{submit:!0, change:!0, focusin:!0})
                D.setAttribute(cb =
                        "on" + db, "t"), N[db + "Bubbles"] = cb in a || !1 === D.attributes[cb].expando;
            D.style.backgroundClip = "content-box";
            D.cloneNode(!0).style.backgroundClip = "";
            N.clearCloneStyle = "content-box" === D.style.backgroundClip;
            j(function() {
                var b, c, f = z.getElementsByTagName("body")[0];
                f && (b = z.createElement("div"), b.style.cssText = "border:0;width:0;height:0;position:absolute;top:0;left:-9999px;margin-top:1px", f.appendChild(b).appendChild(D), D.innerHTML = "<table><tr><td></td><td>t</td></tr></table>", c = D.getElementsByTagName("td"),
                        c[0].style.cssText = "padding:0;margin:0;border:0;display:none", xb = 0 === c[0].offsetHeight, c[0].style.display = "", c[1].style.display = "none", N.reliableHiddenOffsets = xb && 0 === c[0].offsetHeight, D.innerHTML = "", D.style.cssText = "box-sizing:border-box;-moz-box-sizing:border-box;-webkit-box-sizing:border-box;padding:1px;border:1px;display:block;width:4px;margin-top:1%;position:absolute;top:1%;", N.boxSizing = 4 === D.offsetWidth, N.doesNotIncludeMarginInBodyOffset = 1 !== f.offsetTop, a.getComputedStyle && (N.pixelPosition =
                        "1%" !== (a.getComputedStyle(D, null) || {}).top, N.boxSizingReliable = "4px" === (a.getComputedStyle(D, null) || {width: "4px"}).width, c = D.appendChild(z.createElement("div")), c.style.cssText = D.style.cssText = "padding:0;margin:0;border:0;display:block;box-sizing:content-box;-moz-box-sizing:content-box;-webkit-box-sizing:content-box;", c.style.marginRight = c.style.width = "0", D.style.width = "1px", N.reliableMarginRight = !parseFloat((a.getComputedStyle(c, null) || {}).marginRight)), typeof D.style.zoom !== E && (D.innerHTML = "",
                        D.style.cssText = "padding:0;margin:0;border:0;display:block;box-sizing:content-box;-moz-box-sizing:content-box;-webkit-box-sizing:content-box;width:1px;padding:1px;display:inline;zoom:1", N.inlineBlockNeedsLayout = 3 === D.offsetWidth, D.style.display = "block", D.innerHTML = "<div></div>", D.firstChild.style.width = "5px", N.shrinkWrapBlocks = 3 !== D.offsetWidth, N.inlineBlockNeedsLayout && (f.style.zoom = 1)), f.removeChild(b), D = null)
            });
            La = Ma = Na = Oa = pa = X = null;
            bb = N
        }
        Yb.support = bb;
        var Lb = /(?:\{[\s\S]*\}|\[[\s\S]*\])$/, Kb = /([A-Z])/g;
        j.extend({cache: {}, expando: "jQuery" + ("1.9.1" + Math.random()).replace(/\D/g, ""), noData: {embed: !0, object: "clsid:D27CDB6E-AE6D-11cf-96B8-444553540000", applet: !0}, hasData: function(a) {
        ...
        j.fn.extend({data: function(a, b) {
                var c, f, d = this[0], h = 0, k = null;
                if (a === e) {
                    if (this.length && (k = j.data(d), 1 === d.nodeType && !j._data(d, "parsedAttrs"))) {
                        for (c = d.attributes; h < c.length; h++)
                            f = c[h].name, f.indexOf("data-") || (f = j.camelCase(f.slice(5)), g(d, f, k[f]));
                ...
                return"object" === typeof a ? this.each(function() {
                    ...
                    if (b === e)
                        return d ? g(d, a, j.data(d, a)) : null;
                    this.each(function() {
                        j.data(this, a, b)
                    })
        ...
        j.extend({queue: function(a, b, c) {
                var f;
                if (a)
                    return b = (b || "fx") + "queue", f = j._data(a, b), c && (!f || j.isArray(c) ? f = j._data(a, b, j.makeArray(c)) : f.push(c)), f || []
            }, dequeue: function(a, b) {
                var b = b || "fx", c = j.queue(a, b), f = c.length, d = c.shift(), h = j._queueHooks(a, b), g = function() {
                    j.dequeue(a, b)
                };
                ...
                var c = b + "queueHooks";
                return j._data(a, c) || j._data(a, c, {empty: j.Callbacks("once memory").add(function() {
                        j._removeData(a, b + "queue");
                        j._removeData(a, c)
                    })})
            }});
        j.fn.extend({queue: function(a, b) {
                var c = 2;
                ...
                for (a = a || "fx"; g--; )
                    if ((c = j._data(h[g], a + "queueHooks")) && c.empty)
                        f++, c.empty.add(k);
                k();
                return d.promise(b)
            }});
        var ya, yb, eb = /[\t\r\n]/g, Zb = /\r/g, $b = /^(?:input|select|textarea|button|object)$/i,
                ac = /^(?:a|area)$/i, zb = /^(?:checked|selected|autofocus|autoplay|async|controls|defer|disabled|hidden|loop|multiple|open|readonly|required|scoped)$/i, fb = /^(?:checked|selected)$/i, va = j.support.getSetAttribute, gb = j.support.input;
        j.fn.extend({attr: function(a, b) {
                ...
                if (b)
                    for (b = (a || "").match(ja) || []; g < e; g++)
                        if (c = this[g], f = 1 === c.nodeType && (c.className ? (" " + c.className + " ").replace(eb, " ") : " ")) {
                            for (h = 0; d = b[h++]; )
                                0 > f.indexOf(" " + d + " ") && (f += d + " ");
                ...
                return j.isFunction(a) ? this.each(function(c) {
                    ...
                    if ("string" === c)
                        for (var d, h = 0, g = j(this), e = b, k = a.match(ja) || []; d = k[h++]; )
                            e = f ? e : !g.hasClass(d), g[e ? "addClass" : "removeClass"](d);
                    else if (c === E || "boolean" === c)
                        this.className && j._data(this, "__className__", this.className), this.className = this.className || !1 === a ? "" : j._data(this, "__className__") || ""
                })
            }, hasClass: function(a) {
                for (var a = " " + a + " ", b = 0, c = this.length; b < c; b++)
                    if (1 === this[b].nodeType && 0 <= (" " + this[b].className + " ").replace(eb, " ").indexOf(a))
                        return!0;
                return!1
            },
            val: function(a) {
                var b, c, f, d = this[0];
                if (arguments.length)
                    return f = j.isFunction(a), this.each(function(b) {
                        var d = j(this);
                        if (1 === this.nodeType && (b = f ? a.call(this, b, d.val()) : a, null == b ? b = "" : "number" === typeof b ? b += "" : j.isArray(b) && (b = j.map(b, function(a) {
                            return null == a ? "" : a + ""
                        })), c = j.valHooks[this.type] || j.valHooks[this.nodeName.toLowerCase()], !c || !("set"in c) || c.set(this, b, "value") === e))
                            this.value = b
                    });
                if (d) {
                    if ((c = j.valHooks[d.type] || j.valHooks[d.nodeName.toLowerCase()]) && "get"in c && (b = c.get(d, "value")) !==
                        ...
                        return b;
                    b = d.value;
                    return"string" === typeof b ? b.replace(Zb, "") : null == b ? "" : b
                }
            }});
        j.extend({valHooks: {option: {get: function(a) {
                ...
                if (a && !(3 === d || 8 === d || 2 === d)) {
                    if (typeof a.getAttribute === E)
                        return j.prop(a, b, c);
                    if (d = 1 !== d || !j.isXMLDoc(a))
                        b = b.toLowerCase(), f = j.attrHooks[b] || (zb.test(b) ? yb : ya);
                    if (c !== e)
                        if (null === c)
                            j.removeAttr(a, b);
                        else {
                            if (f && d && "set"in f && (h = f.set(a, c, b)) !== e)
                                return h;
                            a.setAttribute(b, c + "");
                            return c
                        }
                    else {
                        if (f && d && "get"in f && null !== (h = f.get(a, b)))
                            return h;
                ...
                var c, f, d = 0, h = b && b.match(ja);
                if (h && 1 === a.nodeType)
                    for (; c = h[d++]; )
                        f = j.propFix[c] || c, zb.test(c) ? !va && fb.test(c) ? a[j.camelCase("default-" + c)] = a[f] = !1 : a[f] = !1 : j.attr(a, c, ""), a.removeAttribute(va ? c : f)
                ...
                h = a.nodeType;
                if (a && !(3 === h || 8 === h || 2 === h)) {
                    if (h = 1 !== h || !j.isXMLDoc(a))
                        b = j.propFix[b] || b, d = j.propHooks[b];
                    return c !== e ? d && "set"in d && (f = d.set(a, c, b)) !== e ? f : a[b] = c : d && "get"in
                            d && null !== (f = d.get(a, b)) ? f : a[b]
                }
            }, propHooks: {tabIndex: {get: function(a) {
                        var b = a.getAttributeNode("tabindex");
                        return b && b.specified ? parseInt(b.value, 10) : $b.test(a.nodeName) || ac.test(a.nodeName) && a.href ? 0 : e
                    }}}});
        yb = {get: function(a, b) {
                var c = j.prop(a, b), f = "boolean" === typeof c && a.getAttribute(b);
                return(c = "boolean" === typeof c ? gb && va ? null != f : fb.test(b) ? a[j.camelCase("default-" + b)] : !!f : a.getAttributeNode(b)) && !1 !== c.value ? b.toLowerCase() : e
            }, set: function(a, b, c) {
                !1 === b ? j.removeAttr(a, c) : gb && va || !fb.test(c) ?
                        a.setAttribute(!va && j.propFix[c] || c, c) : a[j.camelCase("default-" + c)] = a[c] = !0;
                return c
            }};
        if (!gb || !va)
            j.attrHooks.value = {get: function(a, b) {
                    var c = a.getAttributeNode(b);
                    return j.nodeName(a, "input") ? a.defaultValue : c && c.specified ? c.value : e
                }, set: function(a, b, c) {
                    if (j.nodeName(a, "input"))
                        a.defaultValue = b;
                    else
                        return ya && ya.set(a, b, c)
                }};
        va || (ya = j.valHooks.button = {get: function(a, b) {
                var c = a.getAttributeNode(b);
            ...
            }}, j.attrHooks.contenteditable = {get: ya.get, set: function(a, b, c) {
                ya.set(a, "" === b ? !1 : b, c)
        ...
        j.each(["radio", "checkbox"], function() {
            j.valHooks[this] = j.extend(j.valHooks[this], {set: function(a, b) {
                    if (j.isArray(b))
                        return a.checked = 0 <= j.inArray(j(a).val(), b)
                }})
        });
        var hb = /^(?:input|select|textarea)$/i, bc = /^key/, cc = /^(?:mouse|contextmenu)|click/, Ab = /^(?:focusinfocus|focusoutblur)$/, Bb = /^([^.]*)(?:\.(.+)|)$/;
        j.event = {global: {}, add: function(a,
                    b, c, f, d) {
                var h, g, k, l, m, t, n, s, L;
                if (k = j._data(a)) {
                    ...
                    for (k = b.length; k--; ) {
                        ...
                        L = (h[2] || "").split(".").sort();
                        h = j.event.special[s] || {};
                        s = (d ? h.delegateType : h.bindType) || s;
                        h = j.event.special[s] || {};
                        t = j.extend({type: s,
                            origType: t, data: f, handler: c, guid: c.guid, selector: d, needsContext: d && j.expr.match.needsContext.test(d), namespace: L.join(".")}, l);
                        if (!(n = g[s]))
                            if (n = g[s] = [], n.delegateCount = 0, !h.setup || !1 === h.setup.call(a, f, L, m))
                                a.addEventListener ? a.addEventListener(s, m, !1) : a.attachEvent && a.attachEvent("on" + s, m);
                        h.add && (h.add.call(a, t), t.handler.guid || (t.handler.guid = c.guid));
                        d ? n.splice(n.delegateCount++, 0, t) : n.push(t);
                        j.event.global[s] = !0
                    }
                    a = null
                }
            }, remove: function(a, b, c, f, d) {
                var h, g, e, k, l, m, t, n, s, L, da, A = j.hasData(a) &&
                        j._data(a);
                if (A && (m = A.events)) {
                    b = (b || "").match(ja) || [""];
                    for (l = b.length; l--; )
                        if (e = Bb.exec(b[l]) || [], s = da = e[1], L = (e[2] || "").split(".").sort(), s) {
                            t = j.event.special[s] || {};
                            s = (f ? t.delegateType : t.bindType) || s;
                            n = m[s] || [];
                            e = e[2] && RegExp("(^|\\.)" + L.join("\\.(?:.*\\.|)") + "(\\.|$)");
                            for (k = h = n.length; h--; )
                                if (g = n[h], (d || da === g.origType) && (!c || c.guid === g.guid) && (!e || e.test(g.namespace)) && (!f || f === g.selector || "**" === f && g.selector))
                                    n.splice(h, 1), g.selector && n.delegateCount--, t.remove && t.remove.call(a, g);
                            k && !n.length &&
                                    ((!t.teardown || !1 === t.teardown.call(a, L, A.handle)) && j.removeEvent(a, s, A.handle), delete m[s])
                        } else
                            for (s in m)
                                j.event.remove(a, s + b[l], c, f, !0);
                    j.isEmptyObject(m) && (delete A.handle, j._removeData(a, "events"))
                }
            }, trigger: function(b, c, f, d) {
                var h, g, k, l, m, t, n = [f || z], s = Ga.call(b, "type") ? b.type : b;
                m = Ga.call(b, "namespace") ? b.namespace.split(".") : [];
                k = h = f = f || z;
                if (!(3 === f.nodeType || 8 === f.nodeType) && !Ab.test(s + j.event.triggered))
                    if (0 <= s.indexOf(".") && (m = s.split("."), s = m.shift(), m.sort()), g = 0 > s.indexOf(":") && "on" +
                            s, b = b[j.expando] ? b : new j.Event(s, "object" === typeof b && b), b.isTrigger = !0, b.namespace = m.join("."), b.namespace_re = b.namespace ? RegExp("(^|\\.)" + m.join("\\.(?:.*\\.|)") + "(\\.|$)") : null, b.result = e, b.target || (b.target = f), c = null == c ? [b] : j.makeArray(c, [b]), m = j.event.special[s] || {}, d || !(m.trigger && !1 === m.trigger.apply(f, c))) {
                        if (!d && !m.noBubble && !j.isWindow(f)) {
                            l = m.delegateType || s;
                            Ab.test(l + s) || (k = k.parentNode);
                            for (; k; k = k.parentNode)
                                n.push(k), h = k;
                            if (h === (f.ownerDocument || z))
                                n.push(h.defaultView || h.parentWindow ||
                                        a)
                        }
                        for (t = 0; (k = n[t++]) && !b.isPropagationStopped(); )
                            b.type = 1 < t ? l : m.bindType || s, (h = (j._data(k, "events") || {})[b.type] && j._data(k, "handle")) && h.apply(k, c), (h = g && k[g]) && (j.acceptData(k) && h.apply && !1 === h.apply(k, c)) && b.preventDefault();
                        b.type = s;
                        if (!d && !b.isDefaultPrevented() && (!m._default || !1 === m._default.apply(f.ownerDocument, c)) && !("click" === s && j.nodeName(f, "a")) && j.acceptData(f) && g && f[s] && !j.isWindow(f)) {
                            (h = f[g]) && (f[g] = null);
                            j.event.triggered = s;
                            try {
                                f[s]()
            ...
            dispatch: function(a) {
                var a = j.event.fix(a), b, c, f, d, h = [], g = ua.call(arguments);
                    ...
                    for (b = 0; (f = h[b++]) && !a.isPropagationStopped(); ) {
                        ...
                        for (d = 0; (c = f.handlers[d++]) && !a.isImmediatePropagationStopped(); )
                            if (!a.namespace_re || a.namespace_re.test(c.namespace))
                                if (a.handleObj = c, a.data = c.data, c = ((j.event.special[c.origType] ||
                                        {}).handle || c.handler).apply(f.elem, g), c !== e && !1 === (a.result = c))
                ...
                if (k && l.nodeType && (!a.button || "click" !== a.type))
                    for (; l != this; l = l.parentNode || this)
                        if (1 === l.nodeType && (!0 !== l.disabled || "click" !== a.type)) {
                            d = [];
                            for (h = 0; h < k; h++)
                                f = b[h], c = f.selector + " ", d[c] === e && (d[c] = f.needsContext ? 0 <= j(c, this).index(l) : j.find(c, this, null, [l]).length),
                                        d[c] && d.push(f);
                ...
                h || (this.fixHooks[b] = h = cc.test(b) ? this.mouseHooks : bc.test(b) ? this.keyHooks : {});
                f = h.props ? this.props.concat(h.props) : this.props;
                a = new j.Event(d);
                for (b = f.length; b--; )
                    c = f[b], a[c] = d[c];
                a.target || (a.target = d.srcElement || z);
                ...
                return h.filter ?
                    ...
                    null ==
                            a.pageX && null != b.clientX && (c = a.target.ownerDocument || z, f = c.documentElement, c = c.body, a.pageX = b.clientX + (f && f.scrollLeft || c && c.scrollLeft || 0) - (f && f.clientLeft || c && c.clientLeft || 0), a.pageY = b.clientY + (f && f.scrollTop || c && c.scrollTop || 0) - (f && f.clientTop || c && c.clientTop || 0));
                    !a.relatedTarget && h && (a.relatedTarget = h === a.target ? b.toElement : h);
                    !a.which && d !== e && (a.which = d & 1 ? 1 : d & 2 ? 3 : d & 4 ? 2 : 0);
                    return a
                }}, special: {load: {noBubble: !0}, click: {trigger: function() {
                        if (j.nodeName(this, "input") && "checkbox" === this.type && this.click)
                            return this.click(),
                                    !1
                        ...
                        if (this === z.activeElement && this.blur)
                            return this.blur(), !1
        ...
        j.removeEvent = z.removeEventListener ? function(a, b, c) {
        ...
        j.Event.prototype = {isDefaultPrevented: h, isPropagationStopped: h, isImmediatePropagationStopped: h, preventDefault: function() {
        ...
        j.each({mouseenter: "mouseover", mouseleave: "mouseout"}, function(a, b) {
            j.event.special[a] = {delegateType: b, bindType: b, handle: function(a) {
                    ...
                    if (!f || f !== this && !j.contains(this, f))
                        a.type = d.origType, c = d.handler.apply(this, arguments), a.type = b;
                    return c
                }}
        });
        j.support.submitBubbles || (j.event.special.submit = {setup: function() {
                ...
                j.event.add(this, "click._submit keypress._submit", function(a) {
                    ...
                    if ((a = j.nodeName(a, "input") || j.nodeName(a, "button") ?
                            a.form : e) && !j._data(a, "submitBubbles"))
        ...
        j.support.changeBubbles || (j.event.special.change = {setup: function() {
                ...
                j.event.add(this, "beforeactivate._change", function(a) {
                    a = a.target;
                    hb.test(a.nodeName) && !j._data(a, "changeBubbles") && (j.event.add(a, "change._change", function(a) {
        ...
        j.support.focusinBubbles || j.each({focus: "focusin", blur: "focusout"}, function(a, b) {
            ...
            j.event.special[b] = {setup: function() {
                    0 === c++ &&
                            z.addEventListener(a, f, !0)
                }, teardown: function() {
                    0 === --c && z.removeEventListener(a, f, !0)
                }}
        });
        j.fn.extend({on: function(a, b, c, f, d) {
                var g, k;
                if ("object" === typeof a) {
                ...
                if (a && a.preventDefault && a.handleObj)
                    return f = a.handleObj, j(a.delegateTarget).off(f.namespace ? f.origType + "." + f.namespace : f.origType, f.selector, f.handler), this;
                if ("object" === typeof a) {
                    for (f in a)
                        this.off(f, b, a[f]);
                    return this
                ...
                var c = this[0];
                if (c)
                    return j.event.trigger(a, b, c, !0)
            }});
        var ib = a, jb = function() {
            var a, b = [];
            ...
            var d, h, g, e, k;
            (b ? b.ownerDocument || b : Ha) !== ca && Pa(b);
            b = b || ca;
            c = c || [];
            if (!a || "string" !== typeof a)
                return c;
                ...
                if (d = Yc.exec(a))
                    if (g = d[1])
                        if (9 === e)
                            ...
                            if (b.ownerDocument && (h = b.ownerDocument.getElementById(g)) && kb(b, h) && h.id === g)
                                return c.push(h), c
                        }
                    else {
                        if (d[2])
                            return Qa.apply(c, Ra.call(b.getElementsByTagName(a),
                                    0)), c;
                        if ((g = d[3]) && S.getByClassName && b.getElementsByClassName)
                            return Qa.apply(c, Ra.call(b.getElementsByClassName(g), 0)), c
                    }
                if (S.qsa && !ra.test(a)) {
                    d = !0;
                    h = P;
                    ...
                    if (1 === e && "object" !== b.nodeName.toLowerCase()) {
                        ...
                        for (g = e.length; g--; )
                            e[g] = h + Ta(e[g]);
                        g = dc.test(a) && b.parentNode || b;
                        k = e.join(",")
                    }
                    if (k)
                        try {
                            return Qa.apply(c, Ra.call(g.querySelectorAll(k), 0)), c
                        } catch (j) {
                        } finally {
            ...
            a:{
                ...
                if (!f && 1 === h.length) {
                    d = h[0] = h[0].slice(0);
                    if (2 < d.length && "ID" === (l = d[0]).type && 9 === b.nodeType && !ma && B.relative[d[1].type]) {
                        b = B.find.ID(l.matches[0].replace(za, Aa), b)[0];
                        if (!b) {
                            l = c;
                            break a
                        }
                    ...
                    for (e = Db.needsContext.test(a) ? 0 : d.length; e--; ) {
                        l = d[e];
                        if (B.relative[g = l.type])
                            break;
                        if (g = B.find[g])
                            if (f = g(l.matches[0].replace(za, Aa), dc.test(d[0].type) && b.parentNode || b)) {
                                d.splice(e, 1);
                                a = f.length && Ta(d);
                                if (!a) {
                                    Qa.apply(c, Ra.call(f, 0));
                                    l = c;
                                    break a
                                }
                                break
                ...
                ec(a,
                        h)(f, b, ma, c, dc.test(a));
                l = c
            }
            return l
        }, Eb = function(a, b) {
            var c = b && a, f = c && (~b.sourceIndex || wc) - (~a.sourceIndex || wc);
            if (f)
                return f;
            if (c)
                for (; c = c.nextSibling; )
            ...
            for (k = B.preFilter; g; ) {
                if (!c || (f = $c.exec(g)))
                    f && (g = g.slice(f[0].length) || g), e.push(d = []);
                c = !1;
                if (f = ad.exec(g))
                    c = f.shift(), d.push({value: c, type: f[0].replace(Cb, " ")}), g = g.slice(c.length);
                for (h in B.filter)
                    if ((f = Db[h].exec(g)) && (!k[h] || (f = k[h](f))))
                        c = f.shift(), d.push({value: c, type: h, matches: f}), g = g.slice(c.length);
                if (!c)
                    break
            }
            return b ? g.length : g ? H.error(a) : xc(a, e).slice(0)
        }, Ta = function(a) {
            for (var b =
                    0, c = a.length, f = ""; b < c; b++)
                f += a[b].value;
            return f
        }, lb = function(a, b, c) {
            ...
            return b.first ? function(b, c, h) {
                ...
                if (g)
                    ...
                    for (; b = b[f]; )
                        if (1 === b.nodeType || d)
                            if (j = b[P] || (b[P] = {}), (k = j[f]) && k[0] === l) {
                                if (!0 === (e = k[1]) || e === Y)
                                    return!0 === e
                            } else if (k = j[f] = [l], k[1] = a(b, c, g) || Y, !0 === k[1])
                                return!0
            }
        }, mb = function(a) {
        ...
        }, Ua = function(a, b, c, f, d) {
            for (var h, g = [], e = 0, k = a.length, j = null != b; e < k; e++)
                if (h = a[e])
                    if (!c || c(h, f, d))
                        g.push(h), j && b.push(e);
            return g
        }, nb = function(a, b, c, f, d, h) {
            f && !f[P] && (f = nb(f));
            d && !d[P] && (d = nb(d, h));
            return fa(function(h, g, e, k) {
                var j, l, m = [], t = [], n = g.length, s;
                if (!(s = h)) {
                    s = b || "*";
                    for (var T = e.nodeType ? [e] : e, L = [], A = 0, da = T.length; A < da; A++)
                        H(s, T[A], L);
                    s = L
                }
                s = a && (h || !b) ? Ua(s, m, a, e, k) : s;
                T = c ? d || (h ? a : n || f) ? [] : g : s;
                c && c(s, T, e, k);
                if (f) {
                    j = Ua(T, t);
                ...
                if (h) {
                    if (d || a) {
                        ...
                        for (e = T.length; e--; )
                            if ((l = T[e]) && -1 < (j = d ? hc.call(h, l) : m[e]))
                                h[j] = !(g[j] = l)
                    }
                } else
                    T = Ua(T === g ? T.splice(n, T.length) : T), d ? d(null, g, T, k) : Qa.apply(g, T)
            })
        }, ob = function(a) {
            var b, c, f, d = a.length, h = B.relative[a[0].type];
            c = h || B.relative[" "];
            for (var g = h ? 1 : 0, e = lb(function(a) {
                return a === b
            }, c, !0), k = lb(function(a) {
                return-1 < hc.call(b, a)
            }, c, !0), j = [function(a, c, f) {
                    return!h &&
                            (f || c !== Fb) || ((b = c).nodeType ? e(a, c, f) : k(a, c, f))
                }]; g < d; g++)
                if (c = B.relative[a[g].type])
                    j = [lb(mb(j), c)];
                else {
                    c = B.filter[a[g].type].apply(null, a[g].matches);
                    if (c[P]) {
                        for (f = ++g; f < d && !B.relative[a[f].type]; f++)
                            ;
                        return nb(1 < g && mb(j), 1 < g && Ta(a.slice(0, g - 1)).replace(Cb, "$1"), c, g < f && ob(a.slice(g, f)), f < d && ob(a = a.slice(f)), f < d && Ta(a))
                    }
                    j.push(c)
                }
            return mb(j)
        }, L = function() {
        }, da, Y, B, Gb, yc, ec, Va, Fb, Pa, ca, ga, ma, ra, Wa, Hb, kb, ic, P = "sizzle" + -new Date, Ha = ib.document, S = {}, sa = 0, bd = 0, zc = jb(), xc = jb(), Ac = jb(), wc = -2147483648,
                Ib = [], cd = Ib.pop, Qa = Ib.push, Ra = Ib.slice, hc = Ib.indexOf || function(a) {
            for (var b = 0, c = this.length; b < c; b++)
                if (this[b] === a)
                    return b;
            return-1
        }, Bc = "(?:\\\\.|[\\w-]|[^\\x00-\\xa0])+".replace("w", "w#"), Cc = "\\[[\\x20\\t\\r\\n\\f]*((?:\\\\.|[\\w-]|[^\\x00-\\xa0])+)[\\x20\\t\\r\\n\\f]*(?:([*^$|!~]?=)[\\x20\\t\\r\\n\\f]*(?:(['\"])((?:\\\\.|[^\\\\])*?)\\3|(" + Bc + ")|)|)[\\x20\\t\\r\\n\\f]*\\]", jc = ":((?:\\\\.|[\\w-]|[^\\x00-\\xa0])+)(?:\\(((['\"])((?:\\\\.|[^\\\\])*?)\\3|((?:\\\\.|[^\\\\()[\\]]|" + Cc.replace(3, 8) + ")*)|.*)\\)|)",
                Cb = RegExp("^[\\x20\\t\\r\\n\\f]+|((?:^|[^\\\\])(?:\\\\.)*)[\\x20\\t\\r\\n\\f]+$", "g"), $c = /^[\x20\t\r\n\f]*,[\x20\t\r\n\f]*/, ad = /^[\x20\t\r\n\f]*([\x20\t\r\n\f>+~])[\x20\t\r\n\f]*/, dd = RegExp(jc), ed = RegExp("^" + Bc + "$"), Db = {ID: /^#((?:\\.|[\w-]|[^\x00-\xa0])+)/, CLASS: /^\.((?:\\.|[\w-]|[^\x00-\xa0])+)/, NAME: /^\[name=['"]?((?:\\.|[\w-]|[^\x00-\xa0])+)['"]?\]/, TAG: RegExp("^(" + "(?:\\\\.|[\\w-]|[^\\x00-\\xa0])+".replace("w", "w*") + ")"), ATTR: RegExp("^" + Cc), PSEUDO: RegExp("^" + jc), CHILD: RegExp("^:(only|first|last|nth|nth-last)-(child|of-type)(?:\\([\\x20\\t\\r\\n\\f]*(even|odd|(([+-]|)(\\d*)n|)[\\x20\\t\\r\\n\\f]*(?:([+-]|)[\\x20\\t\\r\\n\\f]*(\\d+)|))[\\x20\\t\\r\\n\\f]*\\)|)",
                    "i"), needsContext: RegExp("^[\\x20\\t\\r\\n\\f]*[>+~]|:(even|odd|eq|gt|lt|nth|first|last)(?:\\([\\x20\\t\\r\\n\\f]*((?:-\\d)?\\d*)[\\x20\\t\\r\\n\\f]*\\)|)(?=[^-]|$)", "i")}, dc = /[\x20\t\r\n\f]*[+~]/, kc = /^[^{]+\{\s*\[native code/, Yc = /^(?:#([\w-]+)|(\w+)|\.([\w-]+))$/, fd = /^(?:input|select|textarea|button)$/i, gd = /^h\d$/i, Zc = /'|\\/g, hd = /\=[\x20\t\r\n\f]*([^'"\]]*)[\x20\t\r\n\f]*\]/g, za = /\\([\da-fA-F]{1,6}[\x20\t\r\n\f]?|.)/g, Aa = function(a, b) {
            var c = "0x" + b - 65536;
            return c !== c ? b : 0 > c ? String.fromCharCode(c + 65536) :
                    String.fromCharCode(c >> 10 | 55296, c & 1023 | 56320)
        };
        try {
            Ra.call(Ha.documentElement.childNodes, 0)[0].nodeType
        } catch (Gd) {
            Ra = function(a) {
        ...
        Pa = H.setDocument = function(a) {
            var b = a ? a.ownerDocument || a : Ha;
            if (b === ca || 9 !== b.nodeType || !b.documentElement)
                return ca;
            ca = b;
            ...
            S.getByName = qa(function(a) {
                ...
                ga.insertBefore(a,
                        ga.firstChild);
                var c = b.getElementsByName && b.getElementsByName(P).length === 2 + b.getElementsByName(P + 0).length;
                S.getIdNotName = !b.getElementById(P);
                ga.removeChild(a);
                return c
            });
            B.attrHandle = qa(function(a) {
            ...
            S.getIdNotName ? (B.find.ID = function(a, b) {
                if ("undefined" !==
            ...
            B.find.TAG = S.tagNameNoComments ? function(a, b) {
            ...
            B.find.NAME = S.getByName && function(a, b) {
                if ("undefined" !== typeof b.getElementsByName)
                    return b.getElementsByName(name)
            };
            B.find.CLASS = S.getByClassName && function(a, b) {
            ...
            Wa = [];
            ra = [":focus"];
            if (S.qsa = kc.test(b.querySelectorAll + ""))
                qa(function(a) {
            ...
            var a = S, c;
            c = Hb = ga.matchesSelector || ga.mozMatchesSelector || ga.webkitMatchesSelector || ga.oMatchesSelector || ga.msMatchesSelector;
            c = kc.test(c + "");
            (a.matchesSelector = c) && qa(function(a) {
                S.disconnectedMatch = Hb.call(a, "div");
                Hb.call(a, "[s!='']:x");
                Wa.push("!=", jc)
            });
            ra = RegExp(ra.join("|"));
            Wa = RegExp(Wa.join("|"));
            kb = kc.test(ga.contains + "") || ga.compareDocumentPosition ? function(a, b) {
                var c = 9 ===
            ...
            ic = ga.compareDocumentPosition ? function(a, c) {
                var f;
                return a === c ? (Va = !0, 0) : (f = c.compareDocumentPosition && a.compareDocumentPosition && a.compareDocumentPosition(c)) ? f & 1 || a.parentNode && 11 === a.parentNode.nodeType ? a === b || kb(Ha, a) ? -1 : c === b || kb(Ha, c) ? 1 : 0 : f & 4 ? -1 : 1 : a.compareDocumentPosition ?
                        -1 : 1
            } : function(a, c) {
                var f, d = 0;
                f = a.parentNode;
                var h = c.parentNode, g = [a], e = [c];
                if (a === c)
                    return Va = !0, 0;
                if (!f || !h)
                    return a === b ? -1 : c === b ? 1 : f ? -1 : h ? 1 : 0;
                if (f === h)
                    return Eb(a, c);
                ...
                for (; g[d] === e[d]; )
                    d++;
                return d ? Eb(g[d], e[d]) : g[d] === Ha ? -1 : e[d] === Ha ? 1 : 0
            };
            Va = !1;
            [0, 0].sort(ic);
            S.detectDuplicates = Va;
            return ca
        };
        ...
        H.matchesSelector = function(a, b) {
            (a.ownerDocument || a) !== ca && Pa(a);
            b = b.replace(hd, "='$1']");
            if (S.matchesSelector && !ma && (!Wa || !Wa.test(b)) && !ra.test(b))
                try {
                    var c = Hb.call(a, b);
                    if (c || S.disconnectedMatch || a.document && 11 !== a.document.nodeType)
                        return c
                } catch (f) {
                }
        ...
        H.attr = function(a, b) {
            ...
            (a.ownerDocument || a) !== ca && Pa(a);
            ma || (b = b.toLowerCase());
            return(c = B.attrHandle[b]) ? c(a) : ma || S.attributes ? a.getAttribute(b) : ((c = a.getAttributeNode(b)) || a.getAttribute(b)) && !0 === a[b] ? b : c && c.specified ? c.value :
            null
        };
        H.error = function(a) {
        ...
        B = H.selectors = {cacheLength: 50, createPseudo: fa, match: Db, find: {}, relative: {">": {dir: "parentNode", first: !0}, " ": {dir: "parentNode"}, "+": {dir: "previousSibling", first: !0}, "~": {dir: "previousSibling"}}, preFilter: {ATTR: function(a) {
                    a[1] = a[1].replace(za, Aa);
                    ...
                    var b, c = !a[5] && a[2];
                    if (Db.CHILD.test(a[0]))
                        return null;
                    if (a[4])
                        a[2] = a[4];
                    else if (c && dd.test(c) && (b = Sa(c, !0)) && (b = c.indexOf(")", c.length - b) - c.length))
                    ...
                    return 1 === f && 0 === d ? function(a) {
                        ...
                        var j, l, m, t, Q, c = h !== g ? "nextSibling" : "previousSibling", n = b.parentNode, Ca = e && b.nodeName.toLowerCase(), k = !k && !e;
                        if (n) {
                            if (h) {
                                for (; c; ) {
                                    for (l = b; l = l[c]; )
                                        if (e ? l.nodeName.toLowerCase() === Ca : 1 === l.nodeType)
                                            return!1;
                                    Q = c = "only" === a && !Q && "nextSibling"
                                }
                                return!0
                            }
                            Q = [g ? n.firstChild : n.lastChild];
                            if (g && k) {
                                k = n[P] || (n[P] = {});
                                j = k[a] || [];
                                t = j[0] === sa && j[1];
                                m = j[0] === sa && j[2];
                                for (l = t && n.childNodes[t]; l = ++t && l && l[c] ||
                                        (m = t = 0) || Q.pop(); )
                                    if (1 === l.nodeType && ++m && l === b) {
                                        k[a] = [sa, t, m];
                                        break
                                    }
                            } else if (k && (j = (b[P] || (b[P] = {}))[a]) && j[0] === sa)
                                m = j[1];
                            else
                                for (; l = ++t && l && l[c] || (m = t = 0) || Q.pop(); )
                                    if ((e ? l.nodeName.toLowerCase() === Ca : 1 === l.nodeType) && ++m)
                                        if (k && ((l[P] || (l[P] = {}))[a] = [sa, m]), l === b)
                                            break;
                            m -= d;
                    ...
                    var c, f = B.pseudos[a] || B.setFilters[a.toLowerCase()] || H.error("unsupported pseudo: " + a);
                    return f[P] ? f(b) : 1 < f.length ? (c = [a, a, "", b], B.setFilters.hasOwnProperty(a.toLowerCase()) ?
                            fa(function(a, c) {
                                for (var d, h = f(a, b), g = h.length; g--; )
                                    d = hc.call(a, h[g]), a[d] = !(c[d] = h[g])
                            }) : function(a) {
                        return f(a, 0, c)
                    }) : f
                }}, pseudos: {not: fa(function(a) {
                    var b = [], c = [], f = ec(a.replace(Cb, "$1"));
                    return f[P] ? fa(function(a, b, c, d) {
                    ...
                    return function(b) {
                        return-1 < (b.textContent || b.innerText || Gb(b)).indexOf(a)
                    }
                }),
                lang: fa(function(a) {
                    ...
                    return function(b) {
                        var c;
                        do
                            if (c = ma ? b.getAttribute("xml:lang") || b.getAttribute("lang") : b.lang)
                ...
                input: function(a) {
                    ...
                    return[b - 1]
                }), eq: wa(function(a, b, c) {
                    return[0 > c ? c + b : c]
                }), even: wa(function(a, b) {
                    for (var c = 0; c < b; c += 2)
                        a.push(c);
                    return a
                }), odd: wa(function(a, b) {
                    for (var c = 1; c <
                        ...
                        a.push(c);
                    return a
                }), lt: wa(function(a, b, c) {
                    for (b = 0 > c?c + b:c; 0 <= --b; )
                        a.push(b);
                    return a
                }), gt: wa(function(a, b, c) {
                    for (c = 0 > c?c + b:c; ++c < b; )
                        a.push(c);
                    return a
                })}};
        for (da in{radio:!0, checkbox:!0, file:!0, password:!0, image:!0})
            B.pseudos[da] = fc(da);
        for (da in{submit:!0, reset:!0})
            B.pseudos[da] = gc(da);
        ec = H.compile = function(a, b) {
            var c, f = [], d = [], h = Ac[a + " "];
            if (!h) {
                b || (b = Sa(a));
                for (c = b.length; c--; )
                    h = ob(b[c]), h[P] ? f.push(h) : d.push(h);
                var g = 0, e = 0 < f.length, k = 0 < d.length;
                c = function(a, b, c, h, j) {
                    var p, l, m = [], t = 0, n =
                            "0", Q = a && [], s = null != j, Ca = Fb, L = a || k && B.find.TAG("*", j && b.parentNode || b), A = sa += null == Ca ? 1 : Math.random() || 0.1;
                    s && (Fb = b !== ca && b, Y = g);
                    for (; null != (j = L[n]); n++) {
                        if (k && j) {
                            for (p = 0; l = d[p++]; )
                    ...
                    if (e && n !== t) {
                        ...
                        if (a) {
                            if (0 < t)
                                for (; n--; )
                                    !Q[n] && !m[n] && (m[n] = cd.call(h));
                            m = Ua(m)
                        }
                        Qa.apply(h, m);
                        s && (!a && 0 < m.length && 1 < t + f.length) && H.uniqueSort(h)
                    }
                    s && (sa = A, Fb = Ca);
                    return Q
                };
        ...
        B.pseudos.nth =
                B.pseudos.eq;
        B.filters = L.prototype = B.pseudos;
        B.setFilters = new L;
        Pa();
        H.attr = j.attr;
        j.find = H;
        ...
        var id = /Until$/, jd = /^(?:parents|prev(?:Until|All))/, Tc = /^.[^:#\[\.,]*$/, Dc = j.expr.match.needsContext, kd = {children: !0, contents: !0, next: !0, prev: !0};
        j.fn.extend({find: function(a) {
                var b, c, f, d = this.length;
                if ("string" !== typeof a)
                    return f = this, this.pushStack(j(a).filter(function() {
                        for (b = 0; b <
                                d; b++)
                            if (j.contains(f[b], this))
                                return!0
                    }));
                c = [];
                for (b = 0; b < d; b++)
                ...
                var c = "string" === typeof a ? j(a, b) : j.makeArray(a && a.nodeType ? [a] : a), c = j.merge(this.get(), c);
        ...
        j.extend({filter: function(a, b, c) {
                ...
                for (var f = [], a = a[b]; a && 9 !== a.nodeType && (c === e || 1 !== a.nodeType || !j(a).is(c)); )
        ...
        var sc = "abbr|article|aside|audio|bdi|canvas|data|datalist|details|figcaption|figure|footer|header|hgroup|mark|meter|nav|output|progress|section|summary|time|video", ld = / jQuery\d+="(?:null|\d+)"/g, Ec = RegExp("<(?:" + sc + ")[\\s/>]", "i"), lc = /^\s+/, Fc = /<(?!area|br|col|embed|hr|img|input|link|meta|param)(([\w:]+)[^>]*)\/>/gi, Gc = /<([\w:]+)/, Hc = /<tbody/i, md = /<|&#?\w+;/, nd = /<(?:script|style|link)/i,
                Mb = /^(?:checkbox|radio)$/i, od = /checked\s*(?:[^=]|=\s*.checked.)/i, Ic = /^$|\/(?:java|ecma)script/i, Uc = /^true\/(.*)/, pd = /^\s*<!(?:\[CDATA\[|--)|(?:\]\]|--)>\s*$/g, ia = {option: [1, "<select multiple='multiple'>", "</select>"], legend: [1, "<fieldset>", "</fieldset>"], area: [1, "<map>", "</map>"], param: [1, "<object>", "</object>"], thead: [1, "<table>", "</table>"], tr: [2, "<table><tbody>", "</tbody></table>"], col: [2, "<table><tbody></tbody><colgroup>", "</colgroup></table>"], td: [3, "<table><tbody><tr>", "</tr></tbody></table>"],
                    _default: j.support.htmlSerialize ? [0, "", ""] : [1, "X<div>", "</div>"]}, mc = n(z).appendChild(z.createElement("div"));
        ia.optgroup = ia.option;
        ia.tbody = ia.tfoot = ia.colgroup = ia.caption = ia.thead;
        ia.th = ia.td;
        j.fn.extend({text: function(a) {
                return j.access(this, function(a) {
                    return a === e ? j.text(this) : this.empty().append((this[0] && this[0].ownerDocument || z).createTextNode(a))
                ...
                return this.each(function(c) {
                    j(this).wrapAll(b ? a.call(this, c) :
                            a)
                })
            }, unwrap: function() {
                ...
                for (var c, f = 0; null != (c = this[f]); f++)
                    if (!a || 0 < j.filter(a, [c]).length)
                        !b && 1 === c.nodeType && j.cleanData(u(c)), c.parentNode && (b && j.contains(c.ownerDocument, c) && r(u(c, "script")), c.parentNode.removeChild(c));
                return this
            }, empty: function() {
                for (var a, b = 0; null != (a = this[b]); b++) {
                    for (1 === a.nodeType && j.cleanData(u(a, !1)); a.firstChild; )
                ...
                return j.access(this, function(a) {
                    ...
                    if (a === e)
                        return 1 === b.nodeType ? b.innerHTML.replace(ld, "") : e;
                    if ("string" === typeof a && !nd.test(a) && (j.support.htmlSerialize || !Ec.test(a)) && (j.support.leadingWhitespace || !lc.test(a)) && !ia[(Gc.exec(a) || ["", ""])[1].toLowerCase()]) {
                        a = a.replace(Fc, "<$1></$2>");
                        try {
                            for (; c < f; c++)
                                b = this[c] || {}, 1 === b.nodeType && (j.cleanData(u(b, !1)), b.innerHTML = a);
                            b = 0
                        } catch (d) {
                        }
                    }
                ...
                var a = sb.apply([], a), f, d, h, g, k = 0, l = this.length, m = this, t = l - 1, n =
                        a[0], s = j.isFunction(n);
                if (s || !(1 >= l || "string" !== typeof n || j.support.checkClone || !od.test(n)))
                    return this.each(function(f) {
                        var d = m.eq(f);
                        s && (a[0] = n.call(this, f, b ? d.html() : e));
                        d.domManip(a, b, c)
                    });
                if (l && (g = j.buildFragment(a, this[0].ownerDocument, !1, this), f = g.firstChild, 1 === g.childNodes.length && (g = f), f)) {
                    b = b && j.nodeName(f, "tr");
                    h = j.map(u(g, "script"), w);
                    for (d = h.length; k < l; k++)
                        f = g, k !== t && (f = j.clone(f, !0, !0), d && j.merge(h, u(f, "script"))), c.call(b && j.nodeName(this[k], "table") ? this[k].getElementsByTagName("tbody")[0] ||
                                this[k].appendChild(this[k].ownerDocument.createElement("tbody")) : this[k], f, k);
                    if (d) {
        ...
        j.each({appendTo: "append", prependTo: "prepend", insertBefore: "before", insertAfter: "after", replaceAll: "replaceWith"},
        function(a, b) {
            j.fn[a] = function(a) {
                for (var c = 0, f = [], d = j(a), h = d.length - 1; c <= h; c++)
                    a = c === h ? this : this.clone(!0), j(d[c])[b](a), $a.apply(f, a.get());
                return this.pushStack(f)
            }
        });
        j.extend({clone: function(a, b, c) {
                var f, d, h, g, e, k = j.contains(a.ownerDocument, a);
                j.support.html5Clone || j.isXMLDoc(a) || !Ec.test("<" + a.nodeName + ">") ? h = a.cloneNode(!0) : (mc.innerHTML = a.outerHTML, mc.removeChild(h = mc.firstChild));
                if ((!j.support.noCloneEvent || !j.support.noCloneChecked) && (1 === a.nodeType || 11 === a.nodeType) && !j.isXMLDoc(a)) {
                    ...
                    for (g = 0; null != (d = e[g]); ++g)
                        if (f[g]) {
                            var l = f[g], m = void 0, t = void 0, n = void 0;
                            if (1 === l.nodeType) {
                                m = l.nodeName.toLowerCase();
                                if (!j.support.noCloneEvent && l[j.expando]) {
                                    n = j._data(l);
                                    for (t in n.events)
                                        j.removeEvent(l, t, n.handle);
                                    l.removeAttribute(j.expando)
                                }
                                if ("script" === m && l.text !== d.text)
                                    w(l).text = d.text, q(l);
                                else if ("object" === m)
                                    l.parentNode && (l.outerHTML = d.outerHTML), j.support.html5Clone && (d.innerHTML && !j.trim(l.innerHTML)) && (l.innerHTML = d.innerHTML);
                                else if ("input" === m && Mb.test(d.type))
                                    l.defaultChecked =
                                            l.checked = d.checked, l.value !== d.value && (l.value = d.value);
                                else if ("option" === m)
                                    l.defaultSelected = l.selected = d.defaultSelected;
                                else if ("input" === m || "textarea" === m)
                                    l.defaultValue = d.defaultValue
                            }
                        }
                }
                if (b)
                ...
                for (var d, h, g, e, k, l, m = a.length, t = n(b), s = [], L = 0; L < m; L++)
                    if ((h = a[L]) || 0 === h)
                        if ("object" === j.type(h))
                            j.merge(s, h.nodeType ? [h] : h);
                        else if (md.test(h)) {
                            g =
                                    g || t.appendChild(b.createElement("div"));
                            e = (Gc.exec(h) || ["", ""])[1].toLowerCase();
                            l = ia[e] || ia._default;
                            g.innerHTML = l[1] + h.replace(Fc, "<$1></$2>") + l[2];
                            for (d = l[0]; d--; )
                                g = g.lastChild;
                            !j.support.leadingWhitespace && lc.test(h) && s.push(b.createTextNode(lc.exec(h)[0]));
                            if (!j.support.tbody)
                            ...
                            j.merge(s, g.childNodes);
                            for (g.textContent =
                                    ""; g.firstChild; )
                                g.removeChild(g.firstChild);
                            g = t.lastChild
                        } else
                            s.push(b.createTextNode(h));
                g && t.removeChild(g);
                j.support.appendChecked || j.grep(u(s, "input"), y);
                for (L = 0; h = s[L++]; )
                    if (!(f && -1 !== j.inArray(h, f)) && (a = j.contains(h.ownerDocument, h), g = u(t.appendChild(h), "script"), a && r(g), c))
                        for (d = 0; h = g[d++]; )
                            Ic.test(h.type || "") && c.push(h);
                return t
                ...
                for (var c, f, d, h, g = 0, e = j.expando, k = j.cache, l = j.support.deleteExpando, m = j.event.special; null != (c = a[g]); g++)
                    if (b || j.acceptData(c))
                        if (h = (d =
                            ...
                            if (h.events)
                                for (f in h.events)
                                    m[f] ? j.event.remove(c, f) : j.removeEvent(c, f, h.handle);
                            k[d] && (delete k[d], l ? delete c[e] : typeof c.removeAttribute !== E ? c.removeAttribute(e) : c[e] = null, xa.push(d))
                        }
            }});
        var Ya, Ea, Fa, nc = /alpha\([^)]*\)/i, qd = /opacity\s*=\s*([^)]*)/, rd = /^(top|right|bottom|left)$/, sd = /^(none|table(?!-c[ea]).+)/, Jc = /^margin/, Vc = RegExp("^(" + Ka + ")(.*)$", "i"), qb = RegExp("^(" + Ka + ")(?!px)[a-z%]+$", "i"), td = RegExp("^([+-])=(" + Ka + ")", "i"), uc = {BODY: "block"}, ud = {position: "absolute", visibility: "hidden",
            display: "block"}, Kc = {letterSpacing: 0, fontWeight: 400}, Da = ["Top", "Right", "Bottom", "Left"], tc = ["Webkit", "O", "Moz", "ms"];
        j.fn.extend({css: function(a, b) {
                return j.access(this, function(a, b, c) {
                    var f, d = {}, h = 0;
                    if (j.isArray(b)) {
                        f = Ea(a);
                        for (c = b.length; h < c; h++)
                            d[b[h]] = j.css(a, b[h], !1, f);
                        return d
                    }
        ...
        j.extend({cssHooks: {opacity: {get: function(a, b) {
                    ...
                    }}}, cssNumber: {columnCount: !0, fillOpacity: !0, fontWeight: !0, lineHeight: !0, opacity: !0, orphans: !0, widows: !0, zIndex: !0, zoom: !0}, cssProps: {"float": j.support.cssFloat ? "cssFloat" : "styleFloat"}, style: function(a, b, c, f) {
                if (a && !(3 === a.nodeType || 8 === a.nodeType || !a.style)) {
                    ...
                    if (c !==
                            e) {
                        h = typeof c;
                        if ("string" === h && (d = td.exec(c)))
                            c = (d[1] + 1) * d[2] + parseFloat(j.css(a, b)), h = "number";
                        ...
                        return g && "get"in g && (d = g.get(a, !1, f)) !== e ? d : l[b]
                }
                ...
                var d, h = {};
                for (d in b)
                    h[d] = a.style[d], a.style[d] = b[d];
                c = c.apply(a, f || []);
                for (d in b)
                    a.style[d] = h[d];
                return c
            }});
        a.getComputedStyle ? (Ea = function(b) {
            return a.getComputedStyle(b, null)
        }, Fa = function(a, b, c) {
            var f, d = (c = c || Ea(a)) ? c.getPropertyValue(b) || c[b] : e, h = a.style;
            c && ("" === d && !j.contains(a.ownerDocument, a) && (d = j.style(a, b)), qb.test(d) &&
                    Jc.test(b) && (a = h.width, b = h.minWidth, f = h.maxWidth, h.minWidth = h.maxWidth = h.width = d, d = c.width, h.width = a, h.minWidth = b, h.maxWidth = f));
            return d
        }) : z.documentElement.currentStyle && (Ea = function(a) {
            return a.currentStyle
        }, Fa = function(a, b, c) {
            var f, d, h = (c = c || Ea(a)) ? c[b] : e, g = a.style;
            null == h && (g && g[b]) && (h = g[b]);
            if (qb.test(h) && !rd.test(b)) {
                c = g.left;
                if (d = (f = a.runtimeStyle) && f.left)
        ...
        j.each(["height",
            "width"], function(a, b) {
            j.cssHooks[b] = {get: function(a, c, f) {
                    if (c)
                        return 0 === a.offsetWidth && sd.test(j.css(a, "display")) ? j.swap(a, ud, function() {
                            return A(a, b, f)
                        }) : A(a, b, f)
                }, set: function(a, c, f) {
                    var d = f && Ea(a);
                    return t(a, c, f ? s(a, b, f, j.support.boxSizing && "border-box" === j.css(a, "boxSizing", !1, d), d) : 0)
                }}
        });
        j.support.opacity || (j.cssHooks.opacity = {get: function(a, b) {
                ...
                var c = a.style,
                        f = a.currentStyle, d = j.isNumeric(b) ? "alpha(opacity=" + 100 * b + ")" : "", h = f && f.filter || c.filter || "";
                c.zoom = 1;
                if ((1 <= b || "" === b) && "" === j.trim(h.replace(nc, "")) && c.removeAttribute)
                    if (c.removeAttribute("filter"), "" === b || f && !f.filter)
                        return;
                c.filter = nc.test(h) ? h.replace(nc, d) : h + " " + d
            }});
        j(function() {
            j.support.reliableMarginRight || (j.cssHooks.marginRight = {get: function(a, b) {
                    if (b)
                        return j.swap(a, {display: "inline-block"}, Fa, [a, "marginRight"])
                }});
            !j.support.pixelPosition && j.fn.position && j.each(["top", "left"], function(a,
                    b) {
                j.cssHooks[b] = {get: function(a, c) {
                        if (c)
                            return c = Fa(a, b), qb.test(c) ? j(a).position()[b] + "px" : c
                    }}
            })
        });
        ...
        j.each({margin: "", padding: "", border: "Width"}, function(a, b) {
            j.cssHooks[a + b] = {expand: function(c) {
                    for (var f = 0, d = {}, c = "string" === typeof c ? c.split(" ") :
                            [c]; 4 > f; f++)
                        d[a + Da[f] + b] = c[f] || c[f - 2] || c[0];
                    return d
                }};
            Jc.test(a) || (j.cssHooks[a + b].set = t)
        });
        var vd = /%20/g, Wc = /\[\]$/, Lc = /\r?\n/g, wd = /^(?:submit|button|image|reset|file)$/i, xd = /^(?:input|select|textarea|keygen)/i;
        j.fn.extend({serialize: function() {
                ...
                return this.map(function() {
                    ...
                    return this.name && !j(this).is(":disabled") && xd.test(this.nodeName) &&
                            !wd.test(a) && (this.checked || !Mb.test(a))
                }).map(function(a, b) {
                    var c = j(this).val();
        ...
        var Ia, Ba, oc = j.now(), pc = /\?/, yd =
                /#.*$/, Mc = /([?&])_=[^&]*/, zd = /^(.*?):[ \t]*([^\r\n]*)\r?$/mg, Ad = /^(?:GET|HEAD)$/, Bd = /^\/\//, Nc = /^([\w.+-]+:)(?:\/\/([^\/?#:]*)(?::(\d+)|)|)/, Oc = j.fn.load, Pc = {}, Nb = {}, Qc = "*/".concat("*");
        try {
            Ba = I.href
        } catch (Hd) {
            Ba = z.createElement("a"), Ba.href = "", Ba = Ba.href
        }
        Ia = Nc.exec(Ba.toLowerCase()) || [];
        j.fn.load = function(a, b, c) {
            if ("string" !== typeof a && Oc)
                return Oc.apply(this, arguments);
            var f, d, h, g = this, k = a.indexOf(" ");
            0 <= k && (f = a.slice(k, a.length), a = a.slice(0, k));
            j.isFunction(b) ? (c = b, b = e) : b && "object" === typeof b &&
                    (h = "POST");
        ...
        j.each(["get", "post"], function(a, b) {
            j[b] = function(a, c, f, d) {
                ...
                return j.ajax({url: a, type: b, dataType: d,
                    data: c, success: f})
            }
        });
        j.extend({active: 0, lastModified: {}, etag: {}, ajaxSettings: {url: Ba, type: "GET", isLocal: /^(?:about|app|app-storage|.+-extension|file|res|widget):$/.test(Ia[1]), global: !0, processData: !0, async: !0, contentType: "application/x-www-form-urlencoded; charset=UTF-8", accepts: {"*": Qc, text: "text/plain", html: "text/html", xml: "application/xml, text/xml", json: "application/json, text/javascript"}, contents: {xml: /xml/, html: /html/, json: /json/}, responseFields: {xml: "responseXML", text: "responseText"}, converters: {"* text": a.String,
                    "text html": !0, "text json": j.parseJSON, "text xml": j.parseXML}, flatOptions: {url: !0, context: !0}}, ajaxSetup: function(a, b) {
                return b ? F(F(a, j.ajaxSettings), b) : F(j.ajaxSettings, a)
            }, ajaxPrefilter: K(Pc), ajaxTransport: K(Nb), ajax: function(a, b) {
                function c(a, b, f, d) {
                    var p, t, q, Y, r = b;
                    if (2 !== J) {
                        J = 2;
                        ...
                        if (f) {
                            Y = n;
                            var d = x, u, Q, B, v, C = Y.contents, R = Y.dataTypes, U = Y.responseFields;
                            for (v in U)
                                v in f && (d[U[v]] = f[v]);
                            for (; "*" === R[0]; )
                                R.shift(), Q === e && (Q = Y.mimeType || d.getResponseHeader("Content-Type"));
                            if (Q)
                                for (v in C)
                                    if (C[v] && C[v].test(Q)) {
                                        R.unshift(v);
                            ...
                            B ? (B !== R[0] && R.unshift(B), Y = f[B]) : Y = void 0
                        }
                        if (200 <= a && 300 > a || 304 === a)
                            if (n.ifModified && ((f = x.getResponseHeader("Last-Modified")) && (j.lastModified[h] = f), (f = x.getResponseHeader("etag")) && (j.etag[h] = f)), 204 === a)
                                p = !0, r = "nocontent";
                            else if (304 === a)
                                p = !0, r = "notmodified";
                            else {
                                a:{
                                    ...
                                    Q = t.dataTypes.slice();
                                    B = Q[0];
                                    t.dataFilter && (q = t.dataFilter(q,
                                            t.dataType));
                                    if (Q[1])
                                        for (ea in t.converters)
                                            r[ea.toLowerCase()] = t.converters[ea];
                                    for (; f = Q[++u]; )
                                        if ("*" !== f) {
                                            if ("*" !== B && B !== f) {
                                                ea = r[B + " " + f] || r["* " + f];
                                                if (!ea)
                                                    for (G in r)
                                                        if (p = G.split(" "), p[1] === f && (ea = r[B + " " + p[0]] || r["* " + p[0]])) {
                                                            !0 === ea ? ea = r[G] : !0 !== r[G] && (f = p[0], Q.splice(u--, 0, f));
                                                            break
                                                        }
                                                if (!0 !== ea)
                                                    if (ea && t["throws"])
                                                        ...
                                                        try {
                                                            ...
                                                            p = {state: "parsererror", error: ea ? Ca : "No conversion from " + B + " to " + f};
                                                            break a
                                                        }
                                            }
                                            B = f
                                        }
                                    p = {state: "success", data: q}
                                }
                                r = p.state;
                                t = p.data;
                                q = p.error;
                        ...
                        x.status = a;
                        x.statusText = (b || r) + "";
                        p ? A.resolveWith(s, [t, r, x]) : A.rejectWith(s, [x, r, q]);
                        x.statusCode(w);
                        w = e;
                        l && L.trigger(p ? "ajaxSuccess" : "ajaxError", [x, n, p ? t : q]);
                        da.fireWith(s, [x, r]);
                        l && (L.trigger("ajaxComplete", [x, n]), --j.active || j.event.trigger("ajaxStop"))
                    }
                }
                "object" === typeof a && (b = a, a = e);
                var b = b || {}, f, d, h, g, k, l, m, t, n = j.ajaxSetup({}, b), s = n.context || n, L = n.context && (s.nodeType || s.jquery) ? j(s) : j.event, A = j.Deferred(), da = j.Callbacks("once memory"), w = n.statusCode || {}, q = {}, Y =
                        {}, J = 0, r = "canceled", x = {readyState: 0, getResponseHeader: function(a) {
                        var b;
                        if (2 === J) {
                            if (!t)
                                for (t = {}; b = zd.exec(g); )
                ...
                A.promise(x).complete = da.add;
                x.success = x.done;
                x.error = x.fail;
                n.url = ((a || n.url || Ba) + "").replace(yd, "").replace(Bd, Ia[1] + "//");
                n.type = b.method || b.type || n.method || n.type;
                n.dataTypes = j.trim(n.dataType || "*").toLowerCase().match(ja) || [""];
                null == n.crossDomain && (f = Nc.exec(n.url.toLowerCase()), n.crossDomain = !(!f || !(f[1] !== Ia[1] || f[2] !== Ia[2] || (f[3] || ("http:" === f[1] ? 80 : 443)) != (Ia[3] || ("http:" === Ia[1] ? 80 : 443)))));
                n.data && (n.processData && "string" !== typeof n.data) && (n.data =
                        j.param(n.data, n.traditional));
                V(Pc, n, b, x);
                if (2 === J)
                    return x;
                (l = n.global) && 0 === j.active++ && j.event.trigger("ajaxStart");
                n.type = n.type.toUpperCase();
                n.hasContent = !Ad.test(n.type);
                h = n.url;
                n.hasContent || (n.data && (h = n.url += (pc.test(h) ? "&" : "?") + n.data, delete n.data), !1 === n.cache && (n.url = Mc.test(h) ? h.replace(Mc, "$1_=" + oc++) : h + (pc.test(h) ? "&" : "?") + "_=" + oc++));
                n.ifModified && (j.lastModified[h] && x.setRequestHeader("If-Modified-Since", j.lastModified[h]), j.etag[h] && x.setRequestHeader("If-None-Match", j.etag[h]));
                ...
                for (d in n.headers)
                    x.setRequestHeader(d, n.headers[d]);
                if (n.beforeSend && (!1 === n.beforeSend.call(s, x, n) || 2 === J))
                    return x.abort();
                r = "abort";
        ...
        j.ajaxSetup({accepts: {script: "text/javascript, application/javascript, application/ecmascript, application/x-ecmascript"}, contents: {script: /(?:java|ecma)script/}, converters: {"text script": function(a) {
                    j.globalEval(a);
                    return a
                }}});
        ...
        j.ajaxTransport("script", function(a) {
            if (a.crossDomain) {
                var b, c = z.head || j("head")[0] || z.documentElement;
                return{send: function(f, d) {
                        ...
                        b.onload = b.onreadystatechange = function(a, c) {
                            if (c || !b.readyState || /loaded|complete/.test(b.readyState))
                                b.onload = b.onreadystatechange = null, b.parentNode && b.parentNode.removeChild(b),
        ...
        j.ajaxSetup({jsonp: "callback", jsonpCallback: function() {
                var a = Rc.pop() || j.expando + "_" + oc++;
                this[a] = !0;
                return a
            }});
        j.ajaxPrefilter("json jsonp", function(b, c, f) {
            var d, h, g, k = !1 !== b.jsonp && (qc.test(b.url) ? "url" : "string" === typeof b.data && !(b.contentType || "").indexOf("application/x-www-form-urlencoded") && qc.test(b.data) && "data");
            if (k || "jsonp" === b.dataTypes[0])
                return d = b.jsonpCallback =
                        j.isFunction(b.jsonpCallback) ? b.jsonpCallback() : b.jsonpCallback, k ? b[k] = b[k].replace(qc, "$1" + d) : !1 !== b.jsonp && (b.url += (pc.test(b.url) ? "&" : "?") + b.jsonp + "=" + d), b.converters["script json"] = function() {
        ...
        var Xa, pb, Cd = 0, rc = a.ActiveXObject && function() {
            for (var a in Xa)
                Xa[a](e, !0)
        };
        j.ajaxSettings.xhr =
        ...
        pb = j.ajaxSettings.xhr();
        j.support.cors = !!pb && "withCredentials"in pb;
        (pb = j.support.ajax = !!pb) && j.ajaxTransport(function(b) {
            if (!b.crossDomain || j.support.cors) {
                ...
                return{send: function(f, d) {
                        ...
                        c = function(a, f) {
                            ...
                            try {
                                if (c && (f || 4 === k.readyState))
                                    if (c = e, h && (k.onreadystatechange = j.noop, rc && delete Xa[h]), f)
                        ...
                        b.async ? 4 === k.readyState ? setTimeout(c) : (h = ++Cd, rc && (Xa || (Xa = {}, j(a).unload(rc)), Xa[h] = c), k.onreadystatechange = c) : c()
                    }, abort: function() {
                        c && c(e, !0)
                    }}
            }
        });
        var Ja, Jb, Dd = /^(?:toggle|show|hide)$/, Ed = RegExp("^(?:([+-])=|)(" + Ka + ")([a-z%]*)$", "i"), Fd = /queueHooks$/, rb = [function(a, b, c) {
                var f, d, h, g, e, k, l = this, m = a.style, n = {}, t = [], s = a.nodeType && C(a);
                c.queue || (e = j._queueHooks(a, "fx"), null == e.unqueued && (e.unqueued =
                        0, k = e.empty.fire, e.empty.fire = function() {
                            e.unqueued || k()
                ...
                if (1 === a.nodeType && ("height"in b || "width"in b))
                    c.overflow = [m.overflow, m.overflowX, m.overflowY], "inline" === j.css(a, "display") && "none" === j.css(a, "float") && (!j.support.inlineBlockNeedsLayout || "inline" === J(a.nodeName) ? m.display = "inline-block" : m.zoom = 1);
                ...
                for (d in b)
                    h = b[d], Dd.exec(h) && (delete b[d], f = f || "toggle" === h, h !== (s ? "hide" : "show") && t.push(d));
                if (b = t.length) {
                    h = j._data(a, "fxshow") || j._data(a, "fxshow", {});
                    "hidden"in h && (s = h.hidden);
                    f && (h.hidden = !s);
                    s ? j(a).show() : l.done(function() {
                        j(a).hide()
                    });
                    l.done(function() {
                        var b;
                    ...
                    for (d = 0; d < b; d++)
                        f = t[d], g = l.createTween(f, s ? h[f] : 0), n[f] = h[f] || j.style(a, f), f in h || (h[f] = g.start, s && (g.end =
                                g.start, g.start = "width" === f || "height" === f ? 1 : 0))
                }
            }], Za = {"*": [function(a, b) {
                    ...
                    if (h) {
                        ...
                        if ("px" !== f && e) {
                            ...
                            do
                                k = k || ".5", e /= k, j.style(d.elem, a, e + f);
        ...
        j.Animation = j.extend(na, {tweener: function(a, b) {
                j.isFunction(a) ? (b = a, a = ["*"]) : a = a.split(" ");
                for (var c, f = 0, d = a.length; f < d; f++)
                    c = a[f],
                            Za[c] = Za[c] || [], Za[c].unshift(b)
            }, prefilter: function(a, b) {
                b ? rb.unshift(a) : rb.push(a)
            }});
        j.Tween = M;
        M.prototype = {constructor: M, init: function(a, b, c, f, d, h) {
                this.elem = a;
                this.prop = c;
                this.easing = d || "swing";
                this.options = b;
        ...
        M.propHooks = {_default: {get: function(a) {
                    ...
                    if (j.fx.step[a.prop])
                        ...
                        a.elem.style && (null != a.elem.style[j.cssProps[a.prop]] || j.cssHooks[a.prop]) ? j.style(a.elem, a.prop, a.now + a.unit) : a.elem[a.prop] = a.now
                }}};
        ...
        j.each(["toggle", "show", "hide"], function(a, b) {
            ...
            j.fn[b] = function(a, f, d) {
                return null == a || "boolean" === typeof a ? c.apply(this, arguments) : this.animate(ka(b, !0), a, f, d)
            }
        });
        j.fn.extend({fadeTo: function(a, b, c, f) {
                return this.filter(C).css("opacity",
                        0).show().end().animate({opacity: b}, a, c, f)
                ...
                return this.each(function() {
                    var b = !0, d = null != a && a + "queueHooks",
                            h = j.timers, g = j._data(this);
                    if (d)
                        g[d] && g[d].stop && f(g[d]);
                    else
                        for (d in g)
                            g[d] && (g[d].stop && Fd.test(d)) && f(g[d]);
                    for (d = h.length; d--; )
                        if (h[d].elem === this && (null == a || h[d].queue === a))
                            h[d].anim.stop(c), b = !1, h.splice(d, 1);
                ...
                return this.each(function() {
                    ...
                    for (b = 0; b < h; b++)
                        f[b] && f[b].finish && f[b].finish.call(this);
                    delete c.finish
                })
            }});
        j.each({slideDown: ka("show"), slideUp: ka("hide"), slideToggle: ka("toggle"), fadeIn: {opacity: "show"}, fadeOut: {opacity: "hide"}, fadeToggle: {opacity: "toggle"}}, function(a, b) {
            j.fn[a] = function(a, c, f) {
                return this.animate(b, a, c, f)
            }
        });
        j.speed = function(a, b, c) {
            var f = a && "object" === typeof a ? j.extend({}, a) : {complete: c || !c && b || j.isFunction(a) && a, duration: a, easing: c && b || b && !j.isFunction(b) &&
                b};
        ...
        j.fx.interval = 13;
        j.fx.start = function() {
            Jb || (Jb = setInterval(j.fx.tick, j.fx.interval))
        };
        j.fx.stop = function() {
            clearInterval(Jb);
            Jb = null
        ...
        j.offset = {setOffset: function(a, b, c) {
                var f = j.css(a, "position");
                "static" === f && (a.style.position = "relative");
                var d = j(a), h = d.offset(), g = j.css(a,
                        "top"), e = j.css(a, "left"), k = {}, l = {};
        ...
        j.fn.extend({position: function() {
                if (this[0]) {
                    ...
                    "fixed" === j.css(f, "position") ? b = f.getBoundingClientRect() : (a = this.offsetParent(), b = this.offset(), j.nodeName(a[0],
                            "html") || (c = a.offset()), c.top += j.css(a[0], "borderTopWidth", !0), c.left += j.css(a[0], "borderLeftWidth", !0));
                    return{top: b.top - c.top - j.css(f, "marginTop", !0), left: b.left - c.left - j.css(f, "marginLeft", !0)}
                }
            }, offsetParent: function() {
                return this.map(function() {
                    for (var a = this.offsetParent || z.documentElement; a && !j.nodeName(a, "html") && "static" === j.css(a, "position"); )
                        a = a.offsetParent;
        ...
        j.each({scrollLeft: "pageXOffset", scrollTop: "pageYOffset"}, function(a, b) {
            ...
            j.fn[a] =
                    function(f) {
                        return j.access(this, function(a, f, d) {
                            var h = ha(a);
                            if (d === e)
                                return h ? b in h ? h[b] : h.document.documentElement[f] : a[f];
        ...
        j.each({Height: "height", Width: "width"}, function(a, b) {
            j.each({padding: "inner" + a, content: b, "": "outer" + a}, function(c, f) {
                j.fn[f] = function(f, d) {
                    var h = arguments.length && (c || "boolean" !== typeof f), g = c || (!0 === f || !0 === d ? "margin" : "border");
                    return j.access(this, function(b, c, f) {
                        return j.isWindow(b) ?
                                b.document.documentElement["client" + a] : 9 === b.nodeType ? (c = b.documentElement, Math.max(b.body["scroll" + a], c["scroll" + a], b.body["offset" + a], c["offset" + a], c["client" + a])) : f === e ? j.css(b, c, g) : j.style(b, c, f, g)
                    }, b, h ? f : e, h, null)
                }
            })
        });
    ...
    (function(a, e) {
        function c(c, d) {
            ...
            if ("area" === g) {
                g = c.parentNode;
                e = g.name;
                if (!c.href || !e || "map" !== g.nodeName.toLowerCase())
                    return!1;
                g = a("img[usemap=#" + e + "]")[0];
                return!!g && b(g)
            }
        ...
        a.extend(a.expr[":"], {data: a.expr.createPseudo ?
        ...
        a("<a>").outerWidth(1).jquery || a.each(["Width", "Height"], function(b, c) {
            ...
            var g = "Width" === c ? ["Left", "Right"] : ["Top", "Bottom"], l = c.toLowerCase(), w = {innerWidth: a.fn.innerWidth, innerHeight: a.fn.innerHeight, outerWidth: a.fn.outerWidth, outerHeight: a.fn.outerHeight};
            a.fn["inner" + c] = function(b) {
                return b === e ? w["inner" + c].call(this) : this.each(function() {
                    a(this).css(l, d(this, b) + "px")
                })
            };
            a.fn["outer" + c] = function(b, f) {
                return"number" !== typeof b ? w["outer" + c].call(this, b) : this.each(function() {
        ...
        a.extend(a.ui, {plugin: {add: function(b, c, d) {
                    ...
                    for (g in d)
                        b.plugins[g] = b.plugins[g] || [], b.plugins[g].push([c, d[g]])
                }, call: function(a, b, c) {
                    var d = a.plugins[b];
    ...
    (function(a, e) {
        ...
        a.widget = function(b, c, f) {
            var d, e, m, n, w = {}, q = b.split(".")[0], b = b.split(".")[1];
            d = q + "-" + b;
            f || (f = c, c = a.Widget);
            ...
            a.extend(m, e, {version: f.version,
            ...
            m.prototype = a.widget.extend(n, {widgetEventPrefix: e ? n.widgetEventPrefix : b}, w, {constructor: m,
        ...
        a.widget.extend = function(c) {
            for (var d = b.call(arguments, 1), f = 0, h = d.length, k, m; f < h; f++)
                for (k in d[f])
                    m = d[f][k], d[f].hasOwnProperty(k) && m !== e && (c[k] = a.isPlainObject(m) ? a.isPlainObject(c[k]) ? a.widget.extend({}, c[k], m) : a.widget.extend({}, m) : m);
            return c
        };
        a.widget.bridge =
                function(c, d) {
                    ...
                    a.fn[c] = function(h) {
                        var k = "string" === typeof h, m = b.call(arguments, 1), n = this, h = !k && m.length ? a.widget.extend.apply(null, [h].concat(m)) : h;
                        k ? this.each(function() {
                            var b, d = a.data(this, f);
                            if (!d)
                                return a.error("cannot call methods on " + c + " prior to initialization; attempted to call method '" + h + "'");
                            if (!a.isFunction(d[h]) || "_" === h.charAt(0))
                                return a.error("no such method '" + h + "' for " + c + " widget instance");
                            b = d[h].apply(d, m);
                            if (b !== d && b !== e)
                                return n = b && b.jquery ?
        ...
        a.Widget.prototype = {widgetName: "widget", widgetEventPrefix: "", defaultElement: "<div>", options: {disabled: !1, create: null}, _createWidget: function(b, d) {
                ...
                this._init()
            }, _getCreateOptions: a.noop, _getCreateEventData: a.noop, _create: a.noop, _init: a.noop,
            destroy: function() {
                this._destroy();
            ...
            option: function(b, c) {
                ...
                if ("string" === typeof b)
                    if (f = {}, d = b.split("."), b = d.shift(), d.length) {
                        ...
                        b = d.pop();
                        if (c === e)
                            return k[b] === e ? null : k[b];
                        k[b] = c
                    } else {
                        if (c === e)
                            return this.options[b] === e ? null : this.options[b];
                        f[b] = c
                    }
                this._setOptions(f);
                return this
                ...
                f ? (c = d = a(c), this.bindings = this.bindings.add(c)) : (f = c, c = this.element, d =
                        this.widget());
                a.each(f, function(f, n) {
                    function w() {
                        if (b || !(!0 === e.options.disabled || a(this).hasClass("ui-state-disabled")))
                            return("string" === typeof n ? e[n] : n).apply(e, arguments)
                    }
                    "string" !== typeof n && (w.guid = n.guid = n.guid || w.guid || a.guid++);
                    var q = f.match(/^(\w+)\s*(.*)$/), r = q[1] + e.eventNamespace;
                    (q = q[2]) ? d.delegate(q, r, w) : c.bind(r, w)
                })
            }, _off: function(a, b) {
        ...
        a.each({show: "fadeIn", hide: "fadeOut"}, function(b, c) {
            a.Widget.prototype["_" + b] = function(f, d, e) {
                ...
                var m, n = !d ? b : !0 === d || "number" === typeof d ? c : d.effect || c, d =
                        d || {};
                "number" === typeof d && (d = {duration: d});
                m = !a.isEmptyObject(d);
                d.complete = e;
                d.delay && f.delay(d.delay);
                if (m && a.effects && a.effects.effect[n])
                    f[b](d);
                else if (n !== b && f[n])
                    f[n](d.duration, d.easing, e);
                else
                    f.queue(function(c) {
                        a(this)[b]();
                        e && e.call(f[0]);
    ...
    (function(a) {
        ...
        a.widget("ui.mouse", {version: "1.10.2", options: {cancel: "input,textarea,button,select,option", distance: 1, delay: 0}, _mouseInit: function() {
                ...
                this.element.bind("mousedown." + this.widgetName, function(a) {
                    ...
                    if (!0 === a.data(b.target, c.widgetName + ".preventClickEvent"))
                        return a.removeData(b.target, c.widgetName + ".preventClickEvent"), b.stopImmediatePropagation(), !1
                });
                this.started =
                        !1
                ...
                if (!e) {
                    ...
                    var b = this, d = 1 === c.which, g = "string" === typeof this.options.cancel && c.target.nodeName ? a(c.target).closest(this.options.cancel).length : !1;
                    if (!d || g || !this._mouseCapture(c))
                        return!0;
                    this.mouseDelayMet =
                            !this.options.delay;
                ...
                if (a.ui.ie && (!document.documentMode || 9 > document.documentMode) && !c.button)
                    return this._mouseUp(c);
                if (this._mouseStarted)
                    return this._mouseDrag(c), c.preventDefault();
    ...
    (function(a, e) {
        ...
        a.ui = a.ui || {};
        var b, d = Math.max, g = Math.abs, l = Math.round, f = /left|center|right/, h = /top|center|bottom/, k = /[\+\-]\d+(\.[\d]+)?%?/, m = /^\w+/, n = /%$/, w = a.fn.position;
        a.position = {scrollbarWidth: function() {
                ...
                var c = b.isWindow ? "" : b.element.css("overflow-x"), f = b.isWindow ? "" : b.element.css("overflow-y"), c = "scroll" === c || "auto" === c && b.width < b.element[0].scrollWidth;
                ...
                return{element: b,
                    isWindow: c, offset: b.offset() || {left: 0, top: 0}, scrollLeft: b.scrollLeft(), scrollTop: b.scrollTop(), width: c ? b.width() : b.outerWidth(), height: c ? b.height() : b.outerHeight()}
            }};
        a.fn.position = function(b) {
            if (!b || !b.of)
                return w.apply(this, arguments);
            var b = a.extend({}, b), e, n, t, s, A, q, r = a(b.of), u = a.position.getWithinInfo(b.within), v = a.position.getScrollInfo(u), y = (b.collision || "flip").split(" "), F = {};
            q = r;
            var Z = q[0];
            q = 9 === Z.nodeType ? {width: q.width(), height: q.height(), offset: {top: 0, left: 0}} : a.isWindow(Z) ? {width: q.width(),
                height: q.height(), offset: {top: q.scrollTop(), left: q.scrollLeft()}} : Z.preventDefault ? {width: 0, height: 0, offset: {top: Z.pageY, left: Z.pageX}} : {width: q.outerWidth(), height: q.outerHeight(), offset: q.offset()};
            ...
            1 === y.length && (y[1] = y[0]);
            "right" === b.at[0] ? A.left += n : "center" === b.at[0] && (A.left += n / 2);
            "bottom" === b.at[1] ? A.top += t : "center" === b.at[1] && (A.top += t / 2);
            e = c(F.at, n, t);
            A.left += e[0];
            A.top += e[1];
            return this.each(function() {
                var f, h, k = a(this), m = k.outerWidth(), q = k.outerHeight(), w = parseInt(a.css(this, "marginLeft"), 10) || 0, J = parseInt(a.css(this, "marginTop"), 10) || 0, Z = m + w + (parseInt(a.css(this, "marginRight"),
                        10) || 0) + v.width, z = q + J + (parseInt(a.css(this, "marginBottom"), 10) || 0) + v.height, I = a.extend({}, A), ba = c(F.my, k.outerWidth(), k.outerHeight());
                "right" === b.my[0] ? I.left -= m : "center" === b.my[0] && (I.left -= m / 2);
                "bottom" === b.my[1] ? I.top -= q : "center" === b.my[1] && (I.top -= q / 2);
                I.left += ba[0];
                I.top += ba[1];
                a.support.offsetFractions || (I.left = l(I.left), I.top = l(I.top));
                f = {marginLeft: w, marginTop: J};
                a.each(["left", "top"], function(c, d) {
                    if (a.ui.position[y[c]])
                        a.ui.position[y[c]][d](I, {targetWidth: n, targetHeight: t, elemWidth: m,
                            elemHeight: q, collisionPosition: f, collisionWidth: Z, collisionHeight: z, offset: [e[0] + ba[0], e[1] + ba[1]], my: b.my, at: b.at, within: u, elem: k})
                });
                b.using && (h = function(a) {
                    var c = s.left - I.left, f = c + n - m, h = s.top - I.top, e = h + t - q, l = {target: {element: r, left: s.left, top: s.top, width: n, height: t}, element: {element: k, left: I.left, top: I.top, width: m, height: q}, horizontal: 0 > f ? "left" : 0 < c ? "right" : "center", vertical: 0 > e ? "top" : 0 < h ? "bottom" : "middle"};
                    n < m && g(c + f) < n && (l.horizontal = "center");
                    t < q && g(h + e) < t && (l.vertical = "middle");
                    l.important =
                            d(g(c), g(f)) > d(g(h), g(e)) ? "horizontal" : "vertical";
                    b.using.call(this, a, l)
                });
                k.offset(a.extend(I, {using: h}))
            })
        };
        a.ui.position = {fit: {left: function(a, b) {
                    var c = b.within, f = c.isWindow ? c.scrollLeft : c.offset.left, h = c.width, g = a.left - b.collisionPosition.marginLeft, c = f - g, e = g + b.collisionWidth - h - f;
                    ...
                    var c = b.within, f = c.isWindow ?
                            c.scrollTop : c.offset.top, h = b.within.height, g = a.top - b.collisionPosition.marginTop, c = f - g, e = g + b.collisionHeight - h - f;
                    ...
                    var c = b.within, f = c.offset.left + c.scrollLeft, d = c.width, h = c.isWindow ? c.scrollLeft : c.offset.left, e = a.left - b.collisionPosition.marginLeft, c = e - h, k = e + b.collisionWidth - d - h, e = "left" === b.my[0] ? -b.elemWidth :
                            "right" === b.my[0] ? b.elemWidth : 0, l = "left" === b.at[0] ? b.targetWidth : "right" === b.at[0] ? -b.targetWidth : 0, m = -2 * b.offset[0];
                    if (0 > c) {
                        if (f = a.left + e + l + m + b.collisionWidth - d - f, 0 > f || f < g(c))
                            a.left += e + l + m
                    } else if (0 < k && (f = a.left - b.collisionPosition.marginLeft + e + l + m - h, 0 < f || g(f) < k))
                        a.left += e + l + m
                }, top: function(a, b) {
                    var c = b.within, f = c.offset.top + c.scrollTop, d = c.height, h = c.isWindow ? c.scrollTop : c.offset.top, e = a.top - b.collisionPosition.marginTop, c = e - h, k = e + b.collisionHeight - d - h, e = "top" === b.my[1] ? -b.elemHeight : "bottom" ===
                            b.my[1] ? b.elemHeight : 0, l = "top" === b.at[1] ? b.targetHeight : "bottom" === b.at[1] ? -b.targetHeight : 0, m = -2 * b.offset[1];
                    if (0 > c) {
                        if (f = a.top + e + l + m + b.collisionHeight - d - f, a.top + e + l + m > c && (0 > f || f < g(c)))
                            a.top += e + l + m
                    } else if (0 < k && (f = a.top - b.collisionPosition.marginTop + e + l + m - h, a.top + e + l + m > k && (0 < f || g(f) < k)))
                        a.top += e + l + m
    ...
    (function(a) {
        a.widget("ui.draggable", a.ui.mouse, {version: "1.10.2", widgetEventPrefix: "drag", options: {addClasses: !0, appendTo: "parent", axis: !1, connectToSortable: !1, containment: !1, cursor: "auto", cursorAt: !1, grid: !1, handle: !1, helper: "original", iframeFix: !1, opacity: !1, refreshPositions: !1, revert: !1, revertDuration: 500, scope: "default", scroll: !0, scrollSensitivity: 20, scrollSpeed: 20, snap: !1, snapMode: "both", snapTolerance: 20, stack: !1, zIndex: !1, drag: null, start: null, stop: null}, _create: function() {
                ...
                var c = this.options;
                if (this.helper || c.disabled || 0 < a(e.target).closest(".ui-resizable-handle").length)
                    return!1;
                ...
                for (c = this.element[0]; c && (c = c.parentNode); )
                    c === document && (d = !0);
                if (!d && "original" === this.options.helper)
                    return!1;
            ...
            _mouseUp: function(e) {
                ...
                if ("relative" === this.cssPosition) {
                    ...
                    return{top: a.top - (parseInt(this.helper.css("top"), 10) || 0) + this.scrollParent.scrollTop(),
                ...
                if (!/^(document|window|parent)$/.test(e.containment) && e.containment.constructor !== Array) {
                    if (c = a(e.containment), b = c[0])
                        e = "hidden" !== a(b).css("overflow"), this.containment = [(parseInt(a(b).css("borderLeftWidth"), 10) || 0) + (parseInt(a(b).css("paddingLeft"), 10) || 0), (parseInt(a(b).css("borderTopWidth"), 10) || 0) + (parseInt(a(b).css("paddingTop"),
                ...
                c || (c = this.position);
                var b = "absolute" === e ? 1 : -1, d = "absolute" === this.cssPosition && !(this.scrollParent[0] !== document && a.contains(this.scrollParent[0], this.offsetParent[0])) ? this.offsetParent : this.scrollParent, g = /(html|body)/i.test(d[0].tagName);
                return{top: c.top + this.offset.relative.top * b + this.offset.parent.top * b - ("fixed" === this.cssPosition ? -this.scrollParent.scrollTop() : g ? 0 : d.scrollTop()) * b, left: c.left + this.offset.relative.left * b + this.offset.parent.left *
                            b - ("fixed" === this.cssPosition ? -this.scrollParent.scrollLeft() : g ? 0 : d.scrollLeft()) * b}
            }, _generatePosition: function(e) {
                var c, b, d, g = this.options, l = "absolute" === this.cssPosition && !(this.scrollParent[0] !== document && a.contains(this.scrollParent[0], this.offsetParent[0])) ? this.offsetParent : this.scrollParent, f = /(html|body)/i.test(l[0].tagName);
                d = e.pageX;
                b = e.pageY;
                ...
                return{top: b - this.offset.click.top - this.offset.relative.top - this.offset.parent.top + ("fixed" === this.cssPosition ? -this.scrollParent.scrollTop() : f ? 0 : l.scrollTop()), left: d - this.offset.click.left -
        ...
        a.ui.plugin.add("draggable", "connectToSortable", {start: function(e, c) {
                var b = a(this).data("ui-draggable"), d = b.options, g = a.extend({}, c, {item: b.element});
                b.sortables = [];
                a(d.connectToSortable).each(function() {
                    var c = a.data(this, "ui-sortable");
                    c && !c.options.disabled && (b.sortables.push({instance: c, shouldRevert: c.options.revert}), c.refreshPositions(), c._trigger("activate",
                            e, g))
                })
            }, stop: function(e, c) {
        ...
        a.ui.plugin.add("draggable", "scroll", {start: function() {
                ...
                if (c.scrollParent[0] !== document && "HTML" !== c.scrollParent[0].tagName) {
                    if (!b.axis || "x" !== b.axis)
                        c.overflowOffset.top + c.scrollParent[0].offsetHeight - e.pageY < b.scrollSensitivity ? c.scrollParent[0].scrollTop = d = c.scrollParent[0].scrollTop +
                    ...
                    if (!b.axis || "y" !== b.axis)
                        c.overflowOffset.left + c.scrollParent[0].offsetWidth - e.pageX < b.scrollSensitivity ? c.scrollParent[0].scrollLeft = d = c.scrollParent[0].scrollLeft + b.scrollSpeed : e.pageX - c.overflowOffset.left < b.scrollSensitivity && (c.scrollParent[0].scrollLeft = d = c.scrollParent[0].scrollLeft - b.scrollSpeed)
                } else {
                    if (!b.axis || "x" !== b.axis)
                        e.pageY - a(document).scrollTop() <
                    ...
                    if (!b.axis || "y" !== b.axis)
                        e.pageX - a(document).scrollLeft() < b.scrollSensitivity ? d = a(document).scrollLeft(a(document).scrollLeft() - b.scrollSpeed) : a(window).width() - (e.pageX - a(document).scrollLeft()) < b.scrollSensitivity && (d = a(document).scrollLeft(a(document).scrollLeft() + b.scrollSpeed))
                }
                !1 !==
        ...
        a.ui.plugin.add("draggable", "snap", {start: function() {
                ...
                var b, d, g, l, f, h, k, m, n, w, q = a(this).data("ui-draggable"),
                        r = q.options, v = r.snapTolerance, u = c.offset.left, y = u + q.helperProportions.width, x = c.offset.top, C = x + q.helperProportions.height;
                for (n = q.snapElements.length - 1; 0 <= n; n--)
                    f = q.snapElements[n].left, h = f + q.snapElements[n].width, k = q.snapElements[n].top, m = k + q.snapElements[n].height, f - v < u && u < h + v && k - v < x && x < m + v || f - v < u && u < h + v && k - v < C && C < m + v || f - v < y && y < h + v && k - v < x && x < m + v || f - v < y && y < h + v && k - v < C && C < m + v ? ("inner" !== r.snapMode && (b = Math.abs(k - C) <= v, d = Math.abs(m - x) <= v, g = Math.abs(f - y) <= v, l = Math.abs(h - u) <= v, b && (c.position.top = q._convertPositionTo("relative",
                            {top: k - q.helperProportions.height, left: 0}).top - q.margins.top), d && (c.position.top = q._convertPositionTo("relative", {top: m, left: 0}).top - q.margins.top), g && (c.position.left = q._convertPositionTo("relative", {top: 0, left: f - q.helperProportions.width}).left - q.margins.left), l && (c.position.left = q._convertPositionTo("relative", {top: 0, left: h}).left - q.margins.left)), w = b || d || g || l, "outer" !== r.snapMode && (b = Math.abs(k - x) <= v, d = Math.abs(m - C) <= v, g = Math.abs(f - u) <= v, l = Math.abs(h - y) <= v, b && (c.position.top = q._convertPositionTo("relative",
                            {top: k, left: 0}).top - q.margins.top), d && (c.position.top = q._convertPositionTo("relative", {top: m - q.helperProportions.height, left: 0}).top - q.margins.top), g && (c.position.left = q._convertPositionTo("relative", {top: 0, left: f}).left - q.margins.left), l && (c.position.left = q._convertPositionTo("relative", {top: 0, left: h - q.helperProportions.width}).left - q.margins.left)), !q.snapElements[n].snapping && (b || d || g || l || w) && q.options.snap.snap && q.options.snap.snap.call(q.element, e, a.extend(q._uiHash(), {snapItem: q.snapElements[n].item})),
                            q.snapElements[n].snapping = b || d || g || l || w) : (q.snapElements[n].snapping && q.options.snap.release && q.options.snap.release.call(q.element, e, a.extend(q._uiHash(), {snapItem: q.snapElements[n].item})), q.snapElements[n].snapping = !1)
            }});
    ...
    (function(a) {
        a.widget("ui.droppable", {version: "1.10.2", widgetEventPrefix: "drop", options: {accept: "*", activeClass: !1, addClasses: !0, greedy: !1, hoverClass: !1, scope: "default", tolerance: "intersect", activate: null, deactivate: null, drop: null, out: null, over: null}, _create: function() {
                ...
                for (var e = 0, c = a.ui.ddmanager.droppables[this.options.scope]; e < c.length; e++)
                    c[e] === this && c.splice(e, 1);
                ...
                if (c && (c.currentItem || c.element)[0] !== this.element[0])
                    if (this.accept.call(this.element[0], c.currentItem || c.element))
                        this.options.hoverClass && this.element.removeClass(this.options.hoverClass), this._trigger("out", e, this.ui(c))
            }, _drop: function(e, c) {
        ...
        a.ui.intersect = function(a, c, b) {
            if (!c.offset)
                return!1;
            var d = (a.positionAbs || a.position.absolute).left, g = d + a.helperProportions.width, l = (a.positionAbs || a.position.absolute).top, f = l + a.helperProportions.height, h = c.offset.left, k = h + c.proportions.width, m = c.offset.top, n = m + c.proportions.height;
            switch (b) {
                case "fit":
                    return h <= d && g <= k && m <= l && f <= n;
                case "intersect":
                    return h <
                            d + a.helperProportions.width / 2 && g - a.helperProportions.width / 2 < k && m < l + a.helperProportions.height / 2 && f - a.helperProportions.height / 2 < n;
                case "pointer":
                ...
                case "touch":
                    return(l >= m && l <= n || f >= m && f <= n || l < m && f > n) && (d >= h && d <= k || g >= h && g <= k || d < h && g > k);
                default:
                    return!1
                }
        };
        a.ui.ddmanager = {current: null,
            droppables: {"default": []}, prepareOffsets: function(e, c) {
                var b, d, g = a.ui.ddmanager.droppables[e.options.scope] || [], l = c ? c.type : null, f = (e.currentItem || e.element).find(":data(ui-droppable)").addBack();
                b = 0;
                a:for (; b < g.length; b++)
                ...
                a.each((a.ui.ddmanager.droppables[e.options.scope] || []).slice(), function() {
                    if (this.options && (!this.options.disabled && (this.visible && a.ui.intersect(e, this, this.options.tolerance)) && (b = this._drop.call(this, c) || b), !this.options.disabled && this.visible && this.accept.call(this.element[0], e.currentItem || e.element)))
    ...
    (function(a) {
        ...
        a.widget("ui.resizable", a.ui.mouse, {version: "1.10.2", widgetEventPrefix: "resize", options: {alsoResize: !1, animate: !1, animateDuration: "slow", animateEasing: "swing", aspectRatio: !1, autoHide: !1, containment: !1, ghost: !1, grid: !1, handles: "e,s,se", helper: !1, maxHeight: null, maxWidth: null, minHeight: 10, minWidth: 10, zIndex: 90, resize: null, start: null, stop: null}, _create: function() {
                ...
                a.extend(this, {_aspectRatio: !!k.aspectRatio, aspectRatio: k.aspectRatio, originalElement: this.element, _proportionallyResizeElements: [], _helper: k.helper || k.ghost || k.animate ? k.helper || "ui-resizable-helper" : null});
                this.element[0].nodeName.match(/canvas|textarea|input|select|button|img/i) && (this.element.wrap(a("<div class='ui-wrapper' style='overflow: hidden;'></div>").css({position: this.element.css("position"), width: this.element.outerWidth(), height: this.element.outerHeight(), top: this.element.css("top"),
                    left: this.element.css("left")})), this.element = this.element.parent().data("ui-resizable", this.element.data("ui-resizable")), this.elementIsWrapper = !0, this.element.css({marginLeft: this.originalElement.css("marginLeft"), marginTop: this.originalElement.css("marginTop"), marginRight: this.originalElement.css("marginRight"), marginBottom: this.originalElement.css("marginBottom")}), this.originalElement.css({marginLeft: 0, marginTop: 0, marginRight: 0, marginBottom: 0}), this.originalResizeStyle = this.originalElement.css("resize"),
                        this.originalElement.css("resize", "none"), this._proportionallyResizeElements.push(this.originalElement.css({position: "static", zoom: 1, display: "block"})), this.originalElement.css({margin: this.originalElement.css("margin")}), this._proportionallyResize());
                this.handles = k.handles || (!a(".ui-resizable-handle", this.element).length ? "e,s,se" : {n: ".ui-resizable-n", e: ".ui-resizable-e", s: ".ui-resizable-s", w: ".ui-resizable-w", se: ".ui-resizable-se", sw: ".ui-resizable-sw", ne: ".ui-resizable-ne", nw: ".ui-resizable-nw"});
                if (this.handles.constructor === String) {
                    "all" === this.handles && (this.handles = "n,e,s,w,se,sw,ne,nw");
                    b = this.handles.split(",");
                    this.handles = {};
                    for (c = 0; c < b.length; c++)
                        g = a.trim(b[c]), f = "ui-resizable-" + g, e = a("<div class='ui-resizable-handle " + f + "'></div>"), e.css({zIndex: k.zIndex}), "se" === g && e.addClass("ui-icon ui-icon-gripsmall-diagonal-se"), this.handles[g] = ".ui-resizable-" + g, this.element.append(e)
                }
                ...
                this.elementIsWrapper && (c(this.element), b = this.element, this.originalElement.css({position: b.css("position"), width: b.outerWidth(), height: b.outerHeight(), top: b.css("top"), left: b.css("left")}).insertAfter(b), b.remove());
                ...
                var c, g, e = !1;
                for (c in this.handles)
                    if (g = a(this.handles[c])[0], g === b.target || a.contains(g, b.target))
                        e = !0;
                ...
                this.sizeDiff = {width: f.outerWidth() - f.width(), height: f.outerHeight() -
                            f.height()};
                ...
                this._helper && (c = this._proportionallyResizeElements, c = (g = c.length && /textarea/i.test(c[0].nodeName)) && a.ui.hasScroll(c[0], "left") ? 0 : this.sizeDiff.height, g = g ? 0 : this.sizeDiff.width, g = {width: this.helper.width() - g, height: this.helper.height() - c}, c = parseInt(this.element.css("left"), 10) + (this.position.left -
                        this.originalPosition.left) || null, e = parseInt(this.element.css("top"), 10) + (this.position.top - this.originalPosition.top) || null, f.animate || this.element.css(a.extend(g, {top: e, left: c})), this.helper.height(this.size.height), this.helper.width(this.size.width), this._helper && !f.animate && this._proportionallyResize());
                ...
                if (this._aspectRatio || a)
                    a = f.minHeight * this.aspectRatio, g = f.minWidth / this.aspectRatio, d = f.maxHeight * this.aspectRatio, e = f.maxWidth / this.aspectRatio, a > f.minWidth && (f.minWidth = a), g > f.minHeight && (f.minHeight = g), d < f.maxWidth && (f.maxWidth = d), e < f.maxHeight && (f.maxHeight = e);
                this._vBoundaries = f
                ...
                var d =
                        this._vBoundaries, g = this.axis, e = c(a.width) && d.maxWidth && d.maxWidth < a.width, f = c(a.height) && d.maxHeight && d.maxHeight < a.height, h = c(a.width) && d.minWidth && d.minWidth > a.width, k = c(a.height) && d.minHeight && d.minHeight > a.height, m = this.originalPosition.left + this.originalSize.width, n = this.position.top + this.size.height, w = /sw|nw|w/.test(g), g = /nw|ne|n/.test(g);
                h && (a.width = d.minWidth);
                k && (a.height = d.minHeight);
                e && (a.width = d.maxWidth);
                f && (a.height = d.maxHeight);
                h && w && (a.left = m - d.minWidth);
                e && w && (a.left = m - d.maxWidth);
                k && g && (a.top = n - d.minHeight);
                f && g && (a.top = n - d.maxHeight);
                    ...
                    for (a = 0; a < this._proportionallyResizeElements.length; a++) {
                        ...
                        if (!this.borderDif) {
                            ...
                            for (c = 0; c < g.length; c++)
                                this.borderDif[c] = (parseInt(g[c], 10) || 0) + (parseInt(e[c], 10) || 0)
                        }
                ...
                this._helper ? (this.helper = this.helper || a("<div style='overflow:hidden;'></div>"), this.helper.addClass(this._helper).css({width: this.element.outerWidth() -
                    1, height: this.element.outerHeight() - 1, position: "absolute", left: this.elementOffset.left + "px", top: this.elementOffset.top + "px", zIndex: ++b.zIndex}), this.helper.appendTo("body").disableSelection()) : this.helper = this.element
            }, _change: {e: function(a, c) {
        ...
        a.ui.plugin.add("resizable", "animate", {stop: function(b) {
                var c = a(this).data("ui-resizable"), g = c.options, e = c._proportionallyResizeElements, f = e.length && /textarea/i.test(e[0].nodeName), h = f && a.ui.hasScroll(e[0], "left") ? 0 : c.sizeDiff.height, f =
                        {width: c.size.width - (f ? 0 : c.sizeDiff.width), height: c.size.height - h}, h = parseInt(c.element.css("left"), 10) + (c.position.left - c.originalPosition.left) || null, k = parseInt(c.element.css("top"), 10) + (c.position.top - c.originalPosition.top) || null;
                c.element.animate(a.extend(f, k && h ? {top: k, left: h} : {}), {duration: g.animateDuration, easing: g.animateEasing, step: function() {
                        var f = {width: parseInt(c.element.css("width"), 10), height: parseInt(c.element.css("height"), 10), top: parseInt(c.element.css("top"), 10), left: parseInt(c.element.css("left"),
                                    10)};
        ...
        a.ui.plugin.add("resizable", "containment", {start: function() {
                ...
                if (k = g instanceof a ? g.get(0) : /parent/.test(g) ? k.parent().get(0) : g)
                    h.containerElement = a(k), /document/.test(g) || g === document ? (h.containerOffset = {left: 0, top: 0}, h.containerPosition = {left: 0, top: 0}, h.parentData = {element: a(document), left: 0, top: 0, width: a(document).width(),
                        height: a(document).height() || document.body.parentNode.scrollHeight}) : (b = a(k), c = [], a(["Top", "Right", "Left", "Bottom"]).each(function(a, f) {
                        c[a] = e(b.css("padding" + f))
                    }), h.containerOffset = b.offset(), h.containerPosition = b.position(), h.containerSize = {height: b.innerHeight() - c[3], width: b.innerWidth() - c[1]}, g = h.containerOffset, l = h.containerSize.height, f = h.containerSize.width, f = a.ui.hasScroll(k, "left") ? k.scrollWidth : f, l = a.ui.hasScroll(k) ? k.scrollHeight : l, h.parentData = {element: k, left: g.left, top: g.top, width: f,
                        height: l})
            }, resize: function(b) {
                ...
                if (e.left < (h._helper ? g.left : 0))
                    h.size.width += h._helper ? h.position.left - g.left : h.position.left - f.left, b && (h.size.height = h.size.width / h.aspectRatio), h.position.left = c.helper ? g.left : 0;
                if (e.top < (h._helper ? g.top : 0))
                    h.size.height += h._helper ? h.position.top - g.top :
                ...
                var b = a(this).data("ui-resizable"), c = b.options, g = b.containerOffset, e = b.containerPosition, f = b.containerElement, h = a(b.helper), k = h.offset(), m = h.outerWidth() - b.sizeDiff.width, h = h.outerHeight() - b.sizeDiff.height;
                b._helper && (!c.animate && /relative/.test(f.css("position"))) && a(this).css({left: k.left -
        ...
        a.ui.plugin.add("resizable", "alsoResize", {start: function() {
                ...
                var g = a(this).data("ui-resizable"), e = g.options, f = g.originalSize, h = g.originalPosition, k = {height: g.size.height - f.height || 0, width: g.size.width - f.width || 0, top: g.position.top - h.top || 0, left: g.position.left - h.left || 0}, m = function(b, f) {
                    a(b).each(function() {
                        var b = a(this), h = a(this).data("ui-resizable-alsoresize"), g = {}, e = f && f.length ? f : b.parents(c.originalElement[0]).length ?
        ...
        a.ui.plugin.add("resizable", "ghost", {start: function() {
                ...
                b.ghost.css({opacity: 0.25, display: "block",
                    position: "relative", height: g.height, width: g.width, margin: 0, left: 0, top: 0}).addClass("ui-resizable-ghost").addClass("string" === typeof c.ghost ? c.ghost : "");
        ...
        a.ui.plugin.add("resizable", "grid", {resize: function() {
                var b = a(this).data("ui-resizable"),
                        c = b.options, g = b.size, e = b.originalSize, f = b.originalPosition, h = b.axis, k = "number" === typeof c.grid ? [c.grid, c.grid] : c.grid, m = k[0] || 1, n = k[1] || 1, w = Math.round((g.width - e.width) / m) * m, g = Math.round((g.height - e.height) / n) * n, q = e.width + w, e = e.height + g, r = c.maxWidth && c.maxWidth < q, v = c.maxHeight && c.maxHeight < e, u = c.minWidth && c.minWidth > q, y = c.minHeight && c.minHeight > e;
                c.grid = k;
                u && (q += m);
                y && (e += n);
                r && (q -= m);
                ...
                /^(se|s|e)$/.test(h) ? (b.size.width = q, b.size.height = e) : /^(ne)$/.test(h) ? (b.size.width = q, b.size.height = e,
                        b.position.top = f.top - g) : (/^(sw)$/.test(h) ? (b.size.width = q, b.size.height = e) : (b.size.width = q, b.size.height = e, b.position.top = f.top - g), b.position.left = f.left - w)
            }})
    })(jQuery);
    (function(a) {
        a.widget("ui.selectable", a.ui.mouse, {version: "1.10.2", options: {appendTo: "body", autoRefresh: !0, distance: 0, filter: "*", tolerance: "touch", selected: null, selecting: null, start: null, stop: null, unselected: null, unselecting: null}, _create: function() {
                var e, c = this;
                ...
                this.refresh = function() {
                    ...
                    e.each(function() {
                        var b = a(this), c = b.offset();
                        a.data(this, "selectable-item", {element: this, $element: b,
                            left: c.left, top: c.top, right: c.left + b.outerWidth(), bottom: c.top + b.outerHeight(), startselected: !1, selected: b.hasClass("ui-selected"), selecting: b.hasClass("ui-selecting"), unselecting: b.hasClass("ui-unselecting")})
                    })
                };
                this.refresh();
                ...
                this.options.disabled || (this.selectees = a(b.filter, this.element[0]), this._trigger("start", e), a(b.appendTo).append(this.helper), this.helper.css({left: e.pageX, top: e.pageY, width: 0, height: 0}), b.autoRefresh && this.refresh(), this.selectees.filter(".ui-selected").each(function() {
                    ...
                    if (g)
                        return b = !e.metaKey && !e.ctrlKey || !g.$element.hasClass("ui-selected"), g.$element.removeClass(b ? "ui-unselecting" : "ui-selected").addClass(b ? "ui-selecting" : "ui-unselecting"), g.unselecting = !b, g.selecting = b, (g.selected = b) ? c._trigger("selecting", e, {selecting: g.element}) : c._trigger("unselecting", e, {unselecting: g.element}),
                        !1
                }))
        ...
        a.widget("ui.sortable", a.ui.mouse, {version: "1.10.2", widgetEventPrefix: "sort", ready: !1, options: {appendTo: "parent", axis: !1, connectWith: !1, containment: !1, cursor: "auto", cursorAt: !1, dropOnEmpty: !0, forcePlaceholderSize: !1, forceHelperSize: !1, grid: !1, handle: !1, helper: "original", items: "> *", opacity: !1, placeholder: !1, revert: !1, scroll: !0, scrollSensitivity: 20, scrollSpeed: 20, scope: "default", tolerance: "intersect",
                ...
                if (!d)
                    for (d = this.containers.length - 1; 0 <= d; d--)
                        this.containers[d]._trigger("activate", c, this._uiHash(this));
                a.ui.ddmanager &&
                ...
                if (c) {
                    ...
                    if (this.options.revert) {
                        ...
                        if (!e || "x" === e)
                            f.left = g.left - this.offset.parent.left - this.margins.left + (this.offsetParent[0] === document.body ? 0 : this.offsetParent[0].scrollLeft);
                        if (!e || "y" === e)
                            f.top = g.top - this.offset.parent.top - this.margins.top + (this.offsetParent[0] === document.body ? 0 : this.offsetParent[0].scrollTop);
                        this.reverting = !0;
                ...
                if (this.dragging) {
                    ...
                    for (var c = this.containers.length - 1; 0 <= c; c--)
                        this.containers[c]._trigger("deactivate", null, this._uiHash(this)), this.containers[c].containerCache.over && (this.containers[c]._trigger("out", null, this._uiHash(this)), this.containers[c].containerCache.over =
                                0)
                }
                ...
                var b = this.positionAbs.left, d = b + this.helperProportions.width, g = this.positionAbs.top,
                        e = g + this.helperProportions.height, f = a.left, h = f + a.width, k = a.top, m = k + a.height, n = this.offset.click.top, w = this.offset.click.left;
                return"pointer" === this.options.tolerance || this.options.forcePointerForContainers || "pointer" !== this.options.tolerance && this.helperProportions[this.floating ? "width" : "height"] > a[this.floating ? "width" : "height"] ? g + n > k && g + n < m && b + w > f && b + w < h : f < b + this.helperProportions.width / 2 && d - this.helperProportions.width / 2 < h && k < g + this.helperProportions.height / 2 && e - this.helperProportions.height / 2 <
                m
            }, _intersectsWithPointer: function(a) {
                var b = "y" === this.options.axis || this.positionAbs.left + this.offset.click.left > a.left && this.positionAbs.left + this.offset.click.left < a.left + a.width, a = ("x" === this.options.axis || this.positionAbs.top + this.offset.click.top > a.top && this.positionAbs.top + this.offset.click.top < a.top + a.height) && b, b = this._getDragVerticalDirection(), d = this._getDragHorizontalDirection();
                ...
                var b, d, g, e, f, h = this.items, k = [[a.isFunction(this.options.items) ? this.options.items.call(this.element[0], c, {item: this.currentItem}) : a(this.options.items, this.element), this]];
                ...
                for (b = k.length - 1; 0 <= b; b--) {
                    ...
                    for (f = g.length; d < f; d++)
                        e = a(g[d]), e.data(this.widgetName + "-item", c), h.push({item: e, instance: c, width: 0, height: 0, left: 0, top: 0})
                }
                ...
                var b, d, e;
                for (b = this.items.length - 1; 0 <= b; b--)
                    d = this.items[b], d.instance !== this.currentContainer && this.currentContainer && d.item[0] !== this.currentItem[0] || (e = this.options.toleranceElement ? a(this.options.toleranceElement, d.item) : d.item, c || (d.width = e.outerWidth(), d.height = e.outerHeight()), e = e.offset(), d.left = e.left, d.top = e.top);
                if (this.options.custom && this.options.custom.refreshContainers)
                    this.options.custom.refreshContainers.call(this);
                else
                    for (b =
                            this.containers.length - 1; 0 <= b; b--)
                ...
                if (!d.placeholder || d.placeholder.constructor === String)
                    b = d.placeholder, d.placeholder = {element: function() {
                            var d =
                                    c.currentItem[0].nodeName.toLowerCase(), e = a(c.document[0].createElement(d)).addClass(b || c.currentItem[0].className + " ui-sortable-placeholder").removeClass("ui-sortable-helper");
                ...
                var b, d, g, l, f, h, k, m, n, w = d = null;
                for (b = this.containers.length - 1; 0 <= b; b--)
                    if (!a.contains(this.currentItem[0], this.containers[b].element[0]))
                        if (this._intersectsWith(this.containers[b].containerCache)) {
                            if (!d ||
                                    !a.contains(this.containers[b].element[0], d.element[0]))
                                d = this.containers[b], w = b
                        } else
                            this.containers[b].containerCache.over && (this.containers[b]._trigger("out", c, this._uiHash(this)), this.containers[b].containerCache.over = 0);
                if (d)
                    if (1 === this.containers.length)
                        this.containers[w].containerCache.over || (this.containers[w]._trigger("over", c, this._uiHash(this)), this.containers[w].containerCache.over = 1);
                    else {
                        b = 1E4;
                        g = null;
                        l = (n = d.floating || e(this.currentItem)) ? "left" : "top";
                        f = n ? "width" : "height";
                        h = this.positionAbs[l] +
                                this.offset.click[l];
                        for (d = this.items.length - 1; 0 <= d; d--)
                            if (a.contains(this.containers[w].element[0], this.items[d].item[0]) && this.items[d].item[0] !== this.currentItem[0] && (!n || this.positionAbs.top + this.offset.click.top > this.items[d].top && this.positionAbs.top + this.offset.click.top < this.items[d].top + this.items[d].height))
                                k = this.items[d].item.offset()[l], m = !1, Math.abs(k - h) > Math.abs(k + this.items[d][f] - h) && (m = !0, k += this.items[d][f]), Math.abs(k - h) < b && (b = Math.abs(k - h), g = this.items[d], this.direction = m ? "up" :
                                        "down");
                        if ((g || this.options.dropOnEmpty) && this.currentContainer !== this.containers[w])
                            g ? this._rearrange(c, g, null, !0) : this._rearrange(c, null, this.containers[w].element, !0), this._trigger("change", c, this._uiHash()), this.containers[w]._trigger("change", c, this._uiHash(this)), this.currentContainer = this.containers[w], this.options.placeholder.update(this.currentContainer, this.placeholder), this.containers[w]._trigger("over", c, this._uiHash(this)), this.containers[w].containerCache.over = 1
                    }
            }, _createHelper: function(c) {
                var b =
                        this.options, c = a.isFunction(b.helper) ? a(b.helper.apply(this.element[0], [c, this.currentItem])) : "clone" === b.helper ? this.currentItem.clone() : this.currentItem;
                c.parents("body").length || a("parent" !== b.appendTo ? b.appendTo : this.currentItem[0].parentNode)[0].appendChild(c[0]);
                c[0] === this.currentItem[0] && (this._storedCSS = {width: this.currentItem[0].style.width, height: this.currentItem[0].style.height, position: this.currentItem.css("position"), top: this.currentItem.css("top"), left: this.currentItem.css("left")});
                ...
                b || (b = this.position);
                var d = "absolute" === c ? 1 : -1, e = "absolute" === this.cssPosition && !(this.scrollParent[0] !== document && a.contains(this.scrollParent[0], this.offsetParent[0])) ? this.offsetParent : this.scrollParent, l = /(html|body)/i.test(e[0].tagName);
                return{top: b.top + this.offset.relative.top * d + this.offset.parent.top * d - ("fixed" === this.cssPosition ? -this.scrollParent.scrollTop() : l ? 0 : e.scrollTop()) * d, left: b.left + this.offset.relative.left * d + this.offset.parent.left *
                            d - ("fixed" === this.cssPosition ? -this.scrollParent.scrollLeft() : l ? 0 : e.scrollLeft()) * d}
            }, _generatePosition: function(c) {
                var b, d, e = this.options;
                d = c.pageX;
                b = c.pageY;
                var l = "absolute" === this.cssPosition && !(this.scrollParent[0] !== document && a.contains(this.scrollParent[0], this.offsetParent[0])) ? this.offsetParent : this.scrollParent, f = /(html|body)/i.test(l[0].tagName);
                ...
                return{top: b - this.offset.click.top - this.offset.relative.top -
                            this.offset.parent.top + ("fixed" === this.cssPosition ? -this.scrollParent.scrollTop() : f ? 0 : l.scrollTop()), left: d - this.offset.click.left - this.offset.relative.left - this.offset.parent.left + ("fixed" === this.cssPosition ? -this.scrollParent.scrollLeft() : f ? 0 : l.scrollLeft())}
    ...
    (function(a) {
        ...
        a.widget("ui.accordion", {version: "1.10.2", options: {active: 0, animate: {}, collapsible: !1, event: "click", header: "> li > :first-child,> :not(li):even", heightStyle: "auto", icons: {activeHeader: "ui-icon-triangle-1-s", header: "ui-icon-triangle-1-e"}, activate: null, beforeActivate: null}, _create: function() {
                var b = this.options;
                this.prevShow = this.prevHide = a();
                this.element.addClass("ui-accordion ui-widget ui-helper-reset").attr("role", "tablist");
                if (!b.collapsible && (!1 === b.active || null == b.active))
                    b.active = 0;
                this._processPanels();
                ...
                var b = this.options;
                this._processPanels();
                if (!1 === b.active && !0 === b.collapsible || !this.headers.length)
                    b.active =
                            !1, this.active = a();
            ...
            _refresh: function() {
                var b, c = this.options, l = c.heightStyle, f = this.element.parent(), h = this.accordionId = "ui-accordion-" + (this.element.attr("id") || ++e);
                ...
                b !== this.active[0] && (b = b || this.active[0], this._eventHandler({target: b,
                ...
                var c = this.options, e = this.active, f = a(b.currentTarget), h =
                        f[0] === e[0], k = h && c.collapsible, m = k ? a() : f.next(), n = e.next(), m = {oldHeader: e, oldPanel: n, newHeader: k ? a() : f, newPanel: m};
                b.preventDefault();
                ...
                var f, h, k, m = this, n = 0, w = a.length && (!e.length || a.index() < e.index()), q = this.options.animate || {}, w = w && q.down || q, r = function() {
                    m._toggleComplete(l)
                };
                "number" === typeof w && (k = w);
                "string" === typeof w && (h = w);
                h = h || w.easing || q.easing;
                k = k ||
                        w.duration || q.duration;
                if (!e.length)
                    return a.animate(b, k, h, r);
                if (!a.length)
                    return e.animate(c, k, h, r);
                f = a.show().outerHeight();
                e.animate(c, {duration: k, easing: h, step: function(a, b) {
                        b.now = Math.round(a)
                    }});
                a.hide().animate(b, {duration: k, easing: h, complete: r, step: function(a, b) {
                        b.now = Math.round(a);
                        "height" !== b.prop ? n += b.now : "content" !== m.options.heightStyle && (b.now = Math.round(f - e.outerHeight() - n), n = 0)
                    }})
    ...
    (function(a) {
        var e = 0;
        a.widget("ui.autocomplete", {version: "1.10.2", defaultElement: "<input>", options: {appendTo: null, autoFocus: !1, delay: 300, minLength: 1, position: {my: "left top", at: "left bottom", collision: "none"}, source: null, change: null, close: null, focus: null, open: null, response: null, search: null, select: null}, pending: 0, _create: function() {
                ...
                this._on(this.element, {keydown: function(f) {
                ...
                a.isArray(this.options.source) ? (c = this.options.source, this.source = function(b, d) {
                    d(a.ui.autocomplete.filter(c, b.term))
                        ...
                        this.source = function(c, e) {
                            d.xhr && d.xhr.abort();
                            d.xhr = a.ajax({url: b, data: c, dataType: "json", success: function(a) {
                                    e(a)
                                }, error: function() {
                                    e([])
                                }})
    ...
    (function(a) {
        ...
        a.widget("ui.button", {version: "1.10.2", defaultElement: "<button>", options: {disabled: null, text: !0, label: null, icons: {primary: null, secondary: null}}, _create: function() {
                ...
                var f = this, h = this.options, k = "checkbox" === this.type || "radio" === this.type, m = !k ? "ui-state-active" : "";
                ...
                k && (this.element.bind("change" + this.eventNamespace, function() {
                    ...
                    if (!h.disabled && (c !== a.pageX || b !== a.pageY))
                        d = !0
                }));
            ...
            _determineButtonType: function() {
                ...
                if ("input" === this.type)
                    ...
                    var b = this.buttonElement.removeClass("ui-button-icons-only ui-button-icon-only ui-button-text-icons ui-button-text-icon-primary ui-button-text-icon-secondary ui-button-text-only"),
                            c = a("<span></span>", this.document[0]).addClass("ui-button-text").html(this.options.label).appendTo(b.empty()).text(), d = this.options.icons, e = d.primary && d.secondary, g = [];
        ...
        a.widget("ui.buttonset", {version: "1.10.2", options: {items: "button, input[type=button], input[type=submit], input[type=reset], input[type=checkbox], input[type=radio], a, :data(ui-button)"}, _create: function() {
    ...
    (function(a, e) {
        ...
        a.extend(c.prototype, {markerClassName: "hasDatepicker", maxRows: 4, _widgetDatepicker: function() {
                ...
                return{id: c[0].id.replace(/([^A-Za-z0-9_\-])/g, "\\\\$1"), input: c, selectedDay: 0, selectedMonth: 0, selectedYear: 0, drawMonth: 0, drawYear: 0, inline: d, dpDiv: !d ? this.dpDiv : b(a("<div class='" + this._inlineClass +
                ...
                if ("button" === d || "both" === d)
                    d = this._get(c, "buttonText"), e = this._get(c, "buttonImage"), c.trigger = a(this._get(c, "buttonImageOnly") ? a("<img/>").addClass(this._triggerClass).attr({src: e, alt: d, title: d}) : a("<button type='button'></button>").addClass(this._triggerClass).html(!e ?
                            d : a("<img/>").attr({src: e, alt: d, title: d}))), b[g ? "before" : "after"](c.trigger), c.trigger.click(function() {
                ...
                this._pos || (c = document.documentElement.clientWidth, g = document.documentElement.clientHeight, l = document.documentElement.scrollLeft || document.body.scrollLeft, w = document.documentElement.scrollTop || document.body.scrollTop, this._pos = [c / 2 - 100 + l, g / 2 - 150 + w]);
                ...
                if (d.hasClass(this.markerClassName)) {
                    ...
                    if ("input" === c)
                        b.disabled = !1, e.trigger.filter("button").each(function() {
                            this.disabled = !1
                        }).end().filter("img").css({opacity: "1.0", cursor: ""});
                    else if ("div" === c || "span" === c)
                        c = d.children("." + this._inlineClass), c.children().removeClass("ui-state-disabled"), c.find("select.ui-datepicker-month, select.ui-datepicker-year").prop("disabled",
                                !1);
                ...
                if (d.hasClass(this.markerClassName)) {
                    c = b.nodeName.toLowerCase();
                    if ("input" === c)
                        b.disabled = !0, e.trigger.filter("button").each(function() {
                            this.disabled = !0
                        }).end().filter("img").css({opacity: "0.5", cursor: "default"});
                    else if ("div" === c || "span" === c)
                        c = d.children("." + this._inlineClass), c.children().addClass("ui-state-disabled"), c.find("select.ui-datepicker-month, select.ui-datepicker-year").prop("disabled",
                                !0);
                    this._disabledInputs = a.map(this._disabledInputs, function(a) {
                        return a === b ? null : a
                    });
                ...
                var m, l, w, q, r = this._getInst(b);
                if (2 === arguments.length && "string" ===
                        typeof c)
                    return"defaults" === c ? a.extend({}, a.datepicker._defaults) : r ? "all" === c ? a.extend({}, r.settings) : this._get(r, c) : null;
                m = c || {};
                "string" === typeof c && (m = {}, m[c] = g);
                r && (this._curInst === r && this._hideDatepicker(), l = this._getDateDatepicker(b, !0), w = this._getMinMaxDate(r, "min"), q = this._getMinMaxDate(r, "max"), d(r.settings, m), null !== w && (m.dateFormat !== e && m.minDate === e) && (r.settings.minDate = this._formatDate(r, w)), null !== q && (m.dateFormat !== e && m.maxDate === e) && (r.settings.maxDate = this._formatDate(r, q)), "disabled"in
                        m && (m.disabled ? this._disableDatepicker(b) : this._enableDatepicker(b)), this._attachments(a(b), r), this._autoSize(r), this._setDate(r, l), this._updateAlternate(r), this._updateDatepicker(r))
                    ...
                    switch (b.keyCode) {
                        ...
                        case 37:
                            if (b.ctrlKey || b.metaKey)
                                a.datepicker._adjustDate(b.target, e ? 1 : -1, "D");
                            c = b.ctrlKey || b.metaKey;
                ...
                if (b.input.val() !== b.lastVal)
                    try {
                        if (c = a.datepicker.parseDate(a.datepicker._get(b, "dateFormat"), b.input ? b.input.val() : null, a.datepicker._getFormatConfig(b)))
                            a.datepicker._setDateFromField(b), a.datepicker._updateAlternate(b),
                ...
                if (!(a.datepicker._isDisabledDatepicker(b) || a.datepicker._lastInput === b)) {
                    ...
                    if (!1 !== e && (d(c.settings, e), c.lastVal = null, a.datepicker._lastInput = b, a.datepicker._setDateFromField(c), a.datepicker._inDialog && (b.value = ""), a.datepicker._pos || (a.datepicker._pos = a.datepicker._findPos(b), a.datepicker._pos[1] += b.offsetHeight), g = !1, a(b).parents().each(function() {
                        ...
                        return!g
                    }), e = {left: a.datepicker._pos[0], top: a.datepicker._pos[1]}, a.datepicker._pos = null, c.dpDiv.empty(), c.dpDiv.css({position: "absolute", display: "block", top: "-1000px"}),
                    a.datepicker._updateDatepicker(c), e = a.datepicker._checkOffset(c, e, g), c.dpDiv.css({position: a.datepicker._inDialog && a.blockUI ? "static" : g ? "fixed" : "absolute", display: "none", left: e.left + "px", top: e.top + "px"}), !c.inline)) {
                        e = a.datepicker._get(c, "showAnim");
                        l = a.datepicker._get(c, "duration");
                        c.dpDiv.zIndex(a(b).zIndex() + 1);
                        a.datepicker._datepickerShowing = !0;
                        if (a.effects && a.effects.effect[e])
                            c.dpDiv.show(e, a.datepicker._get(c, "showOptions"), l);
                        else
                            c.dpDiv[e || "show"](e ? l : null);
                ...
                var e = b.dpDiv.outerWidth(), g = b.dpDiv.outerHeight(), l = b.input ? b.input.outerWidth() : 0, q = b.input ? b.input.outerHeight() : 0, r = document.documentElement.clientWidth + (d ? 0 : a(document).scrollLeft()), v = document.documentElement.clientHeight + (d ? 0 : a(document).scrollTop());
                ...
                for (var c = this._getInst(b), c = this._get(c, "isRTL"); b && ("hidden" === b.type || 1 !== b.nodeType || a.expr.filters.hidden(b)); )
                ...
                if (e && !(b && e !== a.data(b, "datepicker")) && this._datepickerShowing) {
                    ...
                    if (a.effects && (a.effects.effect[b] || a.effects[b]))
                        e.dpDiv.hide(b, a.datepicker._get(e, "showOptions"), c, d);
                    else
                        e.dpDiv["slideDown" === b ? "slideUp" : "fadeIn" === b ? "fadeOut" : "hide"](b ? c : null, d);
                    b || d();
                ...
                var r = (d ? d.dayNames : null) || this._defaults.dayNames, v = (d ? d.monthNamesShort :
                        null) || this._defaults.monthNamesShort, u = (d ? d.monthNames : null) || this._defaults.monthNames, y = d = -1, x = -1, C = -1, G = !1, t, s = function(a) {
                    (a = e + 1 < b.length && b.charAt(e + 1) === a) && e++;
                    return a
                }, A = function(a) {
                    var b = s(a), a = RegExp("^\\d{1," + ("@" === a ? 14 : "!" === a ? 20 : "y" === a && b ? 4 : "o" === a ? 3 : 2) + "}"), a = c.substring(q).match(a);
                    if (!a)
                        throw"Missing number at position " + q;
                    q += a[0].length;
                    return parseInt(a[0], 10)
                }, J = function(b, d, f) {
                    var e = -1, b = a.map(s(b) ? f : d, function(a, b) {
                        return[[b, a]]
                    }).sort(function(a, b) {
                    ...
                    a.each(b, function(a, b) {
                        var d = b[1];
                        if (c.substr(q, d.length).toLowerCase() === d.toLowerCase())
                            return e = b[0], q += d.length, !1
                    });
                    if (-1 !== e)
                        return e + 1;
                    throw"Unknown name at position " + q;
                }, U = function() {
                    if (c.charAt(q) !== b.charAt(e))
                    ...
                    if (G)
                        ...
                        switch (b.charAt(e)) {
                            ...
                            case "@":
                                ...
                                break;
                            case "!":
                                t = new Date((A("!") - this._ticksTo1970) / 1E4);
                                d = t.getFullYear();
                                y = t.getMonth() + 1;
                                x = t.getDate();
                                break;
                ...
                if (q < c.length && (l = c.substr(q), !/^\s+/.test(l)))
                ...
                t = this._daylightSavingAdjust(new Date(d, y - 1, x));
                if (t.getFullYear() !== d || t.getMonth() + 1 !== y || t.getDate() !== x)
                    throw"Invalid date";
                return t
                ...
                if (!b)
                    return"";
                var d,
                        e = (c ? c.dayNamesShort : null) || this._defaults.dayNamesShort, g = (c ? c.dayNames : null) || this._defaults.dayNames, l = (c ? c.monthNamesShort : null) || this._defaults.monthNamesShort, c = (c ? c.monthNames : null) || this._defaults.monthNames, r = function(b) {
                ...
                if (a.input.val() !== a.lastVal) {
                    var c = this._get(a, "dateFormat"), d = a.lastVal = a.input ? a.input.val() : null, e = this._getDefaultDate(a), g = e, l = this._getFormatConfig(a);
                    try {
                ...
                if (null == c || "" === c)
                    ...
                    if ("string" === typeof c)
                        a:{
                            ...
                            var l = (c.toLowerCase().match(/^c/) ? a.datepicker._getDate(b) : null) || new Date, b = l.getFullYear();
                            e = l.getMonth();
                        ...
                        "number" === typeof c ? isNaN(c) ? c = d : (b = new Date, b.setDate(b.getDate() + c), c = b) : c = new Date(c.getTime()), e = c;
                    c = e
                }
                if (c = c && "Invalid Date" === c.toString() ? d : c)
                ...
                var b, c, d, e, g, l, r, v, u, y, x, C, G,
                        t, s, A, J, U, R, K, V, F, Z, ta, na, M, ka, ha = new Date, ha = this._daylightSavingAdjust(new Date(ha.getFullYear(), ha.getMonth(), ha.getDate())), W = this._get(a, "isRTL");
                ...
                var z = 1 !== aa[0] || 1 !== aa[1], I = this._daylightSavingAdjust(!a.currentDay ? new Date(9999, 9, 9) : new Date(a.currentYear, a.currentMonth, a.currentDay)), ba = this._getMinMaxDate(a,
                        "min"), la = this._getMinMaxDate(a, "max"), E = a.drawMonth - E, O = a.drawYear;
                0 > E && (E += 12, O--);
                if (la) {
                    b = this._daylightSavingAdjust(new Date(la.getFullYear(), la.getMonth() - aa[0] * aa[1] + 1, la.getDate()));
                    for (b = ba && b < ba?ba:b; this._daylightSavingAdjust(new Date(O, E, 1)) > b; )
                        E--, 0 > E && (E = 11, O--)
                }
                a.drawMonth = E;
                a.drawYear = O;
                b = this._get(a, "prevText");
                b = !g ? b : this.formatDate(b, this._daylightSavingAdjust(new Date(O, E - e, 1)), this._getFormatConfig(a));
                b = this._canAdjustMonth(a, -1, O, E) ? "<a class='ui-datepicker-prev ui-corner-all' data-handler='prev' data-event='click' title='" +
                ...
                c = !g ? c : this.formatDate(c, this._daylightSavingAdjust(new Date(O, E + e, 1)), this._getFormatConfig(a));
                d = this._canAdjustMonth(a, 1, O, E) ? "<a class='ui-datepicker-next ui-corner-all' data-handler='next' data-event='click' title='" + c + "'><span class='ui-icon ui-icon-circle-triangle-" +
                ...
                c = this._get(a, "gotoCurrent") && a.currentDay ? I : ha;
                ...
                C = this._get(a, "selectOtherMonths");
                ...
                for (A = 0; A < aa[0]; A++) {
                    ...
                    this.maxRows = 4;
                    for (U = 0; U < aa[1]; U++) {
                        R = this._daylightSavingAdjust(new Date(O, E, a.selectedDay));
                        s = " ui-corner-all";
                        K = "";
                        if (z) {
                        ...
                        K += "<div class='ui-datepicker-header ui-widget-header ui-helper-clearfix" + s + "'>" + (/all|left/.test(s) && 0 === A ? W ? d : b : "") + (/all|right/.test(s) && 0 === A ? W ? b : d : "") + this._generateMonthYearHeader(a, E, O, ba, la, 0 < A || 0 < U, v, u) + "</div><table class='ui-datepicker-calendar'><thead><tr>";
                        V = e ? "<th class='ui-datepicker-week-col'>" + this._get(a, "weekHeader") + "</th>" : "";
                        for (s = 0; 7 > s; s++)
                            F = (s + g) % 7, V += "<th" + (5 <= (s + g + 6) % 7 ? " class='ui-datepicker-week-end'" : "") + "><span title='" + c[F] +
                                    "'>" + r[F] + "</span></th>";
                        K += V + "</tr></thead><tbody>";
                        V = this._getDaysInMonth(O, E);
                        O === a.selectedYear && E === a.selectedMonth && (a.selectedDay = Math.min(a.selectedDay, V));
                        s = (this._getFirstDayOfMonth(O, E) - g + 7) % 7;
                        V = Math.ceil((s + V) / 7);
                        this.maxRows = V = z ? this.maxRows > V ? this.maxRows : V : V;
                        F = this._daylightSavingAdjust(new Date(O, E, 1 - s));
                        for (Z = 0; Z < V; Z++) {
                            K += "<tr>";
                            ta = !e ? "" : "<td class='ui-datepicker-week-col'>" + this._get(a, "calculateWeek")(F) + "</td>";
                            for (s = 0; 7 > s; s++)
                                na = y ? y.apply(a.input ? a.input[0] : null, [F]) : [!0, ""],
                                        ka = (M = F.getMonth() !== E) && !C || !na[0] || ba && F < ba || la && F > la, ta += "<td class='" + (5 <= (s + g + 6) % 7 ? " ui-datepicker-week-end" : "") + (M ? " ui-datepicker-other-month" : "") + (F.getTime() === R.getTime() && E === a.selectedMonth && a._keyEvent || G.getTime() === F.getTime() && G.getTime() === R.getTime() ? " " + this._dayOverClass : "") + (ka ? " " + this._unselectableClass + " ui-state-disabled" : "") + (M && !x ? "" : " " + na[1] + (F.getTime() === I.getTime() ? " " + this._currentClass : "") + (F.getTime() === ha.getTime() ? " ui-datepicker-today" : "")) + "'" + ((!M || x) && na[2] ?
                                        " title='" + na[2].replace(/'/g, "&#39;") + "'" : "") + (ka ? "" : " data-handler='selectDay' data-event='click' data-month='" + F.getMonth() + "' data-year='" + F.getFullYear() + "'") + ">" + (M && !x ? "&#xa0;" : ka ? "<span class='ui-state-default'>" + F.getDate() + "</span>" : "<a class='ui-state-default" + (F.getTime() === ha.getTime() ? " ui-state-highlight" : "") + (F.getTime() === I.getTime() ? " ui-state-active" : "") + (M ? " ui-priority-secondary" : "") + "' href='#'>" + F.getDate() + "</a>") + "</td>", F.setDate(F.getDate() + 1), F = this._daylightSavingAdjust(F);
                            K += ta + "</tr>"
                        }
                        E++;
                        11 < E && (E = 0, O++);
                        K += "</tbody></table>" + (z ? "</div>" + (0 < aa[0] && U === aa[1] - 1 ? "<div class='ui-datepicker-row-break'></div>" : "") : "");
                        J += K
                    }
                    t += J
                }
                ...
                var v, u, y, x = this._get(a, "changeMonth"), C = this._get(a, "changeYear"), G = this._get(a, "showMonthAfterYear"), t = "<div class='ui-datepicker-title'>", s = "";
                if (g || !x)
                    s += "<span class='ui-datepicker-month'>" + l[b] + "</span>";
                else {
                    l = d && d.getFullYear() === c;
                    v = e && e.getFullYear() === c;
                    s += "<select class='ui-datepicker-month' data-handler='selectMonth' data-event='change'>";
                    for (u = 0; 12 > u; u++)
                        if ((!l || u >= d.getMonth()) && (!v || u <= e.getMonth()))
                            s += "<option value='" + u + "'" + (u === b ? " selected='selected'" : "") + ">" + r[u] + "</option>";
                    s += "</select>"
                }
                G || (t += s + (g || !x || !C ? "&#xa0;" : ""));
                if (!a.yearshtml)
                ...
                var d = a.drawYear + ("Y" === c ? b : 0), e = a.drawMonth +
                        ("M" === c ? b : 0), b = Math.min(a.selectedDay, this._getDaysInMonth(d, e)) + ("D" === c ? b : 0), d = this._restrictMinMax(a, this._daylightSavingAdjust(new Date(d, e, b)));
                ...
                if (c = this._get(a, "yearRange"))
                    c = c.split(":"), d = (new Date).getFullYear(), l = parseInt(c[0], 10), r = parseInt(c[1], 10), c[0].match(/[+\-].*/) && (l += d), c[1].match(/[+\-].*/) && (r += d);
    ...
    (function(a) {
        var e = {buttons: !0, height: !0, maxHeight: !0, maxWidth: !0, minHeight: !0, minWidth: !0, width: !0}, c = {maxHeight: !0, maxWidth: !0, minHeight: !0, minWidth: !0};
        a.widget("ui.dialog", {version: "1.10.2", options: {appendTo: "body", autoOpen: !0, buttons: [], closeOnEscape: !0, closeText: "close", dialogClass: "", draggable: !0, hide: null, height: "auto", maxHeight: null, maxWidth: null, minHeight: 150, minWidth: 150, modal: !1, position: {my: "center", at: "center", of: window, collision: "fit", using: function(b) {
            ...
            widget: function() {
                ...
                this.uiDialog = a("<div>").addClass("ui-dialog ui-widget ui-widget-content ui-corner-all ui-front " + this.options.dialogClass).hide().attr({tabIndex: -1,
                    role: "dialog"}).appendTo(this._appendTo());
                this._on(this.uiDialog, {keydown: function(b) {
                        if (this.options.closeOnEscape && !b.isDefaultPrevented() && b.keyCode && b.keyCode === a.ui.keyCode.ESCAPE)
                            ...
                            if ((b.target === c[0] || b.target === this.uiDialog[0]) && !b.shiftKey)
                                e.focus(1), b.preventDefault();
                            else if ((b.target === e[0] || b.target === this.uiDialog[0]) && b.shiftKey)
                                c.focus(1),
                                        b.preventDefault()
                        }
                ...
                this.uiDialogTitlebarClose = a("<button></button>").button({label: this.options.closeText, icons: {primary: "ui-icon-closethick"}, text: !1}).addClass("ui-dialog-titlebar-close").appendTo(this.uiDialogTitlebar);
                ...
                this.uiDialog.draggable({cancel: ".ui-dialog-content, .ui-dialog-titlebar-close",
                ...
                function b(a) {
                    return{originalPosition: a.originalPosition, originalSize: a.originalSize,
                        position: a.position, size: a.size}
                }
                var c = this, e = this.options, l = e.resizable, f = this.uiDialog.css("position"), l = "string" === typeof l ? l : "n,e,s,w,se,sw,ne,nw";
                this.uiDialog.resizable({cancel: ".ui-dialog-content", containment: "document", alsoResize: this.element, maxWidth: e.maxWidth, maxHeight: e.maxHeight, minWidth: e.minWidth, minHeight: this._minHeight(), handles: l, start: function(e, f) {
        ...
        !1 !== a.uiBackCompat && a.widget("ui.dialog", a.ui.dialog, {_position: function() {
    ...
    (function(a) {
        a.widget("ui.menu", {version: "1.10.2", defaultElement: "<ul>", delay: 300, options: {icons: {submenu: "ui-icon-carat-1-e"}, menus: "ul", position: {my: "left top", at: "right top"}, role: "menu", blur: null, focus: null, select: null}, _create: function() {
                ...
                this.mouseHandled = !1;
                this.element.uniqueId().addClass("ui-menu ui-widget ui-widget-content ui-corner-all").toggleClass("ui-menu-icons", !!this.element.find(".ui-icon").length).attr({role: this.options.role, tabIndex: 0}).bind("click" +
                ...
                this.refresh();
                this._on(this.document, {click: function(e) {
                ...
                e.filter(":not(.ui-menu)").addClass("ui-menu ui-widget ui-widget-content ui-corner-all").hide().attr({role: this.options.role,
    ...
    (function(a, e) {
        a.widget("ui.progressbar", {version: "1.10.2", options: {max: 100, value: 0, change: null, complete: null}, min: 0, _create: function() {
                ...
                this.indeterminate ? (this.element.removeAttr("aria-valuenow"), this.overlayDiv ||
                        (this.overlayDiv = a("<div class='ui-progressbar-overlay'></div>").appendTo(this.valueDiv))) : (this.element.attr({"aria-valuemax": this.options.max, "aria-valuenow": c}), this.overlayDiv && (this.overlayDiv.remove(), this.overlayDiv = null));
                this.oldValue !== c && (this.oldValue = c, this._trigger("change"));
                c === this.options.max && this._trigger("complete")
            }})
    })(jQuery);
    (function(a) {
        a.widget("ui.slider", a.ui.mouse, {version: "1.10.2", widgetEventPrefix: "slide", options: {animate: !1, distance: 0, max: 100, min: 0, orientation: "horizontal", range: !1, step: 1, value: 0, values: null, change: null, slide: null, start: null, stop: null}, _create: function() {
                ...
                e.range ? (!0 === e.range && (e.values ? e.values.length && 2 !== e.values.length ? e.values = [e.values[0], e.values[0]] : a.isArray(e.values) && (e.values = e.values.slice(0)) : e.values = [this._valueMin(), this._valueMin()]), !this.range || !this.range.length ? (this.range = a("<div></div>").appendTo(this.element), c = "ui-slider-range ui-widget-header ui-corner-all") :
                        this.range.removeClass("ui-slider-range-min ui-slider-range-max").css({left: "", bottom: ""}), this.range.addClass(c + ("min" === e.range || "max" === e.range ? " ui-slider-range-" + e.range : ""))) : this.range = a([])
                ...
                this.handles.each(function(e) {
                    ...
                    if (b > l || b === l && (e === f._lastChangedValue || f.values(e) === h.min))
                        b = l, d = a(this), g = e
                });
                if (!1 === this._start(e, g))
                    return!1;
                this._mouseSliding =
                        !0;
                this._handleIndex = g;
                ...
                l = d.offset();
                this._clickOffset = !a(e.target).parents().addBack().is(".ui-slider-handle") ? {left: 0, top: 0} : {left: e.pageX - l.left - d.width() / 2, top: e.pageY - l.top - d.height() / 2 - (parseInt(d.css("borderTopWidth"), 10) || 0) - (parseInt(d.css("borderBottomWidth"), 10) || 0) + (parseInt(d.css("marginTop"), 10) || 0)};
                ...
                if (this.options.values && this.options.values.length) {
                    d = this.values(c ? 0 : 1);
                    if (2 === this.options.values.length && !0 === this.options.range && (0 === c && b > d || 1 === c && b < d))
                        b = d;
                    ...
                    b !== this.value() && (a = this._trigger("slide", a, {handle: this.handles[c], value: b}), !1 !== a && this.value(b))
            }, _stop: function(a,
                    c) {
                var b = {handle: this.handles[c], value: this.value()};
                this.options.values && this.options.values.length && (b.value = this.values(c), b.values = this.values());
                ...
                if (1 < arguments.length)
                    this.options.values[e] = this._trimAlignValue(c), this._refreshValue(), this._change(null, e);
                else if (arguments.length)
                    if (a.isArray(arguments[0])) {
                        b = this.options.values;
                        d = arguments[0];
                        for (g = 0; g < b.length; g += 1)
                            b[g] = this._trimAlignValue(d[g]), this._change(null, g);
                        this._refreshValue()
                    } else
            ...
            _valueMin: function() {
                ...
                var e, c, b, d, g, l = this.options.range, f = this.options, h = this, k = !this._animateOff ? f.animate : !1, m = {};
                if (this.options.values && this.options.values.length)
                    this.handles.each(function(b) {
                        ...
                        if (!0 === h.options.range)
                            if ("horizontal" ===
                                    h.orientation) {
                                if (0 === b)
                                    h.range.stop(1, 1)[k ? "animate" : "css"]({left: c + "%"}, f.animate);
                                if (1 === b)
                                    h.range[k ? "animate" : "css"]({width: c - e + "%"}, {queue: !1, duration: f.animate})
                            } else {
                                if (0 === b)
                                    h.range.stop(1, 1)[k ? "animate" : "css"]({bottom: c + "%"}, f.animate);
                                if (1 === b)
                                    h.range[k ? "animate" : "css"]({height: c - e + "%"}, {queue: !1, duration: f.animate})
                            }
                        e = c
                    });
                else {
                    ...
                    if ("min" === l && "horizontal" === this.orientation)
                        this.range.stop(1, 1)[k ? "animate" : "css"]({width: c + "%"}, f.animate);
                    if ("max" === l && "horizontal" === this.orientation)
                        this.range[k ? "animate" : "css"]({width: 100 - c + "%"}, {queue: !1, duration: f.animate});
                    if ("min" === l && "vertical" === this.orientation)
                        this.range.stop(1, 1)[k ? "animate" : "css"]({height: c + "%"}, f.animate);
                    if ("max" === l && "vertical" === this.orientation)
                        this.range[k ? "animate" : "css"]({height: 100 - c + "%"}, {queue: !1, duration: f.animate})
                }
            },
            _handleEvents: {keydown: function(e) {
                    ...
                    switch (e.keyCode) {
                        ...
                        case a.ui.keyCode.DOWN:
                        case a.ui.keyCode.LEFT:
                            if (e.preventDefault(), !this._keySliding && (this._keySliding = !0, a(e.target).addClass("ui-state-active"), c = this._start(e, g), !1 === c))
                                return
                    }
                    d = this.options.step;
    ...
    (function(a) {
        ...
        a.widget("ui.spinner", {version: "1.10.2", defaultElement: "<input>", widgetEventPrefix: "spin", options: {culture: null, icons: {down: "ui-icon-triangle-1-s", up: "ui-icon-triangle-1-n"}, incremental: !0, max: null, min: null, numberFormat: null, page: 10, step: 1, change: null, spin: null, start: null, stop: null}, _create: function() {
                ...
                if (!this.spinning || !1 !== this._trigger("spin", b, {value: d}))
        ...
        a.widget("ui.tabs", {version: "1.10.2", delay: 300, options: {active: null, collapsible: !1, event: "click", heightStyle: "content", hide: null, show: null, activate: null, beforeActivate: null, beforeLoad: null, load: null}, _create: function() {
                ...
                if (null === b && (d && this.tabs.each(function(c, e) {
                    if (a(e).attr("aria-controls") === d)
                        return b = c, !1
                }), null === b && (b = this.tabs.index(this.tabs.filter(".ui-tabs-active"))), null === b || -1 === b))
            ...
            _focusNextTab: function(a, b) {
                ...
                this.active.length ? (this.active.addClass("ui-tabs-active ui-state-active").attr({"aria-selected": "true", tabIndex: 0}), this._getPanelForTab(this.active).show().attr({"aria-expanded": "true",
                    "aria-hidden": "false"})) : this.tabs.eq(0).attr("tabIndex", 0)
                ...
                this.anchors.each(function(d, e) {
                    var h, k, m, n = a(e).uniqueId().attr("id"), w = a(e).closest("li"), q = w.attr("aria-controls");
                    c(e) ? (h = e.hash, k = b.element.find(b._sanitizeSelector(h))) : (m = b._tabId(w), h = "#" + m, k = b.element.find(h), k.length || (k = b._createPanel(m), k.insertAfter(b.panels[d - 1] || b.tablist)), k.attr("aria-live", "polite"));
                    k.length && (b.panels = b.panels.add(k));
                    q && w.data("ui-tabs-aria-controls", q);
                    w.attr({"aria-controls": h.substring(1), "aria-labelledby": n});
                ...
                var c = this.options, d = this.active,
                        e = a(b.currentTarget).closest("li"), k = e[0] === d[0], m = k && c.collapsible, n = m ? a() : this._getPanelForTab(e), w = !d.length ? a() : this._getPanelForTab(d), d = {oldTab: d, oldPanel: w, newTab: m ? a() : e, newPanel: n};
                b.preventDefault();
                if (!e.hasClass("ui-state-disabled") && !e.hasClass("ui-tabs-loading") && !this.running && !(k && !c.collapsible || !1 === this._trigger("beforeActivate", b, d)))
                    c.active = m ? !1 : this.tabs.index(e), this.active = k ? a() : e, this.xhr && this.xhr.abort(), !w.length && !n.length && a.error("jQuery UI Tabs: Mismatching fragment identifier."),
                            n.length && this.load(this.tabs.index(e), b), this._toggle(b, d)
                ...
                var k = this, m = c.newPanel, n = c.oldPanel;
                this.running = !0;
                ...
                b[0] !== this.active[0] && (b.length || (b = this.active), b = b.find(".ui-tabs-anchor")[0], this._eventHandler({target: b,
                    currentTarget: b, preventDefault: a.noop}))
            }, _findActive: function(b) {
                ...
                var b = this._getIndex(b), e = this, h = this.tabs.eq(b), k = h.find(".ui-tabs-anchor"), m = this._getPanelForTab(h), n = {tab: h, panel: m};
                if (!c(k[0]) && (this.xhr = a.ajax(this._ajaxSettings(k, d, n))) && "canceled" !== this.xhr.statusText)
                    h.addClass("ui-tabs-loading"), m.attr("aria-busy", "true"), this.xhr.success(function(a) {
                        setTimeout(function() {
                            m.html(a);
                            e._trigger("load", d, n)
                        }, 1)
                ...
                var e = this;
                return{url: b.attr("href"), beforeSend: function(b, g) {
    ...
    (function(a) {
        var e = 0;
        a.widget("ui.tooltip", {version: "1.10.2", options: {content: function() {
                ...
                if (!this.closing) {
                    ...
                    var l = d.data("ui-tooltip-id"), f = (d.attr("aria-describedby") || "").split(/\s+/), l = a.inArray(l, f);
                    -1 !== l && f.splice(l, 1);
                ...
                var b = "ui-tooltip-" + e++, d = a("<div>").attr({id: b, role: "tooltip"}).addClass("ui-tooltip ui-widget ui-corner-all ui-widget-content " + (this.options.tooltipClass || ""));
    ...
    (function(a, e) {
        ...
        var c = jQuery, b = function(a, b, c) {
            ...
            r(f, function(c, e) {
                ...
                g = e.space || "rgba";
                if (f)
                    return f = b[g](f), b[k[g].cache] = f[k[g].cache], d = b._rgba = f._rgba, !1
            });
        ...
        }, l = /^([\-+])=\s*(\d+\.?\d*)/, f = [{re: /rgba?\(\s*(\d{1,3})\s*,\s*(\d{1,3})\s*,\s*(\d{1,3})\s*(?:,\s*(\d?(?:\.\d+)?)\s*)?\)/, parse: function(a) {
        ...
        }, k = {rgba: {props: {red: {idx: 0, type: "byte"}, green: {idx: 1, type: "byte"}, blue: {idx: 2,
                        type: "byte"}}}, hsla: {props: {hue: {idx: 0, type: "degrees"}, saturation: {idx: 1, type: "percent"}, lightness: {idx: 2, type: "percent"}}}}, m = {"byte": {floor: !0, max: 255}, percent: {max: 1}, degrees: {mod: 360, floor: !0}}, n = h.support = {}, w = c("<p>")[0], q, r = c.each;
        ...
        h.fn = c.extend(h.prototype, {parse: function(a, e, f, g) {
                if (void 0 === a)
                    return this._rgba = [null,
                        null, null, null], this;
                if (a.jquery || a.nodeType)
                    a = c(a).css(e), e = void 0;
                var l = this, m = c.type(a), n = this._rgba = [];
                void 0 !== e && (a = [a, e, f, g], m = "array");
                if ("string" === m)
                    return this.parse(d(a) || q._default);
                if ("array" === m)
                    return r(k.rgba.props, function(c, d) {
                        n[d.idx] = b(a[d.idx], d)
                    }), this;
                if ("object" === m)
                    return a instanceof h ? r(k, function(b, c) {
                ...
                var d = h(a), e = d._space(), f = k[e], g = 0 === this.alpha() ? h("transparent") :
                        this, l = g[f.cache] || f.to(g._rgba), n = l.slice(), d = d[f.cache];
                r(f.props, function(a, e) {
                    var f = e.idx, g = l[f], h = d[f], k = m[e.type] || {};
                    null !== h && (null === g ? n[f] = h : (k.mod && (h - g > k.mod / 2 ? g += k.mod : g - h > k.mod / 2 && (g -= k.mod)), n[f] = b((h - g) * c + g, e)))
                });
                return this[e](n)
            }, blend: function(a) {
                if (1 === this._rgba[3])
        ...
        k.hsla.to = function(a) {
            ...
            var b = a[0] / 255, c = a[1] / 255, d = a[2] / 255, a = a[3], e = Math.max(b, c, d), f = Math.min(b, c, d), g = e - f, h = e + f, k = 0.5 * h;
        ...
        r(k, function(a, d) {
            ...
            h.fn[a] = function(a) {
                ...
                if (void 0 === a)
                    return this[f].slice();
                var d, l = c.type(a), m = "array" === l || "object" === l ? a : arguments, n = this[f].slice();
                r(e, function(a, c) {
                    var d = m["object" === l ? a : c.idx];
                    null == d && (d = n[c.idx]);
                    n[c.idx] = b(d, c)
                });
                return k ? (d = h(k(n)), d[f] = n, d) : h(n)
            };
            r(e, function(b, d) {
        ...
        c.cssHooks.borderColor = {expand: function(a) {
                var b = {};
        ...
        q = c.Color.names = {aqua: "#00ffff", black: "#000000", blue: "#0000ff", fuchsia: "#ff00ff", gray: "#808080", green: "#008000", lime: "#00ff00", maroon: "#800000", navy: "#000080", olive: "#808000", purple: "#800080", red: "#ff0000", silver: "#c0c0c0", teal: "#008080", white: "#ffffff", yellow: "#ffff00", transparent: [null, null, null, 0], _default: "#ffffff"};
        var v = function(b) {
            ...
            if (d && d.length && d[0] && d[d[0]])
                for (b = d.length; b--; )
                    c = d[b], "string" === typeof d[c] && (e[a.camelCase(c)] = d[c]);
            else
                for (c in d)
                    "string" === typeof d[c] && (e[c] = d[c]);
            return e
        }, u = ["add", "remove", "toggle"], y = {border: 1, borderBottom: 1, borderColor: 1, borderLeft: 1, borderRight: 1, borderTop: 1, borderWidth: 1, margin: 1, padding: 1};
        ...
        a.effects.animateClass = function(b, c, d, e) {
            ...
            return this.queue(function() {
                var c = a(this), d = c.attr("class") || "", e, g = f.children ? c.find("*").addBack() : c, g = g.map(function() {
                ...
                g = g.map(function() {
                    ...
                    for (e in c)
                        if (f = c[e], b[e] !== f && !y[e] && (a.fx.step[e] || !isNaN(parseFloat(f))))
                            d[e] = f;
                    this.diff = d;
                    return this
                });
                c.attr("class", d);
                g = g.map(function() {
                    var b = this, c = a.Deferred(), d = a.extend({}, f, {queue: !1, complete: function() {
                            c.resolve(b)
                        }});
        ...
        a.extend(a.effects, {version: "1.10.2", save: function(a, b) {
                for (var c = 0; c < b.length; c++)
                    null !== b[c] && a.data("ui-effects-" + b[c], a[0].style[b[c]])
            }, restore: function(a, b) {
                var c, d;
                for (d = 0; d < b.length; d++)
                    null !== b[d] && (c = a.data("ui-effects-" + b[d]), c === e && (c = ""), a.css(b[d], c))
                ...
                if (b.parent().is(".ui-effects-wrapper"))
                    return b.parent();
                var c = {width: b.outerWidth(!0), height: b.outerHeight(!0), "float": b.css("float")}, d = a("<div></div>").addClass("ui-effects-wrapper").css({fontSize: "100%", background: "transparent", border: "none",
                    margin: 0, padding: 0}), e = {width: b.width(), height: b.height()}, f = document.activeElement;
                try {
                    f.id
                } catch (g) {
                    f = document.body
                ...
                d = b.parent();
                "static" === b.css("position") ? (d.css({position: "relative"}), b.css({position: "relative"})) : (a.extend(c, {position: b.css("position"), zIndex: b.css("z-index")}), a.each(["top", "left", "bottom", "right"], function(a, d) {
                    c[d] = b.css(d);
    ...
    (function(a) {
        ...
        a.effects.effect.blind = function(b, d) {
            var g = a(this), l = "position top bottom left right height width".split(" "), f = a.effects.setMode(g, b.mode || "hide"), h = b.direction || "up", k = e.test(h), m = k ? "height" : "width", n = k ? "top" : "left", h = c.test(h), w = {}, q = "show" === f, r, v, u;
            ...
            v = r[m]();
            u = parseFloat(r.css(n)) ||
                    0;
            w[m] = q ? v : 0;
            h || (g.css(k ? "bottom" : "right", 0).css(k ? "top" : "left", "auto").css({position: "absolute"}), w[n] = q ? u : v + u);
            q && (r.css(m, 0), h || r.css(n, u + v));
            r.animate(w, {duration: b.duration, easing: b.easing, queue: !1, complete: function() {
                    "hide" === f && g.hide();
    ...
    (function(a) {
        a.effects.effect.bounce = function(e, c) {
            var b = a(this), d = "position top bottom left right height width".split(" "), g = a.effects.setMode(b, e.mode || "effect"), l = "hide" === g, f = "show" === g, h = e.direction || "up", g = e.distance, k = e.times || 5, m = 2 * k + (f || l ? 1 : 0), n = e.duration / m, w = e.easing, q = "up" === h || "down" === h ? "top" : "left", h = "up" === h || "left" === h, r, v, u = b.queue(), y = u.length;
            (f || l) && d.push("opacity");
            a.effects.save(b, d);
            b.show();
            ...
            f &&
                    (v = {opacity: 1}, v[q] = 0, b.css("opacity", 0).css(q, h ? 2 * -g : 2 * g).animate(v, n, w));
            l && (g /= Math.pow(2, k - 1));
            v = {};
            for (f = v[q] = 0; f < k; f++)
                r = {}, r[q] = (h ? "-=" : "+=") + g, b.animate(r, n, w).animate(v, n, w), g = l ? 2 * g : g / 2;
            l && (r = {opacity: 0}, r[q] = (h ? "-=" : "+=") + g, b.animate(r, n, w));
            b.queue(function() {
                l && b.hide();
    ...
    (function(a) {
        a.effects.effect.clip = function(e, c) {
            var b = a(this), d = "position top bottom left right height width".split(" "), g = "show" === a.effects.setMode(b, e.mode || "hide"), l = "vertical" === (e.direction || "vertical"), f = l ? "height" : "width", l = l ? "top" : "left", h = {}, k, m;
            a.effects.save(b, d);
            b.show();
            ...
            h[f] = g ? m : 0;
            h[l] = g ? 0 : m / 2;
            k.animate(h, {queue: !1, duration: e.duration, easing: e.easing, complete: function() {
                    g ||
                            b.hide();
                    a.effects.restore(b, d);
                    a.effects.removeWrapper(b);
    ...
    (function(a) {
        a.effects.effect.drop = function(e, c) {
            var b = a(this), d = "position top bottom left right opacity height width".split(" "), g = a.effects.setMode(b, e.mode || "hide"), l = "show" === g, f = e.direction || "left", h = "up" === f || "down" === f ? "top" : "left", f = "up" === f || "left" === f ? "pos" : "neg", k = {opacity: l ? 1 : 0}, m;
            a.effects.save(b, d);
            b.show();
            a.effects.createWrapper(b);
            ...
            k[h] = (l ? "pos" === f ? "+=" : "-=" : "pos" === f ? "-=" : "+=") +
                    m;
            b.animate(k, {queue: !1, duration: e.duration, easing: e.easing, complete: function() {
                    "hide" === g && b.hide();
                    a.effects.restore(b, d);
                    a.effects.removeWrapper(b);
                    c()
    ...
    (function(a) {
        a.effects.effect.explode = function(e, c) {
            function b() {
                n.push(this);
                n.length === d * g && (l.css({visibility: "visible"}), a(n).remove(), f || l.hide(), c())
            }
            var d = e.pieces ? Math.round(Math.sqrt(e.pieces)) : 3, g = d, l = a(this), f = "show" === a.effects.setMode(l, e.mode || "hide"), h = l.show().css("visibility", "hidden").offset(), k = Math.ceil(l.outerWidth() / g), m = Math.ceil(l.outerHeight() / d), n = [], w, q, r, v, u, y;
            for (w = 0; w < d; w++) {
                v = h.top + w * m;
                y = w - (d - 1) / 2;
                for (q = 0; q < g; q++)
                    r = h.left + q * k, u = q - (g - 1) / 2, l.clone().appendTo("body").wrap("<div></div>").css({position: "absolute",
                        visibility: "visible", left: -q * k, top: -w * m}).parent().addClass("ui-effects-explode").css({position: "absolute", overflow: "hidden", width: k, height: m, left: r + (f ? u * k : 0), top: v + (f ? y * m : 0), opacity: f ? 0 : 1}).animate({left: r + (f ? 0 : u * k), top: v + (f ? 0 : y * m), opacity: f ? 1 : 0}, e.duration || 500, e.easing, b)
            }
        }
    })(jQuery);
    (function(a) {
    ...
    (function(a) {
        a.effects.effect.fold = function(e, c) {
            var b = a(this), d = "position top bottom left right height width".split(" "), g = a.effects.setMode(b, e.mode || "hide"), l = "show" === g, f = "hide" === g, g = e.size || 15, h = /([0-9]+)%/.exec(g), k = !!e.horizFirst, m = l !== k, n = m ? ["width", "height"] : ["height", "width"], w = e.duration / 2, q, r = {}, v = {};
            a.effects.save(b, d);
            b.show();
            ...
            l && q.css(k ? {height: 0,
                width: g} : {height: g, width: 0});
            r[n[0]] = l ? m[0] : g;
            v[n[1]] = l ? m[1] : 0;
            q.animate(r, w, e.easing).animate(v, w, e.easing, function() {
                f && b.hide();
                a.effects.restore(b, d);
                a.effects.removeWrapper(b);
                c()
    ...
    (function(a) {
        a.effects.effect.highlight = function(e, c) {
            var b = a(this), d = ["backgroundImage", "backgroundColor", "opacity"], g = a.effects.setMode(b, e.mode || "show"), l = {backgroundColor: b.css("backgroundColor")};
            "hide" === g && (l.opacity = 0);
            a.effects.save(b, d);
            b.show().css({backgroundImage: "none", backgroundColor: e.color || "#ffff99"}).animate(l, {queue: !1, duration: e.duration, easing: e.easing, complete: function() {
                    "hide" === g && b.hide();
                    a.effects.restore(b, d);
                    c()
                }})
    ...
    (function(a) {
        a.effects.effect.pulsate = function(e, c) {
            var b = a(this), d = a.effects.setMode(b, e.mode || "show"), g = "show" === d, l = "hide" === d, d = 2 * (e.times || 5) + (g || "hide" === d ? 1 : 0), f = e.duration / d, h = 0, k = b.queue(), m = k.length;
            if (g || !b.is(":visible"))
                b.css("opacity", 0).show(), h = 1;
            for (g = 1; g < d; g++)
                b.animate({opacity: h}, f, e.easing), h = 1 - h;
    ...
    (function(a) {
        a.effects.effect.puff = function(e, c) {
            var b = a(this), d = a.effects.setMode(b, e.mode || "hide"), g = "hide" === d, l = parseInt(e.percent, 10) || 150, f = l / 100, h = {height: b.height(), width: b.width(), outerHeight: b.outerHeight(), outerWidth: b.outerWidth()};
        ...
        a.effects.effect.scale = function(e, c) {
            var b = a(this), d = a.extend(!0,
                    {}, e), g = a.effects.setMode(b, e.mode || "effect"), l = parseInt(e.percent, 10) || (0 === parseInt(e.percent, 10) ? 0 : "hide" === g ? 0 : 100), f = e.direction || "both", h = e.origin, k = {height: b.height(), width: b.width(), outerHeight: b.outerHeight(), outerWidth: b.outerWidth()}, m = "horizontal" !== f ? l / 100 : 1, l = "vertical" !== f ? l / 100 : 1;
            d.effect = "size";
            d.queue = !1;
            d.complete = c;
            "effect" !== g && (d.origin = h || ["middle", "center"], d.restore = !0);
            d.from = e.from || ("show" === g ? {height: 0, width: 0, outerHeight: 0, outerWidth: 0} : k);
            d.to = {height: k.height * m, width: k.width *
        ...
        a.effects.effect.size = function(e, c) {
            var b, d, g, l, f, h, k = a(this), m = "position top bottom left right width height overflow opacity".split(" ");
            f = "position top bottom left right overflow opacity".split(" ");
            var n = ["width", "height", "overflow"], w = ["fontSize"], q = ["borderTopWidth", "borderBottomWidth", "paddingTop", "paddingBottom"], r = ["borderLeftWidth",
                "borderRightWidth", "paddingLeft", "paddingRight"], v = a.effects.setMode(k, e.mode || "effect"), u = e.restore || "effect" !== v, y = e.scale || "both";
            h = e.origin || ["middle", "center"];
            var x = k.css("position"), C = u ? m : f, G = {height: 0, width: 0, outerHeight: 0, outerWidth: 0};
            "show" === v && k.show();
            f = {height: k.height(), width: k.width(), outerHeight: k.outerHeight(), outerWidth: k.outerWidth()};
            "toggle" === e.mode && "show" === v ? (k.from = e.to || G, k.to = e.from || f) : (k.from = e.from || ("show" === v ? G : f), k.to = e.to || ("hide" === v ? G : f));
            g = k.from.height / f.height;
            l = k.from.width / f.width;
            b = k.to.height / f.height;
            d = k.to.width / f.width;
            if ("box" === y || "both" === y)
                g !== b && (C = C.concat(q), k.from = a.effects.setTransition(k, q, g, k.from), k.to = a.effects.setTransition(k, q, b, k.to)), l !== d && (C = C.concat(r), k.from = a.effects.setTransition(k, r, l, k.from), k.to = a.effects.setTransition(k, r, d, k.to));
            if (("content" === y || "both" === y) && g !== b)
                C = C.concat(w).concat(n), k.from = a.effects.setTransition(k, w, g, k.from), k.to = a.effects.setTransition(k, w, b, k.to);
            a.effects.save(k, C);
            k.show();
            ...
            k.css(k.from);
            if ("content" === y || "both" === y)
                q = q.concat(["marginTop", "marginBottom"]).concat(w), r = r.concat(["marginLeft", "marginRight"]), n = m.concat(q).concat(r), k.find("*[width]").each(function() {
                    var c = a(this), f = c.height(), h = c.width(), k = c.outerHeight(),
                            m = c.outerWidth();
                    u && a.effects.save(c, n);
                    ...
                    c.animate(c.to, e.duration, e.easing, function() {
                        u && a.effects.restore(c, n)
                    })
                });
            k.animate(k.to, {queue: !1, duration: e.duration, easing: e.easing,
                complete: function() {
                    0 === k.to.opacity && k.css("opacity", k.from.opacity);
                    "hide" === v && k.hide();
                    a.effects.restore(k, C);
                    u || ("static" === x ? k.css({position: "relative", top: k.to.top, left: k.to.left}) : a.each(["top", "left"], function(a, b) {
    ...
    (function(a) {
        a.effects.effect.shake = function(e, c) {
            var b = a(this), d = "position top bottom left right height width".split(" "), g = a.effects.setMode(b, e.mode || "effect"), l = e.direction || "left", f = e.distance || 20, h = e.times || 3, k = 2 * h + 1, m = Math.round(e.duration / k), n = "up" === l || "down" === l ? "top" : "left", w = "up" === l || "left" === l, l = {}, q = {}, r = {}, v = b.queue(), u = v.length;
            a.effects.save(b, d);
            b.show();
            a.effects.createWrapper(b);
            l[n] = (w ? "-=" : "+=") + f;
            ...
            for (f = 1; f <
                    h; f++)
                b.animate(q, m, e.easing).animate(r, m, e.easing);
    ...
    (function(a) {
        a.effects.effect.slide = function(e, c) {
            var b = a(this), d = "position top bottom left right width height".split(" "), g = a.effects.setMode(b, e.mode || "show"), l = "show" === g, f = e.direction || "left", h = "up" === f || "down" === f ? "top" : "left", f = "up" === f || "left" === f, k, m = {};
            a.effects.save(b, d);
            b.show();
    ...
    (function() {
        function a(a, c, b, d) {
            if (a.addEventListener)
                return a.addEventListener(c, b, d), {destroy: function() {
        ...
        this.FastButton.prototype.destroy =
                function() {
                    for (i = this.events.length - 1; 0 <= i; i -= 1)
        ...
        this.FastButton.prototype.reset = function() {
            for (i = this.touchEvents.length - 1; 0 <= i; i -= 1)
    ...
    (function(a) {
        a.event.special.fastClick = {setup: function() {
    ...
    var messenger = function(a) {
            ...
            if (a.isWebWorker || !("*" !== a.origin && a.origin !== b.origin))
                try {
                    ...
                    if ("yumprint messenger" === c.protocol) {
                        var n = e[g];
                        if (n) {
                            var w = a.isWebWorker ? a.target : b.source;
                            n(k, function(a, b) {
                                d(w, "callback", {id: m, data: a}, b)
                            })
                        }
                    }
                } catch (q) {
        ...
        return{postMessage: function(b, c, e) {
                d(a.target, b, c, e)
    ...
    function wordpress(a, e, c, b) {
        ...
        $.ajax({url: window.ajaxurl || window.yumprintRecipeAjaxUrl, dataType: "json", async: c, data: {action: a, data: e}, type: "POST", success: b, error: function() {
                b(!1)
            }})
    }
    ;
    function createStars(a) {
        var e = a.size || 32, c = a.prefix || "", b = a.hasText || void 0 === a.hasText, d = void 0 === a.clear || a.clear, g = void 0 === a.clickable || a.clickable ? $("<div class='" + c + "star-container " + c + "brown-text'></div>") : $("<div class='" + c + "star-container " + c + "brown-text-nh'></div>"), l = a.selected || void 0, f;
        l && !a.constant && (l = Math.round(l));
        !a.constant && d && $("<div class='" + c + "x'></div>").css({width: e + "px", height: e + "px", backgroundSize: 2 * e + "px " + e + "px"}).hover(function() {
            ...
            for (var d = 0; d < h.length; ++d)
                h[d].removeClass(c + "on " + c + "off")
        }).fastClick(function() {
            l = void 0;
            g.change();
            for (var a = 0; a < h.length; ++a)
                h[a].removeClass(c + "selected " + c + "unselected")
        }).appendTo(g);
        for (var h = [], d = 0; d < a.stars; ++d)
            (function(d) {
                var k = $("<div class='" + c + "star'></div>").css({width: e + "px", height: e + "px", backgroundSize: 2 *
                            e + "px " + e + "px"}).appendTo(g);
                a.constant || k.addClass(c + "selectable").hover(function() {
                    b && a.text && f.text(a.text[d + 1]);
                    for (var e = 0; e < h.length; ++e)
                        e <= d ? h[e].addClass(c + "on") : h[e].addClass(c + "off");
                    ...
                    g.change();
                    for (var a = 0; a < h.length; ++a)
                        a <= d ? h[a].removeClass(c + "unselected").addClass(c +
        ...
        if (l)
            for (var k = Math.floor(l), m = l - k, d = 0; d < h.length; ++d)
                if (d < k)
                    h[d].addClass(c + "selected");
                else if (d === k && 0 !== m) {
                    h[d].addClass(c + "partial");
                    var n = 0.5 > m ? 0.5 * Math.sin(m * Math.PI) : 1 - 0.5 * Math.sin((1 - m) * Math.PI), n = Math.round(n * e), w = e - n, q = 2 * e + "px " + e + "px", r = -e + "px 0px", v = -n + "px 0px";
                    $("<div class='" + c + "star-left'></div>").css({height: e + "px", width: n + "px", backgroundSize: q, backgroundPosition: r}).appendTo(h[d]);
                    $("<div class='" + c + "star-right'></div>").css({height: e + "px", width: w + "px", backgroundSize: q, backgroundPosition: v}).appendTo(h[d])
                } else
                    h[d].addClass(c +
                            "unselected");
        b && g.find("." + c + "text").height(e).css({height: e + "px", lineHeight: e + "px", fontSize: Math.round(0.8 * e) + "px"});
        g.selected = function() {
            return l
        };
        return g
            ...
            switch (typeof y) {
                ...
                case "object":
                    ...
                    if (h && "object" === typeof h) {
                        r = h.length;
                        for (d = 0; d < r; d += 1)
                            "string" === typeof h[d] && (f = h[d], (q = c(f, y)) && u.push(e(f) + (g ? ": " : ":") + q))
                    } else
                        for (f in y)
                            Object.prototype.hasOwnProperty.call(y, f) && (q = c(f, y)) && u.push(e(f) + (g ? ": " : ":") + q);
                    q = 0 === u.length ? "{}" : g ? "{\n" + g + u.join(",\n" + g) + "\n" + v + "}" : "{" + u.join(",") +
                            "}";
                    g = v;
                    return q
        ...
        "function" !== typeof JSON.parse && (JSON.parse = function(a, c) {
            function d(a, b) {
                ...
                if (g && "object" === typeof g)
                    for (e in g)
                        Object.prototype.hasOwnProperty.call(g, e) && (f = d(g, e), void 0 !== f ? g[e] = f : delete g[e]);
                return c.call(a, b, g)
            }
            var e, a = String(a);
            b.lastIndex = 0;
    ...
    var api = function() {
        var a = ("api.yumprint.com" === window.location.host || "testapi.yumprint.com" === window.location.host) && "/proxy" === window.location.pathname, e = function(a) {
            return function(b) {
                return function() {
                    for (var c, d, e = b, f = 0; f < arguments.length; ++f) {
                        ...
                        if (!c && "object" === h)
                            ...
                            e = e.replace(RegExp("\\$" + f, "g"), arguments[f])
                    }
                    c = c || {};
                    for (var j in c)
        ...
        if (!("withCredentials"in new XMLHttpRequest) && !a) {
            ...
            window.addEventListener("message", function(a) {
                if (a.origin === SECURE_API_HOST)
                    if ("yumprint-proxy-ready" === a.data)
                        k.set();
                    else
                        try {
        ...
        }, n = b(SECURE_API_HOST + "/ping/");
        d.ping = function(a) {
            n({}, m(a))
        };
        var w = b(SECURE_API_HOST + "/user/$0/friends/facebook/");
        d.friendsFacebook = function(a, b, c, d) {
            w(a, {access_token: b, facebook_token: c}, m(d))
        };
        var q =
                b(SECURE_API_HOST + "/user/$0/friends/gmail/");
        d.friendsGmail = function(a, b, c) {
            q(a, {access_token: b}, m(c))
        };
        var r = c(SECURE_API_HOST + "/user/request/");
        d.request = function(a, b) {
            r({email: a}, m(b))
        };
        var v = c(SECURE_API_HOST + "/user/$0/premium/subscribe/stripe/");
        d.subscribePremium = function(a, b, c) {
            "function" === typeof b && (c = b, b = null);
            v(a, {token: b}, m(c))
        };
        var u = c(SECURE_API_HOST + "/user/$0/premium/unsubscribe/stripe/");
        d.unsubscribePremium = function(a, b) {
            u(a, m(b))
        };
        var y = b(SECURE_API_HOST + "/object/$0/");
        d.getObject =
                function(a, b, c) {
                    y(b, {user_id: a || null}, m(c))
                };
        var x = c(SECURE_API_HOST + "/user/$0/object/$1/view/");
        d.viewObject = function(a, b, c) {
            x(a, b, m(c))
        };
        var C = c(SECURE_API_HOST + "/log/");
        d.log = function(a, b, c, d, e) {
            C({cookie: a, session: b, user_id: c, action: d}, m(e))
        };
        var G = c(SECURE_API_HOST + "/log-batch/");
        d.logBatch = function(a, b) {
            G({logs: a}, m(b))
        };
        var t = c(SECURE_API_HOST + "/user/$0/object/$1/link/");
        d.addObject = function(a, b, c, d) {
            t(a, b, {container_id: c}, m(d))
        };
        var s = c(SECURE_API_HOST + "/user/$0/object/$1/remove/");
        d.removeObject =
                function(a, b, c, d) {
                    s(a, b, {container_id: c}, m(d))
                };
        var A = c(SECURE_API_HOST + "/user/$0/object/$1/title/");
        ...
        var U = c(SECURE_API_HOST + "/user/$0/object/$1/image/");
        d.changeObjectImageWithId = function(a, b, c, d) {
            U(a, b, {image_id: c}, m(d))
        };
        var R = b(SECURE_API_HOST + "/object/$0/images/");
        d.imagesInCookbook = function(a, b) {
            R(a, {}, m(b))
        };
        var K =
                c(SECURE_API_HOST + "/user/$0/collection/add/");
        d.createCollection = function(a, b, c, d, e) {
            "function" == typeof c ? (e = c, d = c = null) : "function" == typeof d && (e = d, d = null);
            K(a, {title: b, container_id: c, image_url: d}, m(e))
        };
        var V = c(SECURE_API_HOST + "/user/$0/recipe/add/");
        d.createRecipe = function(a, b, c, d) {
            "function" == typeof c && (d = c, c = null);
            V(a, {recipeData: b, container_id: c}, m(d))
        };
        var F = c(SECURE_API_HOST + "/widget/recipe/");
        d.createWidgetRecipe = function(a, b) {
            F({recipeData: a}, m(b))
        };
        var Z = b(SECURE_API_HOST + "/user/$0/object/$1/replace/");
        d.canReplace = function(a, b, c) {
            Z(a, b, {}, m(c))
        };
        var ta = b(SECURE_API_HOST + "/user/$0/");
        d.userInfo = function(a, b) {
            ta(a, {}, m(b))
        };
        var na = b(SECURE_API_HOST + "/user/login/facebook/");
        d.loginFacebook = function(a, b) {
            na({token: a}, m(b))
        };
        var M = c(SECURE_API_HOST + "/user/login/yumprint/");
        d.loginYumprint = function(a, b, c) {
            M({email: a, password: b}, m(c))
        };
        var ka = c(SECURE_API_HOST + "/user/reset/yumprint/");
        d.resetYumprint = function(a, b) {
            ka({email: a}, m(b))
        };
        var ha = c(SECURE_API_HOST + "/user/$0/follow/$1/");
        d.follow = function(a,
                b, c) {
            ha(a, b, {}, m(c))
        };
        var W = c(SECURE_API_HOST + "/user/$0/unfollow/$1/");
        d.unfollow = function(a, b, c) {
            W(a, b, {}, m(c))
        };
        var aa = b(SECURE_API_HOST + "/user/$0/station/$1/");
        d.station = function(a, b, c, d, e) {
            aa(a, b, {page: c, person_id: d}, m(e))
        };
        var E = b(SECURE_API_HOST + "/station/all/");
        d.allStations = function(a, b, c) {
            "function" === typeof b && (c = b, b = null);
            E({user_token: a || null, object_id: b}, m(c))
        };
        var z = c(SECURE_API_HOST + "/user/register/facebook/");
        d.registerFacebook = function(a, b, c) {
            "function" === typeof b && (c = b, b = null);
            b =
                    b || {};
            z({token: a, type: b.type || null, value: b.value || null}, m(c))
        };
        var I = c(SECURE_API_HOST + "/user/register/yumprint/");
        d.registerYumprint = function(a, b) {
            a.type = a.type || null;
            a.value = a.value || null;
            I({email_address: a.email, password: a.password, first_name: a.firstName, last_name: a.lastName, gender: a.gender, photo: a.photo, type: a.type, value: a.value}, m(b))
        };
        var ba = b(SECURE_API_HOST + "/query/top/$0/");
        d.top = function(a, b) {
            ba(a, m(b))
        };
        var la = b(SECURE_API_HOST + "/user/$0/collection/list/");
        d.getCollections = function(a, b) {
            la(a,
                    m(b))
        };
        var O = b(SECURE_API_HOST + "/user/$0/quest/list/");
        d.quests = function(a, b) {
            O(a, {}, m(b))
        };
        var xa = c(SECURE_API_HOST + "/user/$0/quest/");
        d.completeQuest = function(a, b, c) {
            xa(a, {quest_name: b}, m(c))
        };
        var sb = b(SECURE_API_HOST + "/user/$0/collection/all/");
        d.getAll = function(a, b) {
            sb(a, m(b))
        };
        var $a = b(SECURE_API_HOST + "/recipe/$0/review/");
        d.getReview = function(a, b) {
            $a(a, {}, m(b))
        };
        var ua = c(SECURE_API_HOST + "/user/$0/recipe/$1/cook/");
        d.cook = function(a, b, c, d, e, f, g) {
            "function" === typeof d ? (g = d, e = d = null) : "function" ===
                    typeof e ? (g = e, e = null) : "function" === typeof f && (g = f, f = null);
            ua(a, b, {date: c, rating: d, review_text: e, share: f}, m(g))
        };
        var tb = b(SECURE_API_HOST + "/user/$0/recipe/$1/review/");
        d.getCook = function(a, b, c) {
            tb(a, b, {}, m(c))
        };
        var Ob = c(SECURE_API_HOST + "/admin/$0/email/");
        d.sendEmail = function(a, b, c) {
            Ob(a, b, m(c))
        };
        var Ga = c(SECURE_API_HOST + "/user/$0/invite/");
        d.sendInvite = function(a, b, c, d) {
            Ga(a, {emails: b, message: c}, m(d))
        };
        var ab = b(SECURE_API_HOST + "/query/stats/");
        d.stats = function(a) {
            ab({}, m(a))
        };
        var j = b(SECURE_API_HOST +
                "/person/$0/following/");
        d.getFollowing = function(a, b) {
            j(a, {}, m(b))
        };
        var Ka = b(SECURE_API_HOST + "/person/$0/");
        d.person = function(a, b) {
            Ka(a, {}, m(b))
        };
        var ja = b(SECURE_API_HOST + "/person/$0/followers/");
        d.getFollowers = function(a, b) {
            ja(a, {}, m(b))
        };
        var Pb = b(SECURE_API_HOST + "/person/$0/schedule/");
        d.getSchedule = function(a, b, c) {
            Pb(a, {days: b}, m(c))
        };
        var Qb = b(SECURE_API_HOST + "/person/$0/day/");
        d.getDay = function(a, b, c, d) {
            Qb(a, {day: b, user_token: c || null}, m(d))
        };
        var ub = b(SECURE_API_HOST + "/person/$0/try-soon/");
        d.getTrySoon =
                function(a, b, c) {
                    ub(a, {user_token: b || null}, m(c))
                };
        var Rb = c(SECURE_API_HOST + "/user/$0/schedule/$1/");
        d.schedule = function(a, b, c, d, e) {
            "function" === typeof d && (e = d, d = null);
            Rb(a, b, {day: c, try_soon_id: d}, m(e))
        };
        var Sb = c(SECURE_API_HOST + "/user/$0/schedule/$1/position/");
        d.positionSchedule = function(a, b, c, d) {
            Sb(a, b, {position: c}, m(d))
        };
        var Tb = c(SECURE_API_HOST + "/user/$0/schedule/$1/remove/");
        d.removeSchedule = function(a, b, c) {
            Tb(a, b, {}, m(c))
        };
        var Ub = c(SECURE_API_HOST + "/user/$0/schedule/$1/move/");
        d.moveSchedule =
                function(a, b, c, d) {
                    Ub(a, b, {day: c}, m(d))
                };
        var Vb = c(SECURE_API_HOST + "/user/$0/try-soon/$1/add/");
        d.trySoon = function(a, b, c) {
            Vb(a, b, {}, m(c))
        };
        var Wb = c(SECURE_API_HOST + "/user/$0/try-soon/$1/remove/");
        d.removeTrySoon = function(a, b, c) {
            Wb(a, b, {}, m(c))
        };
        var Xb = b(SECURE_API_HOST + "/user/$0/try-soon/summary/");
        d.trySoonSummary = function(a, b) {
            Xb(a, {}, m(b))
        };
        var oa = b(SECURE_API_HOST + "/user/$0/schedules/top/");
        d.topSchedules = function(a, b) {
            oa(a, {}, m(b))
        };
        var vb = b(SECURE_API_HOST + "/user/$0/schedules/follow/");
        d.followSchedules =
                function(a, b) {
                    vb(a, {}, m(b))
                };
        var wb = b(SECURE_API_HOST + "/user/$0/person/$1/info/");
        d.personInfo = function(a, b, c) {
            wb(a, b, {}, m(c))
        };
        var Yb = c(SECURE_API_HOST + "/user/$0/try-soon/schedule/$1/");
        d.trySoonFromSchedule = function(a, b, c) {
            Yb(a, b, {}, m(c))
        };
        var bb = b(SECURE_API_HOST + "/user/$0/nutrition/");
        d.nutrition = function(a, b) {
            bb(a, {}, m(b))
        };
        var N = c(SECURE_API_HOST + "/user/$0/nutrition/recipes/");
        d.recipesNutrition = function(a, b, c) {
            N(a, {ids: b}, m(c))
        };
        var La = b(SECURE_API_HOST + "/nutrition/recipe/$0/");
        d.recipeNutrition =
                function(a, b, c) {
                    La(b, {user_token: a || null}, m(c))
                };
        var pa = b(SECURE_API_HOST + "/user/available/");
        d.emailAvailable = function(a, b) {
            pa({email: a}, m(b))
        };
        var X = c(SECURE_API_HOST + "/user/password/reset/");
        d.resetPassword = function(a, b, c) {
            X({token: a, password: b}, m(c))
        };
        var Ma = b(SECURE_API_HOST + "/user/$0/settings/");
        d.getSettings = function(a, b) {
            Ma(a, {}, m(b))
        };
        var Na = c(SECURE_API_HOST + "/user/$0/settings/change/");
        d.setSettings = function(a, b, c) {
            Na(a, {settings: b}, m(c))
        };
        var Oa = c(SECURE_API_HOST + "/user/$0/password/change/");
        d.changePassword = function(a, b, c, d) {
            Oa(a, {old: b, password: c}, m(d))
        };
        var cb = c(SECURE_API_HOST + "/user/$0/password/set/");
        d.setPassword = function(a, b, c) {
            cb(a, {password: b}, m(c))
        };
        var xb = b(SECURE_API_HOST + "/search/");
        d.search = function(a, b, c) {
            xb({user_token: a || null, text: b}, m(c))
        };
        var db = b(SECURE_API_HOST + "/search/summary/");
        d.searchSummary = function(a, b, c) {
            db({user_token: a || null, text: b}, m(c))
        };
        var D = b(SECURE_API_HOST + "/search/all/");
        d.searchRecipes = function(a, b, c, d) {
            D({user_token: a || null, text: b, page: c}, m(d))
        };
        var vc = b(SECURE_API_HOST + "/search/my/");
        d.searchMyRecipes = function(a, b, c, d) {
            vc({user_token: a || null, text: b, page: c}, m(d))
        };
        var Lb = b(SECURE_API_HOST + "/search/friends/");
        d.searchFriendsRecipes = function(a, b, c, d) {
            Lb({user_token: a || null, text: b, page: c}, m(d))
        };
        var Kb = b(SECURE_API_HOST + "/search/people/");
        d.searchPeople = function(a, b, c, d) {
            Kb({user_token: a || null, text: b, page: c}, m(d))
        };
        var ya = b(SECURE_API_HOST + "/user/$0/shopping/");
        d.getShoppingList = function(a, b) {
            ya(a || null, {}, m(b))
        };
        var yb = c(SECURE_API_HOST + "/user/$0/shopping/add/recipe/");
        d.addRecipeToShoppingList = function(a, b, c) {
            yb(a || null, {object_id: b}, m(c))
        };
        var eb = c(SECURE_API_HOST + "/user/$0/shopping/clear/");
        d.clearShoppingList = function(a, b) {
            eb(a || null, {}, m(b))
        };
        var Zb = c(SECURE_API_HOST + "/user/$0/shopping/check/");
        d.checkAllShoppingList = function(a, b) {
            Zb(a || null, {}, m(b))
        };
        var $b = c(SECURE_API_HOST + "/user/$0/shopping/item/check/");
        d.checkShoppingListItem = function(a, b, c) {
            $b(a || null, {item_id: b}, m(c))
        };
        var ac = c(SECURE_API_HOST + "/user/$0/shopping/item/undo/");
        d.undoShoppingListItem =
                function(a, b, c) {
                    ac(a || null, {item_id: b}, m(c))
                };
        var zb = c(SECURE_API_HOST + "/user/$0/shopping/clear/remove/");
        d.clearRemoveShoppingList = function(a, b) {
            zb(a || null, {}, m(b))
        };
        var fb = c(SECURE_API_HOST + "/user/$0/shopping/item/remove/");
        d.removeShoppingListItem = function(a, b, c) {
            fb(a || null, {item_id: b}, m(c))
        };
        var va = c(SECURE_API_HOST + "/user/$0/shopping/item/undo/remove/");
        d.undoRemoveShoppingListItem = function(a, b, c) {
            va(a || null, {item_id: b}, m(c))
        };
        var gb = b(SECURE_API_HOST + "/shopping/category/");
        d.getShoppingListCategories =
                function(a) {
                    gb({}, m(a))
                };
        var hb = c(SECURE_API_HOST + "/user/$0/shopping/subitem/category/");
        d.setShoppingListSubItemCategory = function(a, b, c, d) {
            hb(a || null, {sub_item_id: b, category: c}, m(d))
        };
        var bc = c(SECURE_API_HOST + "/user/$0/shopping/item/name/");
        d.setShoppingListItemName = function(a, b, c, d) {
            bc(a || null, {item_id: b, name: c}, m(d))
        };
        var cc = c(SECURE_API_HOST + "/user/$0/shopping/item/amount/");
        d.setShoppingListItemAmount = function(a, b, c, d) {
            cc(a || null, {item_id: b, amount: c}, m(d))
        };
        var Ab = c(SECURE_API_HOST + "/user/$0/shopping/group/remove/");
        d.removeShoppingListGroup = function(a, b, c) {
            Ab(a || null, {group_id: b}, m(c))
        };
        var Bb = c(SECURE_API_HOST + "/user/$0/shopping/add/ingredient/");
        d.addIngredientToShoppingList = function(a, b, c) {
            Bb(a || null, {text: b}, m(c))
        };
        var ib = c(SECURE_API_HOST + "/user/$0/shopping/add/menu/");
        d.addMenuToShoppingList = function(a, b) {
            ib(a || null, {}, m(b))
        };
        var jb = c(SECURE_API_HOST + "/user/$0/shopping/add/menu-item/");
        d.addScheduleToShoppingList = function(a, b, c) {
            jb(a || null, {schedule_id: b}, m(c))
        };
        var fa = c(SECURE_API_HOST + "/user/$0/shopping/share/email/");
        d.emailShoppingList = function(a, b, c, d) {
            "function" === typeof b ? (d = b, c = b = null) : "function" === typeof c && (d = c, c = null);
            fa(a || null, {email: b || null, text: c || null}, m(d))
        };
        var qa = c(SECURE_API_HOST + "/user/$0/pin/mark/");
        d.markPins = function(a, b, c) {
            qa(a, {pins: b}, m(c))
        };
        var H = c(SECURE_API_HOST + "/user/$0/pin/marked/");
        d.markedPins = function(a, b) {
            H(a, m(b))
        };
        var Eb = b(SECURE_API_HOST + "/user/$0/pin/proxy/");
        d.proxy = function(a, b, c, d) {
            Eb(a, {url: b, timeout: c}, m(d))
        };
        var fc = b(SECURE_API_HOST + "/user/$0/sale/recipe/");
        d.getRecipeSales =
                function(a, b, c) {
                    fc(a, {object_id: b}, m(c))
                };
        var gc = b(SECURE_API_HOST + "/user/$0/sale/menu/");
        d.getMenuSales = function(a, b) {
            gc(a, {}, m(b))
        };
        var wa = b(SECURE_API_HOST + "/user/$0/sale/list/");
        d.getListSales = function(a, b) {
            wa(a, {}, m(b))
        };
        var Sa = c(SECURE_API_HOST + "/user/$0/sale/remove/");
        d.removeSale = function(a, b, c, d, e) {
            "function" == typeof c ? (e = c, d = c = null) : "function" == typeof d && (e = d, d = null);
            Sa(a, {sale_id: b, type: c, type_id: d}, m(e))
        };
        var Ta = c(SECURE_API_HOST + "/user/$0/sale/remove-multiple/");
        d.removeSales = function(a,
                b, c) {
            Ta(a, {store_id: b}, m(c))
        };
        var lb = c(SECURE_API_HOST + "/user/$0/sale/add/");
        d.addSale = function(a, b, c, d, e) {
            "function" == typeof c ? (e = c, d = c = null) : "function" == typeof d && (e = d, d = null);
            lb(a, {sale_id: b, type: c, type_id: d}, m(e))
        };
        var mb = c(SECURE_API_HOST + "/user/$0/store/add/");
        d.addStore = function(a, b, c) {
            mb(a, {store_id: b}, m(c))
        };
        var Ua = c(SECURE_API_HOST + "/user/$0/store/remove/");
        d.removeStore = function(a, b, c, d, e) {
            "function" == typeof c ? (e = c, d = c = null) : "function" == typeof d && (e = d, d = null);
            Ua(a, {store_id: b, type: c, type_id: d},
            m(e))
        };
        var nb = b(SECURE_API_HOST + "/user/$0/store/");
        d.getStores = function(a, b) {
            nb(a, {}, m(b))
        };
        var ob = c(SECURE_API_HOST + "/user/$0/store/zipcode/");
        d.updateZipcode = function(a, b, c) {
            ob(a, {zipcode: b}, m(c))
        };
    ...
    function showDialog(a) {
        var e = function(c) {
            ...
            }, d = $("<div class='blog-yumprint-overlay-dialog'><div class='blog-yumprint-dialog-wrapper'></div></div>").hide().appendTo($("body")), e = $("<div class='blog-yumprint-dialog blog-yumprint-box-shadow blog-yumprint-reading'><div class='blog-yumprint-dialog-title blog-yumprint-brown-text-nh blog-yumprint-reading'></div><div class='blog-yumprint-gray blog-yumprint-close'><span class='blog-yumprint-cancel'>Cancel</span></div><div class='blog-yumprint-dialog-contents blog-yumprint-brown-text-nh'></div></div>").hide().click(function() {
                return!1
    ...
    function star(a, e, c, b, d, g, l, f) {
        ...
        l.moveTo(0, 0 - c);
        for (a = 0; a < b; ++a)
            l.rotate(Math.PI / b), l.lineTo(0, 0 - c * d), l.rotate(Math.PI / b), l.lineTo(0, 0 - c);
        f && l.fill();
        l.stroke();
        l.restore()
    }
    ...
    function initRecipe(a) {
        ...
        a.find(".blog-yumprint-print").click(function() {
            for (var b = {title: a.find(".blog-yumprint-recipe-title").text(), image: a.find(".blog-yumprint-google-image").attr("src"), link: a.find(".blog-yumprint-recipe-source").text(), serves: a.find(".blog-yumprint-serves").text(), sections: [], stats: []}, c = 0; c < a.find(".blog-yumprint-ingredient-section").length; ++c) {
                for (var d = $(a.find(".blog-yumprint-ingredient-section")[c]),
                        e = {title: d.find(".blog-yumprint-subheader").text(), type: "ingredient", items: []}, f = 0; f < d.find(".blog-yumprint-ingredient-item").length; ++f)
            ...
            for (c = 0; c < a.find(".blog-yumprint-method-section").length; ++c) {
                ...
                for (f = 0; f < d.find(".blog-yumprint-method-item").length; ++f)
                    e.items.push($(d.find(".blog-yumprint-method-item")[f]).text());
                b.sections.push(e)
            }
            for (c = 0; c < a.find(".blog-yumprint-note-section").length; ++c) {
                ...
                for (f = 0; f < d.find(".blog-yumprint-note-item").length; ++f)
                    e.items.push($(d.find(".blog-yumprint-note-item")[f]).text());
                b.sections.push(e)
            }
            for (c = 0; c < a.find(".blog-yumprint-infobar-section").length; ++c)
                d = $(a.find(".blog-yumprint-infobar-section")[c]), e = {title: d.find(".blog-yumprint-infobar-section-title").text(),
                    data: d.find(".blog-yumprint-infobar-section-data").text()}, b.stats.push(e);
            c = window.open("");
            b = JSON.stringify(b);
        ...
        a.find(".blog-yumprint-nutrition-bar").click(function() {
            ...
            showDialog({id: "blog-yumprint-nutrition-card", show: function(a) {
        ...
        if (window.yumprintRecipeDisabled)
            a.find(".blog-yumprint-stars-reviews, .blog-yumprint-save, .blog-yumprint-print").remove();
        else {
            var c = a.attr("yumprintrecipe"), e = a.find(".blog-yumprint-stars-reviews");
            if (e.is(":visible")) {
                var b = e.attr("color"), d = e.attr("highlightcolor"), g = e.attr("emptycolor"), l = parseFloat(e.attr("rating")), f = parseInt(e.attr("count"));
            ...
            a.find(".blog-yumprint-save").click(function() {
                showDialog({width: 700, height: 468, show: function(a) {
            ...
            a.find(".blog-yumprint-star-wrapper").click(function() {
                $(this).hasClass("has-reviews") && showDialog({height: 400, width: 600, id: "blog-yumprint-reviews-dialog", show: function(b) {
